  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_sids_building_new-buildingquestions_new-buildingquestions_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "NewBuildingquestionsPageRoutingModule": function NewBuildingquestionsPageRoutingModule() {
          return (
            /* binding */
            _NewBuildingquestionsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _new_buildingquestions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./new-buildingquestions.page */
      27970);
      ...
      var _NewBuildingquestionsPageRoutingModule = /*#__PURE__*/_createClass(function NewBuildingquestionsPageRoutingModule() {
        _classCallCheck(this, NewBuildingquestionsPageRoutingModule);
      });

      _NewBuildingquestionsPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "NewBuildingquestionsPageModule": function NewBuildingquestionsPageModule() {
          return (
            /* binding */
            _NewBuildingquestionsPageModule
          );
        }
        /* harmony export */
      ...
      var _new_buildingquestions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./new-buildingquestions-routing.module */
      77687);
      /* harmony import */


      var _new_buildingquestions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./new-buildingquestions.page */
      27970);

      var _NewBuildingquestionsPageModule = /*#__PURE__*/_createClass(function NewBuildingquestionsPageModule() {
        _classCallCheck(this, NewBuildingquestionsPageModule);
      });

      _NewBuildingquestionsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _new_buildingquestions_routing_module__WEBPACK_IMPORTED_MODULE_0__.NewBuildingquestionsPageRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "NewBuildingquestionsPage": function NewBuildingquestionsPage() {
          return (
            /* binding */
            _NewBuildingquestionsPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_new_buildingquestions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./new-buildingquestions.page.html */
      96804);
      /* harmony import */


      var _new_buildingquestions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./new-buildingquestions.page.scss */
      85395);
      /* harmony import */
      ...
      var _NewBuildingquestionsPage = /*#__PURE__*/function () {
        function NewBuildingquestionsPage(router, formBuilder, route, camera, geolocation, alertController, file, sqliteDB, uploadService, utilityService, datePipe, userSessionService, androidPermissions, alertService, el) {
          _classCallCheck(this, NewBuildingquestionsPage);
        ...
        return _createClass(NewBuildingquestionsPage, [{
          key: "ngOnInit",
          ...
          value: function onSave() {
            ...
            if (this.form.valid) {
              ...
              var query = 'DELETE FROM  sidsBuildingQuestion' + ' WHERE SclId = "' + this.schoolId + '"' + ' And BuildingId = "' + this.buildingId + '"' + ' And VistId = "' + this.vistId + '"';
          ...
          value: function insertLocalDB() {
            ...
            var insertRows = [];
            insertRows.push(["INSERT INTO sidsBuildingQuestion VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [null, this.schoolId, this.vistId, this.buildingId, "", this.form.value.BldgName, // this.form.value.BldgAge, 
            this.form.value.BldgFundSourceCons, this.form.value.BldgFundSourceConsOthers, this.form.value.BldgType, this.form.value.BldgLength, this.form.value.BldgBre, this.form.value.BldgCondition, this.form.value.ElectricityAvai, this.form.value.BldgRepair ? this.form.value.BldgRepair.toString() : this.form.value.BldgRepair, this.form.value.AreaWeatheringReq, this.form.value.AreaPressedTiles, this.form.value.PipeNeedHwDw, this.form.value.PipeNeedToilet, this.form.value.WireLenElectrcty, this.form.value.AreaWaterLeakage, this.form.value.AreaExtWw, this.form.value.AreaIntWw, this.form.value.AreaReplasting, this.form.value.AreaReflooring, this.form.value.AreaFlrPatchwrk, this.form.value.AuditoriumYn, // this.form.value.AuditoriumStageReqt, 
            // this.form.value.AuditoriumStageArea,
            // this.form.value.AuditoriumStageHeight, 
            // this.form.value.AuditoriumStageAreaLevel,
            this.form.value.AuditoriumLights, this.form.value.AuditoriumFans, this.form.value.AuditoriumPrjtYn, // this.form.value.AuditoriumPrjtFunc, 
            this.form.value.RampAvailYn, this.form.value.RampRepairYn, this.form.value.RampHandrailYn, this.form.value.FireExtYn, // this.form.value.FirstAidKit, 
            // this.form.value.CCTVCameraYn, 
            // this.form.value.BuildTabsYn, 
            // this.form.value.BuildTabsNumber, 
            this.form.value.BuildReapairComArea, this.form.value.BldgYrConst, this.form.value.BldgConstAgency, this.form.value.BldgConstOthers, this.form.value.AudiStageStatus, this.form.value.BldgFrontPhoto, this.form.value.BldgFrontPhotoName, this.form.value.BldgExterior, this.form.value.BldgInterior, this.form.value.RainWaterFacilityYn, // this.form.value.BldgBackPhoto, this.form.value.BldgBackPhotoName, this.form.value.BldgRightSidePhoto, this.form.value.BldgRightSidePhotoName,
            ...
            this.sqliteDB.bulkInsert(insertRows).then(function (result) {
              ...
              if (+_this3.form.value.BldgType == 3) {
                _this3.deleteTypeRoom();
              }

              var query = 'UPDATE sidsBuildSavesDatas SET Status = 2 WHERE sidsBuildSavesDatas.SclId = "' + _this3.schoolId + '" And sidsBuildSavesDatas.BuildingId = "' + _this3.buildingId + '"';
              var query1 = 'UPDATE sidsBuildSavesDatas SET BuildName="' + name + '" WHERE sidsBuildSavesDatas.SclId = "' + _this3.schoolId + '" And sidsBuildSavesDatas.BuildingId = "' + _this3.buildingId + '"';
              var query2 = 'UPDATE sidsBuildSavesDatas SET BuildCondi="' + _this3.form.value.BldgCondition + '" WHERE sidsBuildSavesDatas.SclId = "' + _this3.schoolId + '" And sidsBuildSavesDatas.BuildingId = "' + _this3.buildingId + '"';
              return _this3.sqliteDB.update(query).then(function (data) {
                return _this3.sqliteDB.update(query1).then(function (data) {
                  return _this3.sqliteDB.update(query2).then(function (data) {
                    ...
                    _this3.router.navigate(['/tabs/new-dashboard'], {
                      queryParams: {
            ...
            return this.sqliteDB.getDataLocalDB(query).then(function (data) {
              if (data.rows.length > 0) {
                ...
                _this4.form.patchValue({
                  ...
                  "BldgFundSourceConsOthers": _this4.dataList[0].BldgFundSourceConsOthers,
                  ...
                  "ElectricityAvai": _this4.dataList[0].ElectricityAvai,
                  "BldgYrConst": _this4.dataList[0].BldgYrConst,
                  "BldgConstAgency": _this4.dataList[0].BldgConstAgency,
                  "BldgConstOthers": _this4.dataList[0].BldgConstOthers,
                  ...
                  "AudiStageStatus": _this4.dataList[0].AudiStageStatus,
                  ...
                  "RampHandrailYn": _this4.dataList[0].RampHandrailYn == "false" ? false : _this4.dataList[0].RampHandrailYn == "true" ? true : _this4.dataList[0].RampHandrailYn,
                  ...
                  "BldgExterior": _this4.dataList[0].BldgExterior,
                  "BldgInterior": _this4.dataList[0].BldgInterior,
                  "RainWaterFacilityYn": _this4.dataList[0].RainWaterFacilityYn == "false" ? false : _this4.dataList[0].RainWaterFacilityYn == "true" ? true : _this4.dataList[0].RainWaterFacilityYn,
                  ...
                  "LATITUDE": _this4.dataList[0].LATITUDE,
                  "LOGITUDE": _this4.dataList[0].LOGITUDE // "BldgAge": this.dataList[0].BldgAge,
          ...
          value: function onMultiSelectChange(event) {
            ...
            if (this.activeHeight) {// this.form.controls['AuditoriumStageArea'].setValue("");
            ...
            } else {// this.form.controls['AuditoriumStageArea'].setValue("");
            ...
            if (this.activeLevelling) {// this.form.controls['AuditoriumStageAreaLevel'].setValue("");
            ...
            } else {// this.form.controls['AuditoriumStageAreaLevel'].setValue("");
          ...
          key: "getToggleClass",
          value: function getToggleClass(event, id) {
            if (id == 1) {
          ...
          key: "onEventDropdown",
          value: function onEventDropdown(event, id) {
            if (id == 1) {
          ...
          value: function deleteFloorandRoom() {
            ...
            var query1 = 'DELETE FROM sidsFloorQuestion' + ' WHERE SclId = "' + this.schoolId + '"' + ' And BuildingId = "' + this.buildingId + '"' + ' And VistId = "' + this.vistId + '"';
            var query2 = 'DELETE FROM sidsFloorSaveDatas' + ' WHERE SclId = "' + this.schoolId + '"' + ' And BuildIndx = "' + idbuild + '"' + ' And VistId = "' + this.vistId + '"';
            var query3 = 'DELETE FROM sidsRoomSaves' + ' WHERE SclId = "' + this.schoolId + '"' + ' And BuildIndx = "' + idbuild + '"' + ' And VistId = "' + this.vistId + '"';
            var query4 = 'DELETE FROM newRoomscommons' + ' WHERE SchlId = "' + this.schoolId + '"' + ' And BldgId = "' + this.buildingId + '"' + ' And VistId = "' + this.vistId + '"';
              ...
              _this7.file.readAsDataURL(imagename, filename).then(function (base64string) {
                if (base64string) {
                  ...
                  if (blob.size <= 3145728) {
                    if (i == 1) {
                      _this7.form.get('BldgFrontPhoto').setValue(base64string);

                      _this7.form.get('BldgFrontPhotoName').setValue(splitedImage[0] + '.png');
                    }

                    _this7.getLatLong(); // if(i == 2){
              ...
              if (event.target.files[0].type == "image/jpeg" || event.target.files[0].type == "image/jpg") {
                if (event.target.files[0].size <= 3145728) {
                  ...
                  fileReader.onload = function (event) {
                    _this9.uploadUrl = fileReader.result;
                    var bucketName = "renewalapplicationemis";
                    var filename = splittedName[0];
                    var ext = splittedName[1];
                    var expiry = 300;

                    _this9.utilityService.getFileUrl1(bucketName, ext, filename, expiry).subscribe(function (result) {
                      if (result) {
                        var files = _this9.doc_file;
                        var file = files[0];

                        _this9.utilityService.uploadFile(result.url, file).subscribe(function (res) {
                          _this9.imageKey = result.key; // this.viewImage();

                          _this9.form.controls['BldgFrontPhoto'].setValue(result.key);

                          _this9.form.controls['BldgFrontPhoto'].updateValueAndValidity();
                        });
            ...
            return (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee3() {
              ...
              return _regenerator().w(function (_context3) {
                while (1) switch (_context3.n) {
                  case 0:
                    bucketName = "renewalapplicationemis"; // var filename = this.imageKey;
                    ...
                    expiry = 1800;
                    this.utilityService.getFile(bucketName, filename, expiry).subscribe(function (result) {
                      return (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(_this0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee2() {
          ...
          value: function uploadImgDelete(id) {
            ...
            this.form.get('BldgFrontPhoto').updateValueAndValidity(); // this.form.get('BldgBackPhoto').updateValueAndValidity();
          ...
          key: "deleteTypeRoom",
          value: function deleteTypeRoom() {
            var _this10 = this;

            var idbuild = parseInt(this.buildingId) - 100;
            var query = 'SELECT Id FROM newRoomscommons' + ' WHERE SchlId = "' + this.schoolId + '"' + ' And BldgId = "' + this.buildingId + '"' + ' And VistId = "' + this.vistId + '"' + ' And RoomUse NOT IN(10,11,12)';
            var query1 = 'SELECT Sid FROM sidsRoomSaves' + ' WHERE SclId = "' + this.schoolId + '"' + ' And BuildIndx = "' + idbuild + '"' + ' And VistId = "' + this.vistId + '"';
            return this.sqliteDB.getDataLocalDB(query).then(function (data) {
              if (data.rows.length > 0) {
                var dataList = [];
                var dataList2 = [];
                ...
                if (dataList.length > 0) {
                  return _this10.sqliteDB.getDataLocalDB(query1).then(function (data2) {
                    ...
                    for (var _i = 0; _i < dataList.length; _i++) {
                      if (dataList[_i].Id) {
                        _this10.removeLocal1(dataList[_i].Id);
                      }
                    }

                    for (var _i2 = 0; _i2 < dataList2.length; _i2++) {
                      for (var j = 0; j < dataList.length; j++) {
                        if (+dataList2[_i2].Sid == +dataList[j].Id) {
                          _this10.removeLocal2(dataList2[_i2].Sid);
                        }
                      }
                    }
                  });
          ...
          key: "removeLocal1",
          value: function removeLocal1(value) {
            var query2 = 'DELETE FROM newRoomscommons' + ' WHERE SchlId = "' + this.schoolId + '"' + ' And BldgId = "' + this.buildingId + '"' + ' And VistId = "' + this.vistId + '"' + ' And Id IN ("' + value + '")';
            return this.sqliteDB.executeQuery(query2).then(function (data) {});
          }
        }, {
          key: "removeLocal2",
          value: function removeLocal2(value) {
            var idbuild = parseInt(this.buildingId) - 100;
            var query3 = 'DELETE FROM sidsRoomSaves' + ' WHERE SclId = "' + this.schoolId + '"' + ' And BuildIndx = "' + idbuild + '"' + ' And VistId = "' + this.vistId + '"' + ' And Sid IN ("' + value + '")';
            return this.sqliteDB.executeQuery(query3).then(function (data) {});
          }
        }, {
          key: "getLatLong",
          value: function getLatLong() {
            ...
            this.geolocation.getCurrentPosition({
              ...
              _this11.locationCordinates = resp.coords;

              _this11.form.controls['LATITUDE'].setValue(_this11.locationCordinates.latitude);

              _this11.form.controls['LOGITUDE'].setValue(_this11.locationCordinates.longitude);

              _this11.form.controls['LATITUDE'].updateValueAndValidity();

              _this11.form.controls['LOGITUDE'].updateValueAndValidity();
            })["catch"](function (error) {
              if (error.message === 'Illegal Access') {
                _this11.alertService.alertToTurnOnPermission('Location', 'Location');
      ...
      _NewBuildingquestionsPage.ctorParameters = function () {
        return [{
      ...
      _NewBuildingquestionsPage.propDecorators = {
        jpgimage: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_17__.ViewChild,
          args: ['jpgimage']
        }]
      };
      _NewBuildingquestionsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_17__.Component)({
...
//# sourceMappingURL=src_app_pages_sids_building_new-buildingquestions_new-buildingquestions_module_ts-es5.js.map