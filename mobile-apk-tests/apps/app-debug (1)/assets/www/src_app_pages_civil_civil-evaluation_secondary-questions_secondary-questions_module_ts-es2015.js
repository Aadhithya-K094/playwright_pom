(self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_civil_civil-evaluation_secondary-questions_secondary-questions_module_ts"],{

/***/ 69954:
/*!********************************************************************************************************!*\
  !*** ./src/app/pages/civil/civil-evaluation/secondary-questions/secondary-questions-routing.module.ts ***!
  \********************************************************************************************************/
...
/* harmony export */   "SecondaryQuestionsPageRoutingModule": function() { return /* binding */ SecondaryQuestionsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _secondary_questions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./secondary-questions.page */ 65150);
...
const routes = [
    {
        path: '',
        component: _secondary_questions_page__WEBPACK_IMPORTED_MODULE_0__.SecondaryQuestionsPage
    }
];
let SecondaryQuestionsPageRoutingModule = class SecondaryQuestionsPageRoutingModule {
};
SecondaryQuestionsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], SecondaryQuestionsPageRoutingModule);
...
/***/ 19637:
/*!************************************************************************************************!*\
  !*** ./src/app/pages/civil/civil-evaluation/secondary-questions/secondary-questions.module.ts ***!
  \************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SecondaryQuestionsPageModule": function() { return /* binding */ SecondaryQuestionsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _secondary_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./secondary-questions-routing.module */ 69954);
/* harmony import */ var _secondary_questions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./secondary-questions.page */ 65150);
...
let SecondaryQuestionsPageModule = class SecondaryQuestionsPageModule {
};
SecondaryQuestionsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            ...
            _secondary_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__.SecondaryQuestionsPageRoutingModule
        ],
        declarations: [_secondary_questions_page__WEBPACK_IMPORTED_MODULE_1__.SecondaryQuestionsPage]
    })
], SecondaryQuestionsPageModule);
...
/***/ 65150:
/*!**********************************************************************************************!*\
  !*** ./src/app/pages/civil/civil-evaluation/secondary-questions/secondary-questions.page.ts ***!
  \**********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SecondaryQuestionsPage": function() { return /* binding */ SecondaryQuestionsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_secondary_questions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./secondary-questions.page.html */ 20272);
/* harmony import */ var _secondary_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./secondary-questions.page.scss */ 17335);
...
/* harmony import */ var src_app_services_emis_aws_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/emis/aws.service */ 56263);
...
let SecondaryQuestionsPage = class SecondaryQuestionsPage {
    constructor(router, fb, geolocation, alertService, userSessionService, userService, route, uploadService, awsService) {
        this.router = router;
        this.fb = fb;
    ...
    getDate() {
        ...
        this.addYear = this.pipe.transform(yeardate, 'yyyy-MM-dd');
        // console.log('week----' + this.addWeek)
    ...
    getSurveyQuestionsbyId() {
        //debugger
        this.finaldata = [];
        this.awsService.getSurveyQuestions(1008).subscribe(res => {
            if (res) {
                this.data = res;
                ...
                for (let i = 0; i < this.data.length; i++) {
                    ...
                    this.getLibrarySurveyQuestions();
                }
    ...
    getLibrarySurveyQuestions() {
        this.filterData = this.finaldata;
        this.onFundList(this.filterData);
    }
    onFundList(item) {
        this.username = window.localStorage.getItem('username');
        this.surveyDate = this.pipe.transform(this.form.value.date, 'yyyy-MM-dd');
        ...
        if (item.length > 0) {
            for (let i = 0; i < item.length; i++) {
                this.queslist.push(this.fb.group({
                    ...
                    AllotYr: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(this.form.value.year, null),
                    SurId: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].survey_id, null),
                    SurDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(this.todayDate, null),
                    QId: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].QuestID, null),
                    ...
                    Q_Group: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].Q_Group, null),
                    Q_GtropTxt: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].Q_GtropTxt, null),
                    Quest: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].Quest, null),
                    QuestTyp: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].QuestTyp, null),
                    min: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].minlength, null),
                    max: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].maxlength, null),
                    value: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl('', null),
                    UserTyp: new _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormControl(item[i].UserTyp, null)
                }));
                ...
                //   this.form.controls['survey_question']['controls'][i].controls['ResChar'].setValue('0');
                // }
                if (this.queslist.value[i]['ResInt'] == null || this.queslist.value[i]['ResInt'] == 2 || this.queslist.value[i]['ResInt'] == "") {
                    this.form.controls['survey_question']['controls'][i].controls['ResInt'].setValue('2');
                }
                if (this.queslist.value[i]['QuestTyp'] == 2 || this.queslist.value[i]['QuestTyp'] == 3 || this.queslist.value[i]['QuestTyp'] == 7 || this.queslist.value[i]['QuestTyp'] == 4) {
                    this.form.controls['survey_question']['controls'][i].controls['ResInt'].setValue('0');
                    this.form.controls['survey_question']['controls'][i].controls['ResChar'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_9__.Validators.required);
                }
                else {
    ...
    goToHome() {
        this.router.navigate(['tab/dashboard'], { queryParams: { 'title': this.Title, 'id': this.Id }, skipLocationChange: false });
    }
    onFundClickFunc(e, index) {
        //debugger
    ...
    onFinalSave() {
        ...
        if (this.form.valid) {
            this.userService.saveCivilEvaluationSurvey(resdata).subscribe(res => {
                if (res.dataStatus) {
    ...
    // }
    onNext(heading) {
        if (heading == 'Secondary Civil Evaluation') {
        ...
        else if (heading == 'Sports Material') {
            this.headingListIndex = this.headingList[7];
        }
        else if (heading == 'Safety Equipment') {
            this.headingListIndex = this.headingList[8];
                    ...
                    this.uploadService.getSignedUrl(bucketName, ext, filename, expiry).subscribe((result) => {
                        if (result) {
                            ...
                            this.uploadService.uploadFile(result.url, file).subscribe((res) => {
                                this.form.controls['survey_question']['controls'][i].controls['Images'].setValue(result.key);
                                this.getUploadedFiles1(result.key, i);
    ...
    getUploadedFiles1(filename, i) {
        ...
        this.uploadService.getUploadedFiles(bucketName, filename, expiry).subscribe((result) => {
            if (result) {
                ...
                this.form.controls['survey_question']['controls'][i].controls['Photo'].setValue(result.url);
                // this.form.controls['survey_question']['controls'][i].controls['Images'].setValue(filename);
            }
            else {
                this.alertService.error('Error in Uploading File please try again');
            }
...
SecondaryQuestionsPage.ctorParameters = () => [
    ...
    { type: src_app_services_emis_aws_service__WEBPACK_IMPORTED_MODULE_7__.AwsService }
];
SecondaryQuestionsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_12__.Component)({
        selector: 'app-secondary-questions',
        template: _raw_loader_secondary_questions_page_html__WEBPACK_IMPORTED_MODULE_0__.default,
        styles: [_secondary_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__.default]
    })
], SecondaryQuestionsPage);
...
/***/ 17335:
/*!************************************************************************************************!*\
  !*** ./src/app/pages/civil/civil-evaluation/secondary-questions/secondary-questions.page.scss ***!
  \************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("ion-label {\n  max-width: 100% !important;\n}\n\n.valid-clr {\n  color: red;\n}\n\n.header {\n  padding: 15px;\n  border-radius: 10px;\n}\n\n.header-txt {\n  padding-left: 15px;\n  padding-right: 15px;\n  padding-top: 10px;\n  border-radius: 10px;\n}\n\n.heading-txt {\n  background: #e6ccff;\n  padding: 10px;\n  margin-bottom: 15px;\n  border-radius: 5px;\n}\n\n.item-style {\n  margin-bottom: 15px;\n  border-radius: 6px;\n}\n\n.background {\n  border-radius: 10px;\n  background: white;\n  margin-bottom: 0px;\n  margin-top: 10px;\n  padding: 0px;\n}\n\n.ques-txt {\n  padding-top: 10px;\n  padding-bottom: 10px;\n  white-space: pre-line;\n}\n\n.bt-10 {\n  padding-bottom: 10p;\n}\n\n.list {\n  padding-bottom: 0px;\n  padding-top: 0px;\n}\n\n.radio {\n  padding-right: 40px;\n  padding-left: 15px;\n  padding-top: 3px;\n}\n\n.lbl {\n  padding-top: 10px;\n  padding-bottom: 10px;\n  white-space: pre-line;\n}\n\n.input-clr {\n  color: #388;\n  color: var(--ion-color-primary, #388);\n  margin-left: 0px;\n}\n\n.error-message {\n  padding-left: 0px;\n  color: red;\n}\n\nion-input {\n  --padding-start: 0px !important;\n}\n\n.ion-item {\n  border-top: 5px solid #8B67B3;\n  border-radius: 15px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ 20272:
/*!**************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/civil/civil-evaluation/secondary-questions/secondary-questions.page.html ***!
  \**************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=src_app_pages_civil_civil-evaluation_secondary-questions_secondary-questions_module_ts-es2015.js.map