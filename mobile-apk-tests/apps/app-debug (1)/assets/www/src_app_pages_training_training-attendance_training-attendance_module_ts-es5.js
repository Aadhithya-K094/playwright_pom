  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_training_training-attendance_training-attendance_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "TrainingAttendancePageRoutingModule": function TrainingAttendancePageRoutingModule() {
          return (
            /* binding */
            _TrainingAttendancePageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _training_attendance_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      var _TrainingAttendancePageRoutingModule = /*#__PURE__*/_createClass(function TrainingAttendancePageRoutingModule() {
        _classCallCheck(this, TrainingAttendancePageRoutingModule);
      });

      _TrainingAttendancePageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "TrainingAttendancePageModule": function TrainingAttendancePageModule() {
          return (
            /* binding */
            _TrainingAttendancePageModule
          );
        }
        /* harmony export */
      ...
      var _training_attendance_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./training-attendance-routing.module */
      31866);
      /* harmony import */


      var _training_attendance_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./training-attendance.page */
      71860);

      var _TrainingAttendancePageModule = /*#__PURE__*/_createClass(function TrainingAttendancePageModule() {
        _classCallCheck(this, TrainingAttendancePageModule);
      });

      _TrainingAttendancePageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _training_attendance_routing_module__WEBPACK_IMPORTED_MODULE_0__.TrainingAttendancePageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "TrainingAttendancePage": function TrainingAttendancePage() {
          return (
            /* binding */
            _TrainingAttendancePage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_training_attendance_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./training-attendance.page.html */
      74903);
      /* harmony import */


      var _training_attendance_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./training-attendance.page.scss */
      30650);
      /* harmony import */
      ...
      var _TrainingAttendancePage = /*#__PURE__*/function () {
        function TrainingAttendancePage(fb, alertService, router, userService, usersessionService) {
          _classCallCheck(this, TrainingAttendancePage);
        ...
        return _createClass(TrainingAttendancePage, [{
          key: "ngOnInit",
          ...
          key: "onFiterChange",
          value: function onFiterChange(event) {}
        }, {
          key: "onTrainertype",
          value: function onTrainertype(event) {
            debugger;
          ...
          value: function onSave() {
            ...
            if (this.form.valid) {
              if (this.form.value.training_id == 1) {
                var a = this.pipe.transform(this.form.value.starttime, 'hh');
                var b = this.pipe.transform(this.form.value.starttime, 'mm');
                var c = this.pipe.transform(this.form.value.endtime, 'hh');
                var d = this.pipe.transform(this.form.value.endtime, 'mm');
                var e = this.pipe.transform(this.form.value.starttime, 'a');
                var f = this.pipe.transform(this.form.value.endtime, 'a'); // console.log(a)
                // console.log(b)
                // console.log(c)
                // console.log(d)
                // console.log(e)
                ...
                if ((a < c || a == c) && (b < d || b == d) && e == f || (a < c || a == c || a > c) && (b < d || b == d || b > d) && e != f) {
                  this.userService.getSchoolInfo(this.form.value.udise).subscribe(function (res) {
                    if (res.dataStatus) {
                      var schoolinfo = res.result[0].SclId;

                      if (schoolinfo == '' || schoolinfo == null) {
                        _this2.alertService.error('Invalid UDISE code of training location');
                      } else {
                        var data = {
                          "records": {
                            "IndexId": "",
                            "TraineId": _this2.sessionUserName,
                            "TrainiDate": _this2.todayDateFormat,
                            "TrainiVenue": _this2.form.value.udise,
                            "TrainiType": _this2.form.value.training_type,
                            "TrainiBatch": "1",
                            "TrainiStartTime": _this2.form.value.starttime,
                            "TrainiEndTime": _this2.form.value.endtime,
                            "TrainiCode": ""
                          }
                        };
                        console.log('form value', data);

                        _this2.userService.saveTrainerAttendance(data, true).subscribe(function (res) {
                          if (res) {
                ...
                this.userService.saveTraineeAttendance(resdata, true).subscribe(function (res) {
                  if (res) {
                    _this2.alertService.success(res.message);
          ...
          key: "onSavedData",
          value: function onSavedData() {
            if (this.form.value.training_id == 1) {
              this.router.navigate(['/tabs/saveddata'], {
                queryParams: {
                  'page': 1
                },
      ...
      _TrainingAttendancePage.ctorParameters = function () {
        return [{
      ...
      _TrainingAttendancePage = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
...
//# sourceMappingURL=src_app_pages_training_training-attendance_training-attendance_module_ts-es5.js.map