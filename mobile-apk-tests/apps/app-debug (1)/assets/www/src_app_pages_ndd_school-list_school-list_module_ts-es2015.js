...
/* harmony import */ var _school_list_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./school-list.page */ 60586);
...
/* harmony import */ var _school_list_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./school-list-routing.module */ 72704);
/* harmony import */ var _school_list_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./school-list.page */ 60586);
...
/* harmony import */ var _raw_loader_school_list_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./school-list.page.html */ 98112);
/* harmony import */ var _school_list_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./school-list.page.scss */ 9375);
...
let SchoolListPage = class SchoolListPage {
    ...
    navigateToClassSection(data, id) {
        console.log(data, 'data');
        this.stu_id = id;
        this.router.navigate(['/tabs/ndd/class-list'], {
            queryParams: { id: data.BlockId, school_id: data.SchoolId, school_name: data.SchoolName, class: this.class, section: this.section }
        });
        console.log(data.BlockId, data.SchoolId, data.SchoolName, this.class, this.section);
    }
    getdata() {
        this.pmoaService.schoolcount(this.useriddata).subscribe((res) => {
            this.countdata = res.result;
            this.count = this.countdata.TotSchlCount[0].Count;
            this.RcvdSchoolCount = this.countdata.RcvdCount[0].RcvdSchoolCount;
            this.NotRcvdSchlCount = this.countdata.RcvdCount[0].NotRcvdSchlCount;
        });
    }
    getFilterItems(event) {
        ...
        this.schlist = this.allschlist.filter((item) => {
            return item.SchoolName.toLowerCase().indexOf(this.searchTerm.toLowerCase()) > -1;
        });
    }
    getschoolist() {
        this.pmoaService.schoollist(this.useriddata).subscribe((res) => {
            this.schlist = res.result;
            this.allschlist = res.result;
        });
    }
};
...
SchoolListPage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
//# sourceMappingURL=src_app_pages_ndd_school-list_school-list_module_ts-es2015.js.map