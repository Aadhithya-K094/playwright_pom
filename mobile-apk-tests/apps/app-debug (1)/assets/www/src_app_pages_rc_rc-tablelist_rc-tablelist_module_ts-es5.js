  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_rc_rc-tablelist_rc-tablelist_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "RCTablelistPageRoutingModule": function RCTablelistPageRoutingModule() {
          return (
            /* binding */
            _RCTablelistPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _rc_tablelist_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./rc-tablelist.page */
      98171);
      ...
      var _RCTablelistPageRoutingModule = /*#__PURE__*/_createClass(function RCTablelistPageRoutingModule() {
        _classCallCheck(this, RCTablelistPageRoutingModule);
      });

      _RCTablelistPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "RCTablelistPageModule": function RCTablelistPageModule() {
          return (
            /* binding */
            _RCTablelistPageModule
          );
        }
        /* harmony export */
      ...
      var _rc_tablelist_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./rc-tablelist-routing.module */
      96838);
      /* harmony import */


      var _rc_tablelist_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./rc-tablelist.page */
      98171);

      var _RCTablelistPageModule = /*#__PURE__*/_createClass(function RCTablelistPageModule() {
        _classCallCheck(this, RCTablelistPageModule);
      });

      _RCTablelistPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _rc_tablelist_routing_module__WEBPACK_IMPORTED_MODULE_0__.RCTablelistPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "RCTablelistPage": function RCTablelistPage() {
          return (
            /* binding */
            _RCTablelistPage
          );
      ...
      var _raw_loader_rc_tablelist_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./rc-tablelist.page.html */
      67640);
      /* harmony import */


      var _rc_tablelist_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./rc-tablelist.page.scss */
      39743);
      /* harmony import */
      ...
      var _RCTablelistPage = /*#__PURE__*/function () {
        function RCTablelistPage(router, rcservice, uploadService, iab) {
          _classCallCheck(this, RCTablelistPage);
        ...
        return _createClass(RCTablelistPage, [{
          key: "ionViewDidEnter",
          ...
          key: "onExpand",
          value: function onExpand(item, id) {
            if (id) {
              if (this.onActive) {
                this.idItem = null;
                this.onActive = false;
          ...
          key: "goToForm",
          value: function goToForm(appId, atype) {
            ...
            console.log(this.appType); // this.appType = atype

            this.school_name = this.applist[appId].school_name;
            this.district = this.applist[appId].district;
            var deoInspectionDoc = this.applist[appId].deo_inspection_doc || '';
            this.router.navigate(['/tabs/index'], {
              queryParams: {
                ...
                'deoInspectionDoc': deoInspectionDoc
              },
          ...
          value: function getRCquestion() {
            ...
            this.rcservice.toGetRCFormquestion(data).subscribe(function (res) {
              _this.section = res.result.sections;
              console.log(_this.section);
              console.log(_this.section, "question");
            });
          }
        }, {
          key: "getRCApplictaion",
          value: function getRCApplictaion() {
            var _this2 = this;

            this.rcservice.toGetAppList().subscribe(function (res) {
              if (res.result != 'Unable To Load Result for District List') {
                _this2.applicationList = res.result;

                for (var i in res.result) {
                  if (typeof res.result[i] !== 'undefined') _this2.applist[res.result[i].application_id] = res.result[i];
                }

                console.log(_this2.applicationList, 'directAPI Call');
                console.log(_this2.applist, "result");
              } else {
                _this2.errorMessage = res.result;
              }
            });
          }
        }, {
          key: "viewInspectionFile",
          value: function viewInspectionFile(filename) {
            if (filename) {
              var splittedName = filename.split(".");
              var ext = splittedName[splittedName.length - 1].toLowerCase();
              var folderCode = this.uploadService.getAppTypeToFolderCode('3');
              var folderPath = this.uploadService.getBucketFolderNameForRC(folderCode, ext == 'pdf' ? 'pdf' : 'images'); // inspectionFileName already contains folder path from getSignedUrl result.key
      ...
      _RCTablelistPage.ctorParameters = function () {
        return [{
      ...
      _RCTablelistPage = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
...
//# sourceMappingURL=src_app_pages_rc_rc-tablelist_rc-tablelist_module_ts-es5.js.map