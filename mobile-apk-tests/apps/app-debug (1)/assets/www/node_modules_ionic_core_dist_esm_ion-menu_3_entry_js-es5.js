(function () {
  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["node_modules_ionic_core_dist_esm_ion-menu_3_entry_js"], {
    /***/
    86030:
    /*!***************************************************************!*\
      ...
      var Menu = /*#__PURE__*/function () {
        ...
        return _createClass(Menu, [{
          ...
          value: function beforeAnimation(shouldOpen) {
            (0, _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.m)(!this.isAnimating, '_before() should not be called while animating'); // this places the menu into the correct location before it animates in
          ...
          value: function afterAnimation(isOpen) {
            (0, _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.m)(this.isAnimating, '_before() should be called while animating'); // keep opening/closing the menu disabled for a touch more yet
        ...
        return _createClass(MenuButton, [{
          ...
          value: function render() {
            ...
            return (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, {
              ...
              "class": (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_6__.c)(color, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, mode, true), 'button', true), 'menu-button-hidden', hidden), 'menu-button-disabled', disabled), 'in-toolbar', (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_6__.h)('ion-toolbar', this.el)), 'in-toolbar-color', (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_6__.h)('ion-toolbar[color]', this.el)), 'ion-activatable', true), 'ion-focusable', true))
