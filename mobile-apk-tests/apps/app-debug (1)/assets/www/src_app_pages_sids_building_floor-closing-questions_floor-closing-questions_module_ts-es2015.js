(self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_sids_building_floor-closing-questions_floor-closing-questions_module_ts"],{

/***/ 71196:
/*!*******************************************************************************************************!*\
  !*** ./src/app/pages/sids/building/floor-closing-questions/floor-closing-questions-routing.module.ts ***!
  \*******************************************************************************************************/
...
/* harmony export */   "FloorClosingQuestionsPageRoutingModule": function() { return /* binding */ FloorClosingQuestionsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _floor_closing_questions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./floor-closing-questions.page */ 35039);
...
const routes = [
    {
        path: '',
        component: _floor_closing_questions_page__WEBPACK_IMPORTED_MODULE_0__.FloorClosingQuestionsPage
    }
];
let FloorClosingQuestionsPageRoutingModule = class FloorClosingQuestionsPageRoutingModule {
};
FloorClosingQuestionsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], FloorClosingQuestionsPageRoutingModule);
...
/***/ 90305:
/*!***********************************************************************************************!*\
  !*** ./src/app/pages/sids/building/floor-closing-questions/floor-closing-questions.module.ts ***!
  \***********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FloorClosingQuestionsPageModule": function() { return /* binding */ FloorClosingQuestionsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _floor_closing_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./floor-closing-questions-routing.module */ 71196);
/* harmony import */ var _floor_closing_questions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./floor-closing-questions.page */ 35039);
...
let FloorClosingQuestionsPageModule = class FloorClosingQuestionsPageModule {
};
FloorClosingQuestionsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _floor_closing_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__.FloorClosingQuestionsPageRoutingModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule
        ],
        declarations: [_floor_closing_questions_page__WEBPACK_IMPORTED_MODULE_1__.FloorClosingQuestionsPage]
    })
], FloorClosingQuestionsPageModule);
...
/***/ 35039:
/*!*********************************************************************************************!*\
  !*** ./src/app/pages/sids/building/floor-closing-questions/floor-closing-questions.page.ts ***!
  \*********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FloorClosingQuestionsPage": function() { return /* binding */ FloorClosingQuestionsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_floor_closing_questions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./floor-closing-questions.page.html */ 90895);
/* harmony import */ var _floor_closing_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./floor-closing-questions.page.scss */ 45466);
...
let FloorClosingQuestionsPage = class FloorClosingQuestionsPage {
    ...
    initialValidator() {
        this.form = this.formBuilder.group({
            ...
            "FloorSafetyRmrk": new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(false, null),
            ...
            // "ParapetWallBrickWork":new FormControl('', null),
            ...
            "RoofCleaYnRmrk": new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(false, null),
            "CorridorYn": new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(false, null),
            "CorridorYnRmrk": new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(false, null),
            ...
            "CorriLighFuncRmrk": new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl('0', null),
            ...
            "BldOhtYnRmrk": new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(false, null),
    ...
    onSave() {
        ...
        if (this.form.valid) {
            ...
            let query = 'UPDATE sidsFloorQuestion SET FloorSafety ="' + this.form.value.FloorSafety +
                '", ReqParapetWall = "' + this.form.value.ReqParapetWall + '", ParapetWallLength = "' + this.form.value.ParapetWallLength +
                '", ParapetWallHeight = "' + this.form.value.ParapetWallHeight + '", ParapetWallWhiteWash = "' + this.form.value.ParapetWallWhiteWash +
                '", ParapetWallReplasting = "' + this.form.value.ParapetWallReplasting + '", ParapetWallBrickWork = "' + this.form.value.ParapetWallBrickWork +
                '", RepairSteps = "' + this.form.value.RepairSteps + '", WeatheringReq = "' + this.form.value.WeatheringReq +
                '", FoolrTy = "' + this.form.value.FoolrTy + '", FoolrAreReq = "' + this.form.value.FoolrAreReq +
                '", OutPipY = "' + this.form.value.OutPipY + '", PipLenNeed = "' + this.form.value.PipLenNeed +
                '", RoofCleaYn = "' + this.form.value.RoofCleaYn + '", CorridorYn = "' + this.form.value.CorridorYn +
                '", CorriCondi = "' + this.form.value.CorriCondi + '", CorriLen = "' + this.form.value.CorriLen +
                '", CorridorWidth = "' + this.form.value.CorridorWidth + '", CorriLighFunc = "' + this.form.value.CorriLighFunc +
                '", CorridorRepair = "' + this.form.value.CorridorRepair + '", AreaWw = "' + this.form.value.AreaWw +
                '", AreaReplastering = "' + this.form.value.AreaReplastering + '", AreaReflooring = "' + this.form.value.AreaReflooring +
                '", AreaCeilingPlaster = "' + this.form.value.AreaCeilingPlaster + '", AreaFlrPatchwork = "' + this.form.value.AreaFlrPatchwork +
                // '", DoorReplace = "'+ this.form.value.DoorReplace +
                '", JaalisReplace = "' + this.form.value.JaalisReplace +
                // '", DoorRepair = "'+ this.form.value.DoorRepair +
                '", JaalisRepair = "' + this.form.value.JaalisRepair +
                // '", DoorRepaint = "'+ this.form.value.DoorRepaint +
                '", JaalisRepaint = "' + this.form.value.JaalisRepaint +
                '", BldOhtYn = "' + this.form.value.BldOhtYn + '", FunBldOhtYn = "' + this.form.value.FunBldOhtYn +
                '" WHERE sidsFloorQuestion.SclId = "' + this.schoolId + '" And sidsFloorQuestion.BuildingId = "' + this.buildingId + '" And sidsFloorQuestion.FloorId = "' + this.floorId + '"';
            let query2 = 'UPDATE sidsFloorSaveDatas SET FloorClose = 2 WHERE SclId = "' + this.schoolId + '" And BuildIndx = "' + idbuild + '" And FloorId = "' + this.floorId + '"';
    ...
    checkLocalDb() {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            ...
            if (data.rows.length > 0) {
                ...
                console.log(this.dataList, "dat aList");
                ...
                if (this.form.value.FoolrTy == "") {
                    this.form.controls['FoolrTy'].setValidators(null);
                    this.form.controls['FoolrTy'].updateValueAndValidity();
                }
                if (this.form.value.PipLenNeed == "") {
                ...
                if (+this.form.value.FloorCondi == 2) {
                    this.functionalFloor = false;
                }
                if (this.form.value.CorridorRepair) {
                    if (this.form.value.CorridorRepair.length > 0) {
                        this.getOnFunRepair(this.form.value.CorridorRepair, 1);
                    }
                }
                if (this.form.value.ReqParapetWall) {
                    if (this.form.value.ReqParapetWall.length > 0) {
                        this.getOnFunRepair(this.form.value.ReqParapetWall, 2);
                    }
                }
                // Abdullah
                if (+this.form.value.FoolrTy == 6 || +this.form.value.FoolrTy == 7) {
                    this.form.controls['FoolrTy'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_6__.Validators.required);
                    this.form.controls['FoolrTy'].updateValueAndValidity();
                }
                if (+this.form.value.CorridorYn != 7) {
                    this.form.controls['CorridorYn'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_6__.Validators.required);
                    this.form.controls['CorridorYn'].updateValueAndValidity();
                }
            }
            else {
    ...
    onSelectCondition(event, id) {
        ...
        if (id == 5) {
            if (this.form.value.CorridorRepair == 1) {
            }
            else {
            }
        }
    ...
    onToggleClass(event, id) {
        ...
        if (id == 2) {
            if (this.form.value.CorridorYn) {
                ...
                this.form.controls['CorriLighFunc'].setValue("0");
                ...
                this.form.controls['CorridorRepair'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_6__.Validators.required);
                // this.form.controls['CorriObstYn'].setValue(false);
            }
            else {
                this.form.controls['CorriLen'].setValue("");
            ...
            this.form.controls['CorridorRepair'].updateValueAndValidity();
            // this.form.controls['CorriObstYn'].updateValueAndValidity();
        }
        if (id == 3) {
    ...
    onFunRepair(event, id) {
        if (id == 1) {
            ...
            if (this.repairActive6) {
                ...
                // this.form.controls['DoorReplace'].setValidators(Validators.required);
            ...
            if (this.repairActive8) {
                ...
                // this.form.controls['DoorRepair'].setValidators(Validators.required);
            ...
            if (this.repairActive10) {
                ...
                // this.form.controls['DoorRepaint'].setValidators(Validators.required);
        ...
        if (id == 2) {
            ...
            for (let i = 0; i <= event.length; i++) {
                if (event[i] == "Increase in Length") {
                    this.parapetActive1 = true;
                }
                if (event[i] == "Increase in Height") {
                    this.parapetActive2 = true;
                }
                if (event[i] == "Whitewashing and Colouwashing") {
                    this.parapetActive3 = true;
                }
                if (event[i] == "Replastering") {
                    this.parapetActive4 = true;
                }
                if (event[i] == "Brickwork") {
...
FloorClosingQuestionsPage.ctorParameters = () => [
...
FloorClosingQuestionsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
        selector: 'app-floor-closing-questions',
        template: _raw_loader_floor_closing_questions_page_html__WEBPACK_IMPORTED_MODULE_0__.default,
        styles: [_floor_closing_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__.default]
    })
], FloorClosingQuestionsPage);
