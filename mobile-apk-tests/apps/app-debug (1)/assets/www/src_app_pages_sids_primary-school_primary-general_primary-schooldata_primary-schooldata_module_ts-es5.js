  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_sids_primary-school_primary-general_primary-schooldata_primary-schooldata_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimarySchooldataPageRoutingModule": function PrimarySchooldataPageRoutingModule() {
          return (
            /* binding */
            _PrimarySchooldataPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _primary_schooldata_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./primary-schooldata.page */
      19782);
      ...
      var _PrimarySchooldataPageRoutingModule = /*#__PURE__*/_createClass(function PrimarySchooldataPageRoutingModule() {
        _classCallCheck(this, PrimarySchooldataPageRoutingModule);
      });

      _PrimarySchooldataPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimarySchooldataPageModule": function PrimarySchooldataPageModule() {
          return (
            /* binding */
            _PrimarySchooldataPageModule
          );
        }
        /* harmony export */
      ...
      var _primary_schooldata_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./primary-schooldata-routing.module */
      76092);
      /* harmony import */


      var _primary_schooldata_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./primary-schooldata.page */
      19782);

      var _PrimarySchooldataPageModule = /*#__PURE__*/_createClass(function PrimarySchooldataPageModule() {
        _classCallCheck(this, PrimarySchooldataPageModule);
      });

      _PrimarySchooldataPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _primary_schooldata_routing_module__WEBPACK_IMPORTED_MODULE_0__.PrimarySchooldataPageRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimarySchooldataPage": function PrimarySchooldataPage() {
          return (
            /* binding */
            _PrimarySchooldataPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_primary_schooldata_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./primary-schooldata.page.html */
      4692);
      /* harmony import */


      var _primary_schooldata_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./primary-schooldata.page.scss */
      52393);
      /* harmony import */
      ...
      var src_app_services_emis_emis_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! src/app/services/emis/emis.service */
      71660);

      var _PrimarySchooldataPage = /*#__PURE__*/function () {
        function PrimarySchooldataPage(router, formBuilder, route, networkService, alertController, sqliteDB, emisService, utilityService, file, userSessionService, alertService, el, androidPermissions, geolocation, camera) {
          _classCallCheck(this, PrimarySchooldataPage);
        ...
        return _createClass(PrimarySchooldataPage, [{
          key: "ngOnInit",
          ...
          value: function serverData() {
            ...
            var query = 'SELECT * FROM sidsPrimaryGeneralServer' + ' WHERE SclId = "' + this.SchlId + '"' + ' And VistId = "' + this.VistUId + '"';
            ...
            if (id == 4 && this.form.value.PurpLaptopFun == 0) {
              if (this.form.value.PurpLaptopNonFun != '') {
                if (+this.form.value.PurpLaptopNonFun == 0) {
                  ...
                  this.form.controls['PurpLaptopFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 5 && this.form.value.PurpComputerFun == 0) {
              if (this.form.value.PurpComputerNonFun != '') {
                if (+this.form.value.PurpComputerNonFun == 0) {
                  ...
                  this.form.controls['PurpComputerFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 6 && this.form.value.PurpTabFun == 0) {
              if (this.form.value.PurpTabNonFun != '') {
                if (+this.form.value.PurpTabNonFun == 0) {
                  ...
                  this.form.controls['PurpTabFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 7 && this.form.value.PurpPrinterFun == 0) {
              if (this.form.value.PurpPrinterNonFun != '') {
                if (+this.form.value.PurpPrinterNonFun == 0) {
                  ...
                  this.form.controls['PurpPrinterFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 8 && this.form.value.PurpProjectorFun == 0) {
              if (this.form.value.PurpProjectorNonFun != '') {
                if (+this.form.value.PurpProjectorNonFun == 0) {
                  ...
                  this.form.controls['PurpProjectorFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 9 && this.form.value.PurpLaptopNonFun == 0) {
              if (this.form.value.PurpLaptopFun != '') {
                if (+this.form.value.PurpLaptopFun == 0) {
                  ...
                  this.form.controls['PurpLaptopNonFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 10 && this.form.value.PurpComputerNonFun == 0) {
              if (this.form.value.PurpComputerFun != '') {
                if (+this.form.value.PurpComputerFun == 0) {
                  ...
                  this.form.controls['PurpComputerNonFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 11 && this.form.value.PurpTabNonFun == 0) {
              if (this.form.value.PurpTabFun != '') {
                if (+this.form.value.PurpTabFun == 0) {
                  ...
                  this.form.controls['PurpTabNonFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 12 && this.form.value.PurpPrinterNonFun == 0) {
              if (this.form.value.PurpPrinterFun != '') {
                if (+this.form.value.PurpPrinterFun == 0) {
                  ...
                  this.form.controls['PurpPrinterNonFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
            ...
            if (id == 13 && this.form.value.PurpProjectorNonFun == 0) {
              if (this.form.value.PurpProjectorFun != '') {
                if (+this.form.value.PurpProjectorFun == 0) {
                  ...
                  this.form.controls['PurpProjectorNonFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
                }
              }
            }
          }
          ...
          value: function onSave() {
            ...
            if (this.form.valid) {
              ...
              var deleteQuery = 'DELETE FROM sids_primary_general_schooldata' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
              console.log("DeleteQuery", deleteQuery, this.form.value);
              return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
                var datainsert = 'INSERT INTO sids_primary_general_schooldata VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';

                _this2.sqliteDB.insert(datainsert, [null, _this2.SchlId, _this2.VistUId, _this2.form.value.IndexId, _this2.form.value.SiteNum, _this2.form.value.TotalArea, _this2.form.value.PurpLaptopYN, _this2.form.value.PurpLaptopFun, _this2.form.value.PurpLaptopNonFun, _this2.form.value.PurpComputerYN, _this2.form.value.PurpComputerFun, _this2.form.value.PurpComputerNonFun, _this2.form.value.PurpTabYN, _this2.form.value.PurpTabFun, _this2.form.value.PurpTabNonFun, _this2.form.value.PurpPrinterYN, _this2.form.value.PurpPrinterFun, _this2.form.value.PurpPrinterNonFun, _this2.form.value.PurpProjectorYN, _this2.form.value.PurpProjectorFun, _this2.form.value.PurpProjectorNonFun, _this2.form.value.GeneralPhoto, _this2.form.value.GeneralPhotoName, _this2.form.value.GeneralLatitude, _this2.form.value.GeneralLongitude, _this2.form.value.EntrancePhoto, _this2.form.value.EntrancePhotoName, 1]).then(function (insertres) {
                  if (insertres.insertId) {
                    _this2.alertService.success('Saved Successfully');

                    console.log('Inserted SIDS General School Data');

                    _this2.deleteSchoolData();

                    _this2.router.navigate(['/tabs/primary-dashboard'], {
                      queryParams: {
          ...
          value: function checkLocalDB() {
            ...
            var deleteQuery = 'SELECT * FROM sids_primary_general_schooldata' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                _this3.form.patchValue({
                  ...
                  "PurpLaptopYN": _this3.dataList[0].PurpLaptopYN == "false" ? false : _this3.dataList[0].PurpLaptopYN == "true" ? true : _this3.dataList[0].PurpLaptopYN == true ? 1 : 2,
                  "PurpLaptopFun": _this3.dataList[0].PurpLaptopFun,
                  "PurpLaptopNonFun": _this3.dataList[0].PurpLaptopNonFun,
                  "PurpComputerYN": _this3.dataList[0].PurpComputerYN == "false" ? false : _this3.dataList[0].PurpComputerYN == "true" ? true : _this3.dataList[0].PurpComputerYN == true ? 1 : 2,
                  "PurpComputerFun": _this3.dataList[0].PurpComputerFun,
                  "PurpComputerNonFun": _this3.dataList[0].PurpComputerNonFun,
                  "PurpTabYN": _this3.dataList[0].PurpTabYN == "false" ? false : _this3.dataList[0].PurpTabYN == "true" ? true : _this3.dataList[0].PurpTabYN == true ? 1 : 2,
                  "PurpTabFun": _this3.dataList[0].PurpTabFun,
                  "PurpTabNonFun": _this3.dataList[0].PurpTabNonFun,
                  "PurpPrinterYN": _this3.dataList[0].PurpPrinterYN == "false" ? false : _this3.dataList[0].PurpPrinterYN == "true" ? true : _this3.dataList[0].PurpPrinterYN == true ? 1 : 2,
                  "PurpPrinterFun": _this3.dataList[0].PurpPrinterFun,
                  "PurpPrinterNonFun": _this3.dataList[0].PurpPrinterNonFun,
                  "PurpProjectorYN": _this3.dataList[0].PurpProjectorYN == "false" ? false : _this3.dataList[0].PurpProjectorYN == "true" ? true : _this3.dataList[0].PurpProjectorYN == true ? 1 : 2,
                  "PurpProjectorFun": _this3.dataList[0].PurpProjectorFun,
                  "PurpProjectorNonFun": _this3.dataList[0].PurpProjectorNonFun,
                  ...
                  "EntrancePhoto": _this3.dataList[0].EntrancePhoto,
                  "EntrancePhotoName": _this3.dataList[0].EntrancePhotoName
                });
              } else {
          ...
          value: function onSyncSave() {
            ...
            if (this.form.valid) {
              if (this.networkService.getCurrentNetworkStatus() == 0) {
                var dataImage = (_a = this.form.value.GeneralPhoto) === null || _a === void 0 ? void 0 : _a.split(',');
                var dataImage2 = (_b = this.form.value.EntrancePhoto) === null || _b === void 0 ? void 0 : _b.split(',');
                var records = {
                  "records": {
                ...
                this.utilityService.SidsGeneralQues(records).subscribe(function (res) {
                  if (res.dataStatus) {
                    if (dataImage.length > 1) {
                      var imgObj = {
                        "records": {
                          "Photo": dataImage[1],
                          "PhotoName": _this4.form.value.GeneralPhotoName
                        }
                      };

                      _this4.emisService.S3ImageSave(imgObj).subscribe(function (res) {});
                    }
                    ...
                    if (dataImage2.length > 1) {
                      var _imgObj = {
                        "records": {
                          "Photo": dataImage2[1],
                          "PhotoName": _this4.form.value.EntrancePhotoName
                        }
                      };

                      _this4.emisService.S3ImageSave(_imgObj).subscribe(function (res) {});
                    }

                    _this4.form.controls['IndexId'].setValue(res.IndexId);

                    _this4.form.controls['IndexId'].updateValueAndValidity();

                    _this4.updateAllQuery();

                    _this4.insertLocalDB();
          ...
          value: function insertLocalDB() {
            ...
            var deleteQuery = 'DELETE FROM sidsPrimaryGeneralServer' + ' WHERE SclId = "' + this.SchlId + '"' + ' And VistId = "' + this.VistUId + '"';
            this.sqliteDB.getDataLocalDB(deleteQuery).then(function (res) {
              var datainsert = "INSERT INTO sidsPrimaryGeneralServer VALUES (?,?,?,?)";

              _this5.sqliteDB.insert(datainsert, [null, _this5.SchlId, _this5.VistUId, "3"]).then(function (insertres) {
          ...
          key: "updateAllQuery",
          value: function updateAllQuery() {
            var _this6 = this;

            var query1 = 'DELETE FROM sids_primary_general_schooldata' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            console.log("query ", query1, this.form.value);
            return this.sqliteDB.getDataLocalDB(query1).then(function (data) {
              var datainsert = 'INSERT INTO sids_primary_general_schooldata VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';

              _this6.sqliteDB.insert(datainsert, [null, _this6.SchlId, _this6.VistUId, _this6.form.value.IndexId, _this6.form.value.SiteNum, _this6.form.value.TotalArea, _this6.form.value.PurpLaptopYN, _this6.form.value.PurpLaptopFun, _this6.form.value.PurpLaptopNonFun, _this6.form.value.PurpComputerYN, _this6.form.value.PurpComputerFun, _this6.form.value.PurpComputerNonFun, _this6.form.value.PurpTabYN, _this6.form.value.PurpTabFun, _this6.form.value.PurpTabNonFun, _this6.form.value.PurpPrinterYN, _this6.form.value.PurpPrinterFun, _this6.form.value.PurpPrinterNonFun, _this6.form.value.PurpProjectorYN, _this6.form.value.PurpProjectorFun, _this6.form.value.PurpProjectorNonFun, _this6.form.value.GeneralPhoto, _this6.form.value.GeneralPhotoName, _this6.form.value.GeneralLatitude, _this6.form.value.GeneralLongitude, _this6.form.value.EntrancePhoto, _this6.form.value.EntrancePhotoName, 1]).then(function (insertres) {
                if (insertres.insertId) {
                  _this6.alertService.success('Saved Successfully');

                  console.log('Inserted SIDS General School Data');

                  _this6.router.navigate(['/tabs/primary-dashboard'], {
                    queryParams: {
                      'schoolId': _this6.SchlId,
                      'vistId': _this6.VistUId,
                      'visitstatus': _this6.visitstatus
                    },
                    skipLocationChange: false
                  });
                }
          ...
          key: "deleteSchoolData",
          value: function deleteSchoolData() {
            var deleteQuery = 'UPDATE sidsPrimaryGeneralServer SET Status = 2' + ' WHERE SclId = "' + this.SchlId + '"' + ' And VistId = "' + this.VistUId + '"';
            this.sqliteDB.getDataLocalDB(deleteQuery).then(function (res) {
              ...
              _this7.file.readAsDataURL(imagename, filename).then(function (base64string) {
                if (base64string) {
                  ...
                  if (blob.size <= 3145728) {
                    ...
                    if (i == 2) {
                      _this7.form.controls['EntrancePhoto'].setValue(base64string);

                      _this7.form.controls['EntrancePhotoName'].setValue(splitedImage[0] + '.png');
                    }
      ...
      _PrimarySchooldataPage.ctorParameters = function () {
        return [{
      ...
      _PrimarySchooldataPage.propDecorators = {
        content: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_17__.ViewChild,
          args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_16__.IonContent]
        }]
      };
      _PrimarySchooldataPage = (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_17__.Component)({
...
//# sourceMappingURL=src_app_pages_sids_primary-school_primary-general_primary-schooldata_primary-schooldata_module_ts-es5.js.map