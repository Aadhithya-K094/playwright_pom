...
/* harmony export */   "OoscquestionsPageModule": function() { return /* binding */ OoscquestionsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _ooscquestions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ooscquestions.page */ 97039);
...
let OoscquestionsPageModule = class OoscquestionsPageModule {
};
OoscquestionsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OoscquestionsPage": function() { return /* binding */ OoscquestionsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_ooscquestions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./ooscquestions.page.html */ 60779);
/* harmony import */ var _ooscquestions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ooscquestions.page.scss */ 82903);
...
let OoscquestionsPage = class OoscquestionsPage {
    constructor(fb, router, uploadService, http, geolocation, emisService, platform, userSessionService, route, camera, alertService, modalCtrl, file, androidPermissions, locationAccuracy, alertController, sqliteDB, networkService) {
        ...
        this.newlyIdentifyList = [
            { label: 'Newly identified', value: '1' },
            { label: 'Existing', value: '2' },
        ];
        this.reason = [
            { label: 'Identified the student and initiated contact', value: '101' },
            { label: 'Student coming back to school normally', value: '102' },
            { label: 'Student to be moved to common pool', value: '103' }
        ];
        this.specialNeedTypes = [
            { label: 'Home-based care', value: '1' },
            { label: 'School Readiness Programme centres', value: '2' },
        ];
        this.nomadTypes = [
            { label: 'Boom boom maatu karar', value: '1' },
            { label: 'Kazhai koothadigal', value: '2' },
            { label: 'Kudu kuduppai karar', value: '3' },
            { label: 'Narikuravars', value: '4' },
            { label: 'Other types of nomads', value: '5' },
        ];
        this.reasonfordropoutList = [
            // { label: 'Boom Boom Maatu Karar (children of Nomads / Gypsies)', value: '23' },
            { label: 'HIV infected', value: '28' },
            { label: 'Children of Leprosy Affected Parents / Leprosy Affected Children', value: '29' },
            { label: 'Children of Migrant Parents', value: '20' },
            { label: 'Children of Drug Addicts', value: '16' },
            { label: 'Children of Sex Workers', value: '17' },
            { label: 'Informal/ Unorganised labourers', value: '18' },
            { label: 'Children Affected by Natural Calamity (Tsunami, Cyclone etc)', value: '7' },
            { label: 'Children who are Begging', value: '11' },
            { label: 'Conflict With Law (Student in Juvenile Home, Observation Home)', value: '8' },
            { label: 'Children in Slums', value: '9' },
            { label: 'Children Affected by Child Marriages', value: '34' },
            { label: 'Children in Difficult Terrain', value: '59' },
            { label: 'Child labour - Below 14 years', value: '6' },
            { label: 'Gender issue (Girl child, Third gender)', value: '60' },
            { label: 'Homeless/ Street Children/ Children Without Shelter/ Children in Bus Stand/ Railway Station', value: '61' },
            { label: 'Health Related Issues', value: '33' },
            ...
            { label: 'Lack of Interest in Coming to School', value: '1' },
            { label: 'Lack of awareness of Parents', value: '3' },
            // { label: 'Narikuravars (Children of Nomads / Gypsies)', value: '21' },
            { label: 'Orphans', value: '26' },
            // { label: 'Other Types of Nomads (Children of Nomads / Gypsies)', value: '25' },
            { label: 'Parents health issues', value: '62' },
            { label: 'Rag Pickers', value: '12' },
            { label: 'Sibling Care', value: '5' },
            { label: 'Social and Cultural issues', value: '32' },
            { label: 'Semi-Orphans (Single Parent Child)', value: '27' },
            { label: 'Children in Settlement Colony', value: '79' },
            { label: 'Children of Nomads / Gypsies', value: '80' },
        ];
        this.reasonfordropoutListoosc = [
            { label: 'Admitted in Unrecognized Schools', value: '77' },
            { label: 'Admitted in Unrecognized Classes (Partially Recognized Schools)', value: '78' },
            { label: 'Adolescent Labour (14-18 years)', value: '67' },
            // { label: 'Boom Boom Maatu Karar (children of Nomads / Gypsies)', value: '23' },
            { label: 'Bogus Profile', value: '48' },
            { label: 'Children Affected by Natural Calamity (Tsunami, Cyclone etc)', value: '7' },
            { label: 'Children in Slums', value: '9' },
            { label: 'Children who are Begging', value: '11' },
            { label: 'Children of Drug Addicts', value: '16' },
            ...
            { label: 'HIV infected', value: '28' },
            { label: 'Children of Leprosy Affected Parents / Leprosy Affected Children', value: '29' },
            { label: 'Children With Special Needs', value: '30' },
            //{ label: 'Children With Special Needs', value: '31' },
            { label: 'Children Affected by Child Marriages', value: '34' },
            { label: 'Children in Difficult Terrain', value: '59' },
            { label: 'Conflict With Law (Student in Juvenile Home, Observation Home)', value: '8' },
            { label: 'Duplicate Entry', value: '36' },
            { label: 'Child labour - Below 14 years', value: '6' },
            { label: 'Failed in Class XI', value: '63' },
            { label: 'Failed in Class X', value: '54' },
            { label: 'Fee Not Paid', value: '50' },
            { label: 'Gender issue (Girl child, Third gender)', value: '60' },
            { label: 'Health Related Issues', value: '33' },
            // { label: 'Homeless / Street children', value: '10' },
            { label: 'Homeless/ Street Children/ Children Without Shelter/ Children in Bus Stand/ Railway Station', value: '61' },
            { label: 'Home Schooling', value: '58' },
            // { label: 'Kazhai Koothadigal (Children of Nomads / Gypsies)', value: '22' },
            // { label: 'Kudu Kuduppai Karar (Children of Nomads / Gypsies)', value: '24' },
            { label: 'Lack of Interest in Coming to School', value: '1' },
            { label: 'Lack of awareness of Parents', value: '3' },
            // { label: 'Lack of support from Parents', value: '71' }, // no
            { label: 'Migrated to other Block', value: '55' },
            { label: 'Migrated to Other Districts', value: '53' },
            { label: 'Migrated to Other State', value: '51' },
            { label: 'Migrated to Other Country', value: '56' },
            // { label: 'Narikuravars (Children of Nomads / Gypsies)', value: '21' },
            { label: 'Open Schooling', value: '64' },
            // { label: 'Other Types of Nomads (Children of Nomads / Gypsies)', value: '25' },
            { label: 'Orphans', value: '26' },
            { label: 'Parents health issues', value: '62' },
            { label: 'Rag Pickers', value: '12' },
            ...
            { label: 'Social and Cultural issues', value: '32' },
            { label: 'Sibling Care', value: '5' },
            { label: 'Student Expired', value: '37' },
            { label: 'Student Studying in ITI', value: '38' },
            { label: 'Student Studying in Polytechnic', value: '39' },
            { label: 'Student Studying in Industrial Schools', value: '40' },
            ...
            { label: 'Student Studying in Private Tutorials / Tuition Centres', value: '41' },
            { label: 'Studying in school in neighbouring states', value: '68' },
            { label: 'Seasonal Migration', value: '69' },
            { label: 'Substance Abuse', value: '70' },
            { label: 'Student studying Diploma in Nursing', value: '65' },
            { label: 'Student studying Diploma in Medical Laboratory Technology (DMLT)course', value: '66' },
            { label: 'Student Over Age', value: '46' },
            { label: 'Student Under Age', value: '57' },
            { label: 'Students studying in Madrassa', value: '76' },
            { label: 'Students Studying in Madapalli/Other Religious Schools', value: '49' },
            { label: 'Untraceable/Unable to Contact', value: '44' },
            { label: 'XII Completed', value: '47' },
            { label: 'Children in Settlement Colony', value: '79' },
            { label: 'Children of Nomads / Gypsies', value: '80' },
        ];
        ...
        this.presentStatusList = [
            { label: 'Continuing in special training ', value: '1' },
            { label: 'Dropped out again', value: '2' }
        ];
        ...
        this.formalSchoolList = [
            { label: 'Direct Enrolment', value: '1' },
            { label: 'Special Training Centre', value: '2' }
        ];
        this.specialTrainingList = [
            { label: 'NRSTC/RSTC', value: '1' },
            { label: 'KGBV', value: '2' },
            { label: 'ARS', value: '3' }
        ];
        this.genderList = [
        ...
        this.RationCardCategoryList = [
            { label: 'PHHRICE', value: '1' },
            { label: 'PHHA ', value: '2' },
            { label: 'NPHA or NPHHL', value: '3' },
            { label: 'NPHHS', value: '4' },
            { label: 'NPHHNC', value: '5' }
        ];
        this.classList = [
            { label: "I", value: 'I' },
            { label: "II", value: 'II' },
    ...
    ngOnInit() {
        ...
        this.getDeptMasterDetailsJson();
        // this.checkDepartmentListLocalDB();
    ...
    ionViewDidEnter() {
        ...
        if (this.Id == '2') {
            ...
            if (this.pagefun == 'edit') {
                ...
                this.route.queryParams.subscribe((params) => {
                    ...
                    this.cwsn_student = this.studentData.cwsn_student;
                    this.disabilityType = this.studentData.differently_abled;
                    this.disabilityName = this.studentData.diff_abled_reason;
                    this.ac_year = this.studentData.ac_year;
                    this.schoolname = this.studentData.school_name;
            ...
            this.route.queryParams.subscribe((params) => {
                ...
                this.motherName = this.studentData.mother_name;
                this.studEmisNo = this.studentData.new_emis_id;
                this.studOldEmisNo = this.studentData.old_emis_no;
                this.studentAddress = this.studentData.Address;
                this.studentId = this.studentData.stud_id;
                this.stuClsId = this.studentData.class_studying_id;
            });
        ...
        if (this.stuClsId) {
            if (this.stuClsId < 10) {
                const res = this.reasonfordropoutListoosc.filter(obj => obj.value != 54 && obj.value != 63);
    ...
    setFormValues() {
        ...
        this.form.controls['ActSts'].setValue('1');
        // this.getAcYr();
    ...
    onLocalBodyChange(event) {
        ...
        if (this.masterHabitationList.length > 0) {
            ...
            habitation.push({ BlkId: "", DistId: "", IndxId: "92298", LoclBodyCode: "13298", Name: "Other", TamilName: "", ZoneTypId: "92298" });
    ...
    getStudentData() {
        this.emisService.getStudentData(this.studentId, this.schoolId).subscribe(res => {
            var _a, _b;
            if (res.dataStatus == true) {
                ...
                if (((_a = this.form.value.DrpOutRsn) === null || _a === void 0 ? void 0 : _a.value) != '' && ((_b = this.form.value.DrpOutRsn) === null || _b === void 0 ? void 0 : _b.value) != null && this.studentData.MigratDist && (this.form.value.DrpOutRsn.value == 55 || this.form.value.DrpOutRsn.value == 41 || this.form.value.DrpOutRsn.value == 66)) {
                    this.onOoscDistrictChange('load', this.studentData.MigratDist, 'drop');
                }
                debugger;
                this.form.controls['IndxID'].setValue(this.studentData.IndxID);
                this.form.controls['Address'].setValue(this.studentAddress);
                let dropOutIndex = this.reasonfordropoutListoosc.find(o => o.value == this.studentData.DrpOutRsn);
                this.form.controls['DAyn'].setValue(this.cwsn_student);
                this.form.controls['DATyp'].setValue(this.disabilityType);
                this.form.controls['DATypNam'].setValue(this.disabilityName);
                this.form.controls['help'].setValue(this.studentData.help);
                // this.form.controls['relDprt'].setValue(this.studentData.relDprt);
                this.form.controls['DrpOutRsn'].setValue(dropOutIndex);
                debugger;
                this.dropOutEventChange(dropOutIndex, 'load');
                this.form.controls['MigrntAddrs'].setValue(this.studentData.MigrntAddrs);
                let instiIndex = this.reasonfordropoutListoosc.find(o => o.value == this.studentData.MigratInsti);
                if (this.studentData.DistrictId != '' && this.studentData.DistrictId != null && this.studentData.DistrictId != 0) {
                    this.form.controls['DistrictId'].setValue({ value: this.studentData.DistrictId, label: this.studentData.PresentDistrictName });
                    this.onOoscDistrictChange('load', this.studentData.DistrictId, 'present');
                }
                if (this.studentData.PresentBlckId != '' && this.studentData.PresentBlckId != null) {
                    this.form.controls['block'].setValue({ value: this.studentData.PresentBlckId, label: this.studentData.PresentBlckName });
                    this.onOoscBlockChange(this.studentData.PresentBlckId, 'load');
                }
                if (this.studentData.PresentSchoolId != '' && this.studentData.PresentSchoolId != null) {
                    this.form.controls['AdmitSchool'].setValue({ value: this.studentData.PresentSchoolId, label: this.studentData.PresentSchoolName });
                }
                else {
                    this.form.controls['AdmitSchool'].setValue('');
                }
                ...
                if (this.studentData.dropOutFile != '' && this.studentData.dropOutFile != null && this.studentData.dropOutFile != undefined && this.studentData.dropOutFile != 0) {
                    this.form.controls["dropOutFile"].setValue(this.studentData.dropOutFile);
                    this.form.controls['dropOutFile'].updateValueAndValidity();
                    this.imageKey = this.studentData.dropOutFile;
                    this.doc1Uploaded = true;
                    this.viewDoc('show');
                }
                if (this.studentData.CameraFile != '' && this.studentData.CameraFile != null && this.studentData.CameraFile != undefined) {
                    this.form.controls["CameraFile"].setValue(this.studentData.CameraFile);
                    this.form.controls['CameraFile'].updateValueAndValidity();
                    this.cameraKey = this.studentData.CameraFile;
                    this.viewPic('show');
                }
                else {
                    this.imageData = '';
    ...
    dropOutEventChange(eventValue, fun) {
        // this.releventDepartments = 
        let deptFilter = this.deptList.filter(tt => tt.key == eventValue.value);
        ...
        this.onHelpChange(this.studentData.help, 'change');
        // console.log('releventDepartments', this.releventDepartments) //   const key = 'reason_id';
        ...
        if (eventValue != undefined) {
            ...
            if (eventValue.value == 6 || eventValue.value == 7 || eventValue.value == 9 || eventValue.value == 11 || eventValue.value == 17 || eventValue.value == 18 || eventValue.value == 26 || eventValue.value == 27 || eventValue.value == 28 || eventValue.value == 29 || eventValue.value == 30 || eventValue.value == 50 || eventValue.value == 62 || eventValue.value == 79) {
                ...
                if (fun == 'change') {
                    ...
                    this.form.controls['MigratCountry'].setValue({ value: this.studentData.MigratCountry, label: this.studentData.MigratCountryName });
                }
                this.checkCountryLocalDB();
                ...
                if (fun == 'change') {
                    ...
                    this.form.controls['MigratState'].setValue({ value: this.studentData.MigratState, label: this.studentData.MigratStateName });
                }
                ...
                if (fun == 'change') {
                    ...
                    this.form.controls['MigratDist'].setValue({ value: this.studentData.MigratDist, label: this.studentData.MigratDistName });
                }
                ...
                if (fun == 'change') {
                    ...
                    this.form.controls['MigratDist'].setValue({ value: this.studentData.MigratDist, label: this.studentData.MigratDistName });
                    this.form.controls['MigratBlock'].setValue({ value: this.studentData.MigratBlock, label: this.studentData.MigratBlockName });
                }
                this.form.controls["MigratDist"].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.required);
                this.form.controls["MigratBlock"].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.required);
                this.form.controls["MigrntAddrs"].setValidators([_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.pattern(this.addrFormat)]);
                ...
                this.form.controls["crctAddrYN"].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.required);
                // this.form.controls["currentAddr"].setValue('');
                // this.form.controls["currentAddr"].setValidators(null);
                this.form.controls["parentLive"].setValidators(null);
                this.form.controls["MigratCountry"].setValue('');
                ...
                if (fun == 'change') {
                    ...
                    this.form.controls['DistrictId'].setValue({ value: this.studentData.DistrictId, label: this.studentData.PresentDistrictName });
                    this.form.controls['block'].setValue({ value: this.studentData.PresentBlckId, label: this.studentData.PresentBlckId });
                    this.form.controls['AdmitSchool'].setValue({ value: this.studentData.PresentSchoolId, label: this.studentData.PresentSchoolId });
                ...
                if (fun == 'change') {
                    ...
                    console.log('load 80');
                    let nomadIndex = this.nomadTypes.find(o => o.value == this.studentData.nomadTyp);
                    console.log('nomadIndex', nomadIndex);
                    this.form.controls['nomadTyp'].setValue(nomadIndex);
                    // this.form.controls['nomadTyp'].setValue({ value: this.studentData.nomadTyp, label: this.studentData.MigratDistName });
                }
                this.form.controls["RatnCrdNum"].setValidators([_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.pattern(this.aadhar)]);
                this.form.controls["RatnCrdHldrNam"].setValidators([_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.pattern('[a-zA-Z. ]*')]);
                this.form.controls["RatnCardCat"].setValidators(null);
    ...
    onOoscBlockChange(eventval, fun) {
        ...
        let json_name = 'https://d1wpyxz35bzzz4.cloudfront.net/master_json/' + this.form.value.block.value + '-blkwise_school.json';
        this.http.get(json_name).subscribe((data) => {
            if (data) {
                this.masterSchoolList = data;
                if (this.masterSchoolList.length > 0) {
                    if (this.form.value.block != '' && this.form.value.block != null && this.form.value.block != undefined) {
    ...
    onMigratBoundChange(eventVal, fun) {
        if (eventVal != '' && eventVal != null && eventVal == 1) {
            if (fun == 'change') {
                this.form.controls['MigrntYN'].setValue('');
            }
            else {
                this.form.controls['MigrntYN'].setValue({ value: this.studentData.MigrntYN, label: this.studentData.MigrntYN });
            }
        }
        else {
            this.form.controls['MigrntYN'].setValue('');
        ...
        if (eventVal != '' && eventVal != null && eventVal == 1) {
            if (fun == 'change') {
                ...
                if (this.studentData.DATyp != '' && this.studentData.DATyp != null) {
                    let daTypIndex = this.differentlyAbledList.find(o => o.value == this.studentData.DATyp);
    ...
    onHelpChange(eventVal, fun) {
        ...
        if (this.releventDepartments.length > 0) {
            ...
            if (eventVal != '' && eventVal != null && eventVal == 1) {
                if (fun == 'change') {
                    ...
                    if (this.studentData.relDprt != '' && this.studentData.relDprt != null) {
                        ...
                        let helpIndex = this.releventDepartments.find(o => o.id == this.studentData.relDprt);
            ...
            this.form.controls['help'].setValue('2');
            // this.form.controls['relDprt'].setValue('');
            this.form.controls['relDprt'].setValidators(null);
        }
        if (eventVal != '' && eventVal != null && eventVal == 1) {
    ...
    onMigrantChange(eventVal, fun) {
        console.log('onMigrantChange eventVal', eventVal);
        // this.allCountryState = eventVal;
        console.log('onMigrantChange');
        if (eventVal != '' && eventVal != null) {
            // this.form.controls['MigratBound'].setValidators(Validators.required);
            // this.form.controls['MigratBound'].setValidators(null);
            if (fun == 'change') {
                console.log('onMigrantChange change', eventVal);
                // this.form.controls['MigratBound'].setValue("");
                this.form.controls['MigratCountry'].setValue("");
                this.form.controls['MigratState'].setValue("");
                this.form.controls['MigratDist'].setValue("");
                ...
                console.log('onMigrantChange load', eventVal);
                // this.form.controls['MigratBound'].setValue({ value: this.studentData.MigratMigratBound, label: this.studentData.MigratBound });
                // this.form.controls['MigratBound'].setValidators(Validators.required);
                if (eventVal == 1) {
                    this.form.controls['MigratCountry'].setValue({ value: this.studentData.MigratCountry, label: this.studentData.MigratCountryName });
                    this.form.controls['MigratCountry'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.required);
    ...
    onSave() {
        ...
        setTimeout(() => {
            ...
            this.form.controls['ACYr'].setValue(this.acyear);
            this.dateformat = this.form.value.Dob;
            this.datevalue = this.pipe.transform(this.dateformat, 'yyyy-MM-dd');
            this.form.controls['Dob'].setValue(this.datevalue);
            this.form.controls['Latitude'].setValue(this.lat);
            this.form.controls['Longitude'].setValue(this.long);
            let udise_code;
            ...
            if (this.form.value.SpclTrngTyp == '2' || this.form.value.SpclTrngTyp == '3') {
                if (this.form.value.SplSchlUdise != '' && this.form.value.SplSchlUdise != null && this.form.value.SplSchlUdise != 0 && this.form.value.AdmitSchlID != '' && this.form.value.AdmitSchlID != null && this.form.value.AdmitSchlID != 0) {
                    if (this.form.value.SplSchlUdise == this.form.value.AdmitSchlID) {
                        udise_code = true;
                    }
                    else {
                        udise_code = false;
            ...
            console.log('oosc form', this.form);
            if (udise_code == true) {
                if (this.form.value.IndxID != null && this.form.value.IndxID != '' && this.form.value.IndxID != undefined) {
                    ...
                    if (this.form.valid) {
                        if (this.cnfmBtn == true || this.form.value.DrpOutRsn.value != 36) {
                            if (this.form.value.DATyp == '' || this.form.value.DATyp == null || this.form.value.DATyp == 0) {
                                this.form.controls['DATyp'].setValue({ value: '', label: '' });
                            }
                            if (this.form.value.DrpOutRsn == '' || this.form.value.DrpOutRsn == null || this.form.value.DrpOutRsn == 0) {
                                this.form.controls['DrpOutRsn'].setValue({ value: '', label: '' });
                            }
                            if (this.form.value.MigratCountry == '' || this.form.value.MigratCountry == null || this.form.value.MigratCountry == 0) {
                                this.form.controls['MigratCountry'].setValue({ value: '', label: '' });
                            }
                            if (this.form.value.MigratState == '' || this.form.value.MigratState == null || this.form.value.MigratState == 0) {
                                this.form.controls['MigratState'].setValue({ value: '', label: '' });
                            }
                            if (this.form.value.MigratDist == '' || this.form.value.MigratDist == null || this.form.value.MigratDist == 0) {
                                this.form.controls['MigratDist'].setValue({ value: '', label: '' });
                            }
                            if (this.form.value.MigratBlock == '' || this.form.value.MigratBlock == null || this.form.value.MigratBlock == 0) {
                                this.form.controls['MigratBlock'].setValue({ value: '', label: '' });
                            }
                            if (this.form.value.MigratInsti == '' || this.form.value.MigratInsti == null || this.form.value.MigratInsti == 0) {
                                this.form.controls['MigratInsti'].setValue({ value: '', label: '' });
                            }
                            if (this.form.value.DistrictId == '' || this.form.value.DistrictId == null || this.form.value.DistrictId == 0) {
                                this.form.controls['DistrictId'].setValue({ value: '', label: '' });
                            }
                            ...
                            if (this.form.value.nomadTyp == '' || this.form.value.nomadTyp == null || this.form.value.nomadTyp == 0) {
                                this.form.controls['nomadTyp'].setValue({ value: '', label: '' });
                            }
                            if (this.form.value.SplSchl == '' || this.form.value.SplSchl == null || this.form.value.SplSchl == 0) {
                                this.form.controls['SplSchl'].setValue({ value: '', label: '' });
                            }
                            var data = this.form.value;
                            console.log('data', data);
                            this.emisService.saveOoscData(data, true).subscribe(res => {
                                if (res.dataStatus == true) {
                                    this.nesFormAllow = false;
                                    this.ooscStudLocalUpdate(this.form.value.DrpOutRsn.value);
                            ...
                            this.alertService.error('Please confirm duplicate student details');
                            this.isBtnDisabled = false;
                        }
                    }
                    else {
                ...
                this.alertService.error('UDISE Code not matching');
                this.isBtnDisabled = false;
            }
            // } else {
    ...
    getInstitute(type, fun) {
        ...
        if (connectionStatus !== 1) {
            let insti_json_name = 'https://d1wpyxz35bzzz4.cloudfront.net/osc_detail_master_institute.json';
            this.http.get(insti_json_name).subscribe((data) => {
                this.masterInstList = data.institute;
                if (this.masterInstList) {
                    if (this.masterInstList.length > 0) {
                        let instiDeleteQuery = 'DELETE FROM instituteList';
                        return this.sqliteDB.getDataLocalDB(instiDeleteQuery).then(instidata => {
                            let sqlArray = [];
                            this.masterInstList.forEach(element => {
                                sqlArray.push(['INSERT INTO instituteList VALUES (?,?,?,?)', [null, element.id, element.institute_id, element.institute_name_address]]);
                            });
                            this.sqliteDB.bulkInsert(sqlArray).then((insertres) => {
                                this.checkInstiLocalDB(type, fun);
                            });
                        });
                    }
                }
                        ...
                        this.uploadService.getSignedUrl(bucketName, ext, filename, expiry).subscribe((result) => {
                            if (result) {
                                ...
                                this.uploadService.uploadFile(result.url, file).subscribe((res) => {
                                    ...
                                    this.form.controls.CameraFile.setValue(result.key);
                            ...
                            this.uploadService.getSignedUrl(bucketName, ext, filename, expiry).subscribe((result) => {
                                if (result) {
                                    ...
                                    this.uploadService.uploadFile(result.url, file).subscribe((res) => {
                                        ...
                                        this.imgext = '';
                                        this.doc1Uploaded = true;
                                        this.form.controls.dropOutFile.setValue(result.key);
                                        this.viewDoc(result.key);
                                    });
                                    this.alertService.success('File Uploaded Successfully');
                                }
                                else {
                ...
                if (fun == 'modal') {
                    if (this.imgext == 'pdf') {
                        ...
                        const modal = yield this.modalCtrl.create({
                            ...
                            componentProps: { image: this.image1 },
    ...
    getResdSchoolList(event, fun) {
        if (event != '' && event != null && event != undefined && event != 0) {
            if (fun == 'load') {
                if (this.studentData.SplSchl != '' && this.studentData.SplSchl != null && this.studentData.SplSchl != undefined && this.studentData.SplSchl != 0) {
                    if (this.studentData.SpclTrngTyp == 1) {
                        this.form.controls['SplSchl'].setValue({ value: this.studentData.ResdSchlID, label: this.studentData.ResdCenterLoca });
                        this.form.controls["SplSchl"].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.required);
                        this.form.controls['SplSchlUdise'].setValue('');
                    }
                    else {
                        this.form.controls['SplSchl'].setValue({ value: this.studentData.SplSchlID, label: this.studentData.SplSchlName });
                        this.form.controls["SplSchl"].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_16__.Validators.required);
            ...
            let json_name = 'https://d1wpyxz35bzzz4.cloudfront.net/osc_detail_master_udise.json';
            this.http.get(json_name).subscribe((data) => {
                if (data) {
                    var school;
                    if (event == 1) {
                        school = data.rstclocation;
                        this.resiSchlList = school.map(l => { return { label: l.rstc_location, value: l.id }; });
                    }
                    else if (event == 2) {
                        school = data.spltrainingcenter;
                        this.resiSchlList = school.map(l => { return { label: l.school_name, value: l.school_id, udise: l.udise_code }; });
                    }
                    else {
                        school = data.udise_36;
                        this.resiSchlList = school.map(l => { return { label: l.school_name, value: l.school_id, udise: l.udise_code }; });
                    }
                    this.resiSchlList.sort((a, b) => {
                        if (a.label < b.label)
                            return -1;
                        if (a.label > b.label)
                            return 1;
    ...
    getBRTEStudentDetails() {
        if (this.indexID) {
            this.emisService.getBRTEStudntDetails(this.indexID).subscribe(res => {
                var _a, _b;
                if (res.dataStatus == true) {
                    this.studentData = res.result[0];
                    this.form.patchValue(this.studentData);
                    this.myBlock = this.studentData.MigratBlock;
                    if (((_a = this.form.value.DrpOutRsn) === null || _a === void 0 ? void 0 : _a.value) != '' && ((_b = this.form.value.DrpOutRsn) === null || _b === void 0 ? void 0 : _b.value) != null && this.studentData.MigratDist && this.form.value.DrpOutRsn.value == 55) {
                        this.onOoscDistrictChange('load', this.studentData.MigratDist, 'drop');
                    }
                    ...
                    this.form.controls['DrpOutRsn'].setValue(dropOutIndex);
                    this.dropOutEventChange(dropOutIndex, 'load');
                    if (this.studentData.DAyn != '' && this.studentData.DAyn != null && this.studentData.DAyn != undefined && this.studentData.DAyn != 0) {
                        this.onDiffAbleChange(this.studentData.DAyn, 'load');
                    }
                    if (this.studentData.help != '' && this.studentData.help != null && this.studentData.help != undefined && this.studentData.help != 0) {
                        this.onHelpChange(this.studentData.help, 'load');
                    }
                    ...
                    this.form.controls['MigrntAddrs'].setValue(this.studentData.MigrntAddrs);
                    if (this.studentData.DirctSpcl == '2') {
                        this.formalSchlChange(this.studentData.DirctSpcl, 'load');
                    }
                    if (this.studentData.AdmsnNo == 0) {
                        this.form.controls["AdmsnNo"].setValue('');
                        this.form.controls['AdmsnNo'].updateValueAndValidity();
                    }
                    if (this.studentData.dropOutFile != '' && this.studentData.dropOutFile != null && this.studentData.dropOutFile != undefined && this.studentData.dropOutFile != 0) {
    ...
    ooscStudLocalUpdate(reason) {
        this.emisService.OoscReasonType().subscribe(res => {
            if (res.dataStatus == true) {
                var reasonData = res.result;
                var reasonFilter = reasonData.filter(tt => tt.dropout_code == reason);
                if (reasonFilter.length > 0) {
                    let query1 = 'UPDATE ooscStudentsDetail SET Reason="' + reasonFilter[0].dropout_reason + '",' +
                        'reason_type="' + reasonFilter[0].reason_type + '", Status= 1 WHERE stud_id = "' + this.studentId + '"';
    ...
    onSurveySave() {
        ...
        if (this.surveyform.valid) {
            ...
            if (this.surveyform.value.relDprt == '' || this.surveyform.value.relDprt == null || this.surveyform.value.relDprt == 0) {
                this.surveyform.controls['relDprt'].setValue({ id: '', related_dept: '' });
            }
            if (this.surveyform.value.nomadTyp == '' || this.surveyform.value.nomadTyp == null || this.surveyform.value.nomadTyp == 0) {
                this.surveyform.controls['nomadTyp'].setValue({ value: '', label: '' });
            }
            var data = this.surveyform.value;
            this.emisService.saveOoscData(data, true).subscribe(res => {
                if (res.dataStatus) {
                    this.alertService.success(res.message);
                    this.emisService.OoscSurveyData(this.userSessionService.teacher_id(), true).subscribe(res => {
                        if (res.result[0].survey_NEC == 1) {
                            this.IndxID = res.result[0].id;
                            this.form.controls['IndxID'].setValue(this.IndxID);
                            this.survey_NEC = res.result[0].survey_NEC;
    ...
    getDeptMasterDetailsJson() {
        let json_name = 'https://d1wpyxz35bzzz4.cloudfront.net/drop_out_dept_list.json';
        this.http.get(json_name).subscribe((data) => {
            // console.log('json data')
            if (data) {
                let releventDepartments = data.oosc_department_mapping;
                this.deptList = this.transformArray(releventDepartments, 'reason_id');
            }
        });
    }
    transformArray(array, field) {
        if (array) {
    ...
    checkEmisNo() {
        ...
        if (this.form.controls.EmisNo.valid) {
            this.emisService.OoscDupliVerfi(this.form.value.EmisNo).subscribe(res => {
                if (res.dataStatus == true) {
                    let OoscDupliVerfi = res.result[0];
                    this.form.controls['dupStudName'].setValue(OoscDupliVerfi.name);
                    this.form.controls['dupFatherName'].setValue(OoscDupliVerfi.father_name);
                    this.form.controls['dupMotherName'].setValue(OoscDupliVerfi.mother_name);
                    this.form.controls['dupDOB'].setValue(OoscDupliVerfi.dob);
                    this.form.controls['dupAadhar'].setValue(OoscDupliVerfi.aadhaar_uid_number);
                }
                else {
                    this.form.controls['dupStudName'].setValue('');
                    this.form.controls['dupFatherName'].setValue('');
                    this.form.controls['dupMotherName'].setValue('');
                    this.form.controls['dupDOB'].setValue('');
                    this.form.controls['dupAadhar'].setValue('');
                }
            });
        }
        else {
    ...
    duplicateConfirmation() {
        ...
        if (this.form.value.dupStudName != '' && this.form.value.dupStudName != null && this.form.value.dupStudName != undefined) {
            ...
            this.emisService.OoscDupliVerfiSave(data).subscribe(res => {
                if (res.dataStatus == true) {
                    this.cnfmBtn = true;
    ...
    checkDepartmentListLocalDB() {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(country => {
            if (country.rows.length > 0) {
                ...
                ;
                this.masterCountryList = temp;
                const key = 'country_id';
                let unique_list = [...new Map(this.masterCountryList.map(item => [item[key], item])).values()];
                if (this.masterCountryList.length > 0) {
                    this.ooscCountryList = unique_list.map(l => { return { label: l.country_name, value: l.country_id }; });
                    this.ooscCountryList.sort((a, b) => {
                        if (a.label < b.label)
                            return -1;
                        if (a.label > b.label)
                            return 1;
    ...
    checkStateLocalDB() {
        ...
        return this.sqliteDB.getDataLocalDB(statequery).then(state => {
            if (state.rows.length > 0) {
                ...
                ;
                const key = 'state_id';
                let unique_list = [...new Map(list.map(item => [item[key], item])).values()];
                if (list.length > 0) {
                    this.ooscStateList = [];
                    this.ooscStateList = unique_list.map(l => { return { label: l.state_name, value: l.state_id }; });
                    this.ooscStateList.sort((a, b) => {
                        if (a.label < b.label)
                            return -1;
                        if (a.label > b.label)
                            return 1;
                ...
                this.checkDistrictLocalDB();
                // this.alertService.success("General Checkup Stored Successfully...!");
            }
            else {
    ...
    checkDistrictLocalDB() {
        ...
        return this.sqliteDB.getDataLocalDB(districtquery).then(district => {
            ...
            if (district.rows.length > 0) {
                ...
                ;
                this.masterDistrictList = temp;
                const key = 'disid';
                let unique_list = [...new Map(this.masterDistrictList.map(item => [item[key], item])).values()];
                if (this.masterDistrictList.length > 0) {
                    this.ooscDistrictList = unique_list.map(l => { return { label: l.district_name, value: l.disid }; });
                    this.ooscDistrictList.sort((a, b) => {
                        if (a.label < b.label)
                            return -1;
                        if (a.label > b.label)
                            return 1;
    ...
    checkInstiLocalDB(type, fun) {
        this.masterInstList = [];
        let query = 'SELECT * FROM instituteList';
        return this.sqliteDB.getDataLocalDB(query).then(insti => {
            if (insti.rows.length > 0) {
                ...
                ;
                this.masterInstList = instiTemp;
                const key = 'insti_id';
                let insti_unique_list = [...new Map(this.masterInstList.map(item => [item[key], item])).values()];
                if (insti_unique_list) {
                    if (insti_unique_list.length > 0) {
                        var insti;
                        if (type == 1) {
                            insti = insti_unique_list.filter(tt => tt.institute_id == 1);
                        }
                        else if (type == 2) {
                            insti = insti_unique_list.filter(tt => tt.institute_id == 2);
                        }
                        else {
                            insti = insti_unique_list.filter(tt => tt.institute_id == 2);
                        }
                        this.ooscInstiList = insti.map(l => { return { label: l.institute_name_address, value: l.insti_id }; });
                        this.ooscInstiList.sort((a, b) => {
                            if (a.label < b.label)
                                return -1;
                            if (a.label > b.label)
                                return 1;
                ...
                if (fun == 'change') {
                    ...
                    if (this.studentData.MigratInsti != '' && this.studentData.MigratInsti != null && this.studentData.MigratInsti != 0) {
                        this.form.controls['MigratInsti'].setValue({ value: this.studentData.MigratInsti, label: this.studentData.InstituteName });
                    }
                    else {
                        this.form.controls['MigratInsti'].setValue('');
                    }
                ...
                this.getInstitute(type, fun);
            }
        });
    }
};
OoscquestionsPage.ctorParameters = () => [
...
OoscquestionsPage.propDecorators = {
...
OoscquestionsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_17__.__decorate)([
...
//# sourceMappingURL=src_app_pages_oosc_ooscquestions_ooscquestions_module_ts-es2015.js.map