  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_pmoa_pmoa_section-list_section-list_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _SectionListPage = /*#__PURE__*/function () {
        function SectionListPage(router, healthServices, route, sqliteDB, usersessionService) {
        ...
        return _createClass(SectionListPage, [{
          ...
          value: function ionViewDidEnter() {
            ...
            this.checkLocalExistSecList(); // this.getClassSecData();
          ...
          value: function checkLocalExistSecList() {
            ...
            this.sqliteDB.checkDataExistsWithConditions('ClassSec', "SchlId", this.SchoolId).then(function (res) {
              if (res == true) {
                _this.getSecLocalDB(); // Local Data
          ...
          value: function getSecLocalDB() {
            ...
            return this.sqliteDB.getDataLocalDB(query).then(function (data) {
              if (data.rows.length > 0) {
                ...
                console.log(_this3.filterSec);
                _this3.filterSec = _this3.filterSec.sort(function (a, b) {
      ...
      _SectionListPage = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
...
//# sourceMappingURL=src_app_pages_pmoa_pmoa_section-list_section-list_module_ts-es5.js.map