...
/* harmony import */ var _profile_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile.page */ 54413);
...
/* harmony import */ var _profile_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-routing.module */ 80407);
/* harmony import */ var _profile_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile.page */ 54413);
...
/* harmony import */ var _raw_loader_profile_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./profile.page.html */ 80386);
/* harmony import */ var _profile_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile.page.scss */ 76640);
...
let ProfilePage = class ProfilePage {
    ...
    getServerData() {
        ...
        this.userService.profileDetail().subscribe((response) => {
    ...
    onEdit() {
        ...
        let data = { "records": this.form.value };
        this.userService.editAmbastor(data).subscribe((response) => {
            this.router.navigate(['/tabs/stem-dashboard']);
        });
    }
};
...
//# sourceMappingURL=src_app_pages_stem_new_profile_profile_module_ts-es2015.js.map