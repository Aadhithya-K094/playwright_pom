(function () {
  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_leave_leavehistory_leavehistory_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _leavehistory_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./leavehistory.page */
      7863);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _leavehistory_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./leavehistory-routing.module */
      27517);
      /* harmony import */


      var _leavehistory_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./leavehistory.page */
      7863);
      ...
      _LeavehistoryPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _leavehistory_routing_module__WEBPACK_IMPORTED_MODULE_0__.LeavehistoryPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_leavehistory_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./leavehistory.page.html */
      20035);
      /* harmony import */


      var _leavehistory_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./leavehistory.page.scss */
      3807);
      /* harmony import */
      ...
      var _LeavehistoryPage = /*#__PURE__*/function () {
        function LeavehistoryPage(usersessionService, emisService, Actroute, router, fb, alertCtrl, alert) {
          var _this = this;
          ...
          this.Actroute.queryParams.subscribe(function (params) {
            _this.fromPage = params.from_page;
            _this.teacher_id = params.TchrId;

            if (_this.fromPage == 'sanction') {
              _this.teacher_id = params.TchrId;
            } else {
              _this.teacher_id = _this.usersessionService.teacher_id();
            }
          });
        }
        ...
        return _createClass(LeavehistoryPage, [{
          ...
          key: "initialiazeValidator",
          value: function initialiazeValidator() {
          ...
          key: "GetLeaveHis",
          value: function GetLeaveHis() {
            var _this2 = this;

            this.emisService.getLeaveHistory(this.teacher_id, this.Year, this.Month).subscribe(function (data) {
              _this2.LeaveList = [];
              _this2.LeaveList = data.result;

              if (data.result) {
                _this2.LeaveList.forEach(function (x) {
                  var to_date = x.LeaveToDate;
                  var today_date = _this2.todayDateFormat;
              ...
              _this2.alldata = _this2.LeaveList;

              if (_this2.LeaveList == undefined || _this2.LeaveList == null) {} else {
                _this2.LeaveList.reverse();
              }
            }, function (error) {
          ...
          value: function getFilterItems(event) {
            ...
            if (event.detail.value != '') {
              ...
              var data = this.LeaveList.filter(function (item) {
                return item.LeaveType.toLowerCase().indexOf(_this3.searchTerm.toLowerCase()) > -1;
              });
              this.LeaveList = data;
            } else {
          ...
          key: "cancelLeave",
          value: function cancelLeave(leave) {
            var _this5 = this;
            ...
            var dayFinal; //calculate leave balance
            ...
            var getBusinessDatesCount = function getBusinessDatesCount(startDate, endDate) {
              ...
              while (curDate <= +endDate) {
                ...
                var isWeekend = dayOfWeek === 7 || dayOfWeek === 0;
                count++;
            ...
            if (leave.ApprovalStatus == 4) {
              if (this.todayDateFormat > leave.LeaveFromDate) {
                var d1 = new Date(this.todayDateFormat);
              ...
              if (this.todayDateFormat > leave.LeaveFromDate) {
                var _d = new Date(leave.LeaveFromDate);

                var _d2 = new Date(this.todayDateFormat);

                dayFinal = getBusinessDatesCount(_d, _d2);
              } else {
                dayFinal = 0;
              }
            }
            ...
            this.emisService.TchrLeaveDelete(data).subscribe(function (data) {
              if (data.dataStatus) {
                _this5.GetLeaveHis();
              }
            }, function (error) {
      ...
      _LeavehistoryPage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
...
//# sourceMappingURL=src_app_pages_leave_leavehistory_leavehistory_module_ts-es5.js.map