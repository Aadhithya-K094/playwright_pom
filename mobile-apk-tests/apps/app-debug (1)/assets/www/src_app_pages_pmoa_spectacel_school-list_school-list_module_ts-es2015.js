...
/* harmony import */ var _school_list_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./school-list.page */ 96190);
...
/* harmony import */ var _school_list_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./school-list-routing.module */ 63655);
/* harmony import */ var _school_list_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./school-list.page */ 96190);
...
/* harmony import */ var _raw_loader_school_list_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./school-list.page.html */ 18404);
/* harmony import */ var _school_list_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./school-list.page.scss */ 60835);
...
let SchoolListPage = class SchoolListPage {
    constructor(router, fb, healthServices, usersessionService, alertController, modalController, sqliteDB, alertService) {
        this.router = router;
        this.fb = fb;
    ...
    onSync() {
        let query = 'DELETE FROM SchoolLists' +
    ...
    getSchoolData() {
        ...
        this.healthServices.PMOASchlListByBlkId().subscribe((response) => {
            if (response.dataStatus) {
                ...
                this.calcSchSpectacles();
                this.totalBlocklist = 0;
                this.totalBlocklist = response.result.length;
            }
            else {
    ...
    getSchoolLocalDB() {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length > 0) {
                ...
                this.totalBlocklist = 0;
                this.totalBlocklist = data.rows.length;
                // this.getSchoolCount(this.totalBlocklist)
            }
        });
    }
    // widget count
    getSchoolCount(schCount) {
        this.healthServices.getTotalCont(this.useriddata).subscribe((response) => {
            this.completedschool = response.result[0].Count;
            this.completeTeacher = schCount - this.completedschool;
        });
    }
    // searching data 
...
SchoolListPage.propDecorators = {
    selectRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ViewChild, args: ['mySelect', { static: false },] }]
};
SchoolListPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
...
//# sourceMappingURL=src_app_pages_pmoa_spectacel_school-list_school-list_module_ts-es2015.js.map