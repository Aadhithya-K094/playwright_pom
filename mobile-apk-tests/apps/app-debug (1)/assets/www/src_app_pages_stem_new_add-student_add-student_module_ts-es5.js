  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_stem_new_add-student_add-student_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddStudentPageRoutingModule": function AddStudentPageRoutingModule() {
          return (
            /* binding */
            _AddStudentPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _add_student_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./add-student.page */
      11439);
      ...
      var _AddStudentPageRoutingModule = /*#__PURE__*/_createClass(function AddStudentPageRoutingModule() {
        _classCallCheck(this, AddStudentPageRoutingModule);
      });

      _AddStudentPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddStudentPageModule": function AddStudentPageModule() {
          return (
            /* binding */
            _AddStudentPageModule
          );
        }
        /* harmony export */
      ...
      var _add_student_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./add-student-routing.module */
      95722);
      /* harmony import */


      var _add_student_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./add-student.page */
      11439);

      var _AddStudentPageModule = /*#__PURE__*/_createClass(function AddStudentPageModule() {
        _classCallCheck(this, AddStudentPageModule);
      });

      _AddStudentPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _add_student_routing_module__WEBPACK_IMPORTED_MODULE_0__.AddStudentPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddStudentPage": function AddStudentPage() {
          return (
            /* binding */
            _AddStudentPage
          );
      ...
      var _raw_loader_add_student_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./add-student.page.html */
      86151);
      /* harmony import */


      var _add_student_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _AddStudentPage = /*#__PURE__*/function () {
        function AddStudentPage(router, route, sqliteDB, alertService, userService) {
        ...
        return _createClass(AddStudentPage, [{
          key: "ngOnInit",
          ...
          value: function studentData() {
            ...
            this.userService.getExpermentData(this.schoolId, this.batch).subscribe(function (response) {
              _this.studentIndex = response.result[0].IndxId; // this.schoolExpreData = response.result.filter((rq) => rq.batch == this.batch);
            });
          }
        }, {
          key: "localStudentData",
          value: function localStudentData() {
            var _this2 = this;

            var query = 'SELECT * FROM AllStemStudentslists' + ' WHERE SchlId = "' + this.schoolId + '"';
            return this.sqliteDB.getDataLocalDB(query).then(function (data) {
              if (data.rows.length > 0) {
                ...
                _this2.studentListData = [];
                _this2.studentListData = _this2.dataList;
                console.log(_this2.dataList, "local json");
              } else {
          ...
          value: function getFilterItems(event) {
            ...
            this.searchData = this.dataList.filter(function (item) {
              return item.unique_id_no.toLowerCase().indexOf(_this3.searchTerm.toLowerCase()) > -1;
            });
          }
        }, {
          key: "onSave",
          value: function onSave() {
            ...
            if (this.searchData.length > 0) {
              ...
              var removeData = this.dataList.filter(function (item) {
                return item.unique_id_no != _this4.searchData[0].unique_id_no;
              });
              this.dataList = [];
          ...
          value: function _delete(id, event, array) {
            ...
            var removeData = this.addStudentDataList.filter(function (item) {
              return item.unique_id_no != event;
            });
            this.addStudentDataList = [];
          ...
          value: function onFinalSave() {
            ...
            this.userService.studentListData(data).subscribe(function (response) {
              _this5.router.navigate(['/tabs/school-zone']);

              _this5.alertService.success("Saved Sucessfully");
            });
          }
        }]);
      }();

      _AddStudentPage.ctorParameters = function () {
        return [{
      ...
      _AddStudentPage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
...
//# sourceMappingURL=src_app_pages_stem_new_add-student_add-student_module_ts-es5.js.map