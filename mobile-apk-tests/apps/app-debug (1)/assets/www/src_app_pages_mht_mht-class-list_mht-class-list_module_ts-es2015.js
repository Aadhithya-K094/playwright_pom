...
/* harmony export */   "MhtClassListPageRoutingModule": function() { return /* binding */ MhtClassListPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _mht_class_list_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mht-class-list.page */ 74076);
...
let MhtClassListPageRoutingModule = class MhtClassListPageRoutingModule {
};
MhtClassListPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], MhtClassListPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MhtClassListPageModule": function() { return /* binding */ MhtClassListPageModule; }
/* harmony export */ });
...
/* harmony import */ var _mht_class_list_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mht-class-list-routing.module */ 61268);
/* harmony import */ var _mht_class_list_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mht-class-list.page */ 74076);
...
let MhtClassListPageModule = class MhtClassListPageModule {
};
MhtClassListPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _mht_class_list_routing_module__WEBPACK_IMPORTED_MODULE_0__.MhtClassListPageRoutingModule
        ],
        declarations: [_mht_class_list_page__WEBPACK_IMPORTED_MODULE_1__.MhtClassListPage]
    })
], MhtClassListPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MhtClassListPage": function() { return /* binding */ MhtClassListPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_mht_class_list_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./mht-class-list.page.html */ 62998);
/* harmony import */ var _mht_class_list_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mht-class-list.page.scss */ 17526);
...
let MhtClassListPage = class MhtClassListPage {
    constructor(router, alertController, route, alertService, usersessionService, networkService, sqliteDB, userService) {
        this.router = router;
    ...
    ionViewDidEnter() {
        ...
        // this. totalStudentcheckLocalDb();
        this.totalStudentsCount();
    }
    totalStudentcheckLocalDb() {
        let query = 'SELECT * FROM mhtStudentCountDB WHERE SchlId=' + this.SchlId;
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length > 0) {
                this.StudentsCounts = [];
                for (var i = 0; i < data.rows.length; i++) {
                    this.StudentsCounts.push(data.rows.item(i));
                }
            }
            else {
                this.totalStudentsCount();
    ...
    totalStudentsCount() {
        this.StudentsCounts = [];
        this.classCountDet = [];
        this.userService.mhtStudentsCount(this.UserName, this.SchlId, this.acYear).subscribe((res) => {
            if (res.dataStatus) {
                this.StudentsCounts = res.result;
                this.classCountDet = res.result[0]['class_count'];
                // this.TotalStudinsertLocalDB(this.StudentsCounts)
            }
            this.checkLocalData();
        });
    }
    checkLocalData() {
        this.classList = [];
        this.allClassLists = [];
        this.sqliteDB.getExistData('AllClasslist', this.SchlId, 'SchlD').then((res) => {
            if (res.length > 0) {
                this.allClassLists = res;
                this.classList = Array.from(new Set(this.allClassLists.map(s => s.ClsID)))
                    .map(ClsID => {
                    var stuCount = this.classCountDet.filter(x => x.class_studying_id == ClsID);
                    return {
                        ClsID: ClsID,
                        Clsroman: this.allClassLists.find(s => s.ClsID == ClsID).Clsroman,
                        Sync: this.allClassLists.find(s => s.ClsID == ClsID).Sync,
                        SyncClass: this.allClassLists.find(s => s.ClsID == ClsID).SyncClass,
                        Synclr: '',
                        present: this.allClassLists.find(s => s.ClsID == ClsID).present,
                        absent: this.allClassLists.find(s => s.ClsID == ClsID).absent,
                        stuCount: stuCount.length > 0 ? +stuCount[0]['TotalStudents'] : 0
                    };
                });
                this.classList.forEach(a => {
                    this.classLength = this.allClassLists.filter(tt => tt.ClsID == a.ClsID);
                    this.classSync = this.allClassLists.filter(tt => tt.ClsID == a.ClsID && tt.SyncClass == 1);
                    if (this.classLength.length == this.classSync.length) {
                        a.Synclr = 1;
                    }
                    else {
                        a.Synclr = 0;
                ...
                this.alertService.error("Please Sync Student List");
            }
        });
    }
    classSelected(value) {
    ...
    goToSection(data) {
        ...
        this.sectionsList = this.allClassLists.filter(tt => tt.ClsID == this.classVal);
        const key = 'Sectn';
        this.sectionList = [...new Map(this.sectionsList.map(item => [item[key], item])).values()];
    ...
    goToStudentAttendance(section) {
        this.section = section === null || section === void 0 ? void 0 : section.Sectn;
        this.router.navigate(['/tabs/class-student-list'], { queryParams: { 'SchlId': this.SchlId, 'Latt': this.Latt, 'Longg': this.Longg, 'ClsID': this.classVal, 'Sectn': this.section, 'SchName': this.SchName, 'session': 1, 'acYear': this.acYear }, skipLocationChange: false });
    }
    moveClass() {
        this.sectionActive = false;
        this.classActive = true;
    ...
    onSync() {
        ...
        if (connectionStatus !== 1) {
            let deleteQuery = 'DELETE FROM AllClasslist WHERE SchlD = ' + this.SchlId;
    ...
    getAllClassList() {
        this.userService.getAllClassList(2, this.SchlId).subscribe((res) => {
            if (res) {
                res.map(i => i['Clsroman'] = this.class_in_roman[i['class_id']]);
                if (res.length > 0) {
                    res.forEach(element => {
                        this.saveClassLocalDB(this.SchlId, element.class_id, element.section, element.Clsroman);
                    });
                    this.getClassLocalDB();
                }
            }
        });
    }
    saveClassLocalDB(SchlD, ClsID, Sectn, Clsroman) {
        const datainsert = 'INSERT INTO AllClasslist VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
        this.sqliteDB.insert(datainsert, [null, SchlD, ClsID, Sectn, Clsroman, this.SchlId, 0, 0, 0, 0, 0, 0, this.todayDate, 0, 0]).then(insertres => {
            if (insertres) {
            }
        });
    }
    TotalStudinsertLocalDB(key) {
        key.forEach((element) => {
            const datainsert = 'INSERT INTO mhtStudentCountDB VALUES (?,?,?,?,?,?)';
            this.sqliteDB.insert(datainsert, [null, element.DocAddedStudents, element.ScreenedStudents, element.TotalStudents, element.UnScreenedStudents, this.SchlId]).then(insertres => {
    ...
    getClassLocalDB() {
        this.sqliteDB.getExistData('AllClasslist', this.SchlId, 'userName').then((res) => {
            if (res.length > 0) {
...
MhtClassListPage.ctorParameters = () => [
...
MhtClassListPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
...
//# sourceMappingURL=src_app_pages_mht_mht-class-list_mht-class-list_module_ts-es2015.js.map