(function () {
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["default-node_modules_blob-util_dist_blob-util_es_js"], {
    /***/
    1230:
    /*!*****************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */
        "blobToBinaryString": function blobToBinaryString() {
          return (
            /* binding */
            _blobToBinaryString
          );
        ...
        /* harmony export */
        "base64StringToBlob": function base64StringToBlob() {
          return (
            /* binding */
            _base64StringToBlob
          );
        ...
        /* harmony export */
        "binaryStringToBlob": function binaryStringToBlob() {
          return (
            /* binding */
            _binaryStringToBlob
          );
        ...
        /* harmony export */
        "blobToBase64String": function blobToBase64String() {
          return (
            /* binding */
            _blobToBase64String
          );
        ...
        /* harmony export */
        "dataURLToBlob": function dataURLToBlob() {
          return (
            /* binding */
            _dataURLToBlob
          );
        ...
        /* harmony export */
        "blobToDataURL": function blobToDataURL() {
          return (
            /* binding */
            _blobToDataURL
          );
        ...
        /* harmony export */
        "imgSrcToDataURL": function imgSrcToDataURL() {
          return (
            /* binding */
            _imgSrcToDataURL
          );
        ...
        /* harmony export */
        "canvasToBlob": function canvasToBlob() {
          return (
            /* binding */
            _canvasToBlob
          );
        ...
        /* harmony export */
        "imgSrcToBlob": function imgSrcToBlob() {
          return (
            /* binding */
            _imgSrcToBlob
          );
        ...
        /* harmony export */
        "arrayBufferToBlob": function arrayBufferToBlob() {
          return (
            /* binding */
            _arrayBufferToBlob
          );
        ...
        /* harmony export */
        "blobToArrayBuffer": function blobToArrayBuffer() {
          return (
            /* binding */
            _blobToArrayBuffer
          );
        ...
        /* harmony export */
        "arrayBufferToBinaryString": function arrayBufferToBinaryString() {
          return (
            /* binding */
            _arrayBufferToBinaryString
          );
        },

        /* harmony export */
        "binaryStringToArrayBuffer": function binaryStringToArrayBuffer() {
          return (
            /* binding */
            _binaryStringToArrayBuffer
          );
        }
        /* harmony export */
      ...
      function _createObjectURL(blob) {
      ...
      function _blobToBinaryString(blob) {
        return new Promise(function (resolve, reject) {
          ...
          reader.onloadend = function () {
            ...
            resolve(_arrayBufferToBinaryString(result));
          };
      ...
      function _base64StringToBlob(base64, type) {
        var parts = [_binaryStringToArrayBuffer(atob(base64))];
        return type ? _createBlob(parts, {
          type: type
        }) : _createBlob(parts);
      }
      /**
      ...
      function _binaryStringToBlob(binary, type) {
        return _base64StringToBlob(btoa(binary), type);
      }
      /**
       * Convert a `Blob` to a binary string.
       *
      ...
      function _blobToBase64String(blob) {
        return _blobToBinaryString(blob).then(btoa);
      }
      /**
      ...
      function _dataURLToBlob(dataURL) {
        ...
        var buff = _binaryStringToArrayBuffer(atob(base64));

        return _createBlob([buff], {
          type: type
        });
      }
      /**
      ...
      function _blobToDataURL(blob) {
        return _blobToBase64String(blob).then(function (base64String) {
      ...
      function _imgSrcToDataURL(src, type, crossOrigin, quality) {
        type = type || 'image/png';
      ...
      function _canvasToBlob(canvas, type, quality) {
        ...
        return Promise.resolve(_dataURLToBlob(canvas.toDataURL(type, quality)));
      }
      /**
      ...
      function _imgSrcToBlob(src, type, crossOrigin, quality) {
        type = type || 'image/png';
        return loadImage(src, crossOrigin).then(imgToCanvas).then(function (canvas) {
          return _canvasToBlob(canvas, type, quality);
        });
      }
      /**
      ...
      function _arrayBufferToBlob(buffer, type) {
        return _createBlob([buffer], type);
      }
      /**
...
//# sourceMappingURL=default-node_modules_blob-util_dist_blob-util_es_js-es5.js.map