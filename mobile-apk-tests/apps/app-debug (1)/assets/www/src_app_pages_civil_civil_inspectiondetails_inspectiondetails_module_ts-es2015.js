...
/* harmony export */   "InspectiondetailsPageRoutingModule": function() { return /* binding */ InspectiondetailsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _inspectiondetails_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inspectiondetails.page */ 73901);
...
let InspectiondetailsPageRoutingModule = class InspectiondetailsPageRoutingModule {
};
InspectiondetailsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "InspectiondetailsPageModule": function() { return /* binding */ InspectiondetailsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _inspectiondetails_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inspectiondetails-routing.module */ 13389);
/* harmony import */ var _inspectiondetails_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./inspectiondetails.page */ 73901);
...
let InspectiondetailsPageModule = class InspectiondetailsPageModule {
};
InspectiondetailsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            ...
            _inspectiondetails_routing_module__WEBPACK_IMPORTED_MODULE_0__.InspectiondetailsPageRoutingModule
        ],
        declarations: [_inspectiondetails_page__WEBPACK_IMPORTED_MODULE_1__.InspectiondetailsPage]
    })
], InspectiondetailsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "InspectiondetailsPage": function() { return /* binding */ InspectiondetailsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_inspectiondetails_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./inspectiondetails.page.html */ 17739);
/* harmony import */ var _inspectiondetails_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./inspectiondetails.page.scss */ 89160);
...
/* harmony import */ var src_app_services_emis_aws_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/emis/aws.service */ 56263);
...
let InspectiondetailsPage = class InspectiondetailsPage {
    constructor(router, fb, uploadService, geolocation, alertService, userService, awsService, route) {
        this.router = router;
        this.fb = fb;
    ...
    getdDropdownList() {
        this.construct_stage = [
            { value: '1', label: "Marking" },
            { value: '2', label: "Earth Work" },
            { value: '3', label: "Foundation Concrete" },
            { value: '4', label: "Grade beam / Plinth Beam" },
            { value: '5', label: "Basement" },
            { value: '6', label: "Lintel level" },
            { value: '7', label: "Roof level" },
            { value: '8', label: "Roof Centering" },
            { value: '9', label: "Roof concrete laid" },
            { value: '10', label: "Plastering" },
            { value: '11', label: "Flooring" },
            { value: '12', label: "Weathering course" },
            { value: '13', label: "Finishing level" },
            { value: '14', label: "Completed" },
            { value: '15', label: "Stages" },
            { value: '16', label: "Tender stage" },
            { value: '17', label: "Tender under scrutiny" },
            { value: '18', label: "Estimate stage" },
            { value: '19', label: "Site not handed over to PWD" },
            { value: '20', label: "Site handed over but work not started" }
        ];
        this.status = [
            { value: '1', label: "Completed" },
            { value: '2', label: "In Progress" },
            { value: '3', label: "Not yet constructed" }
        ];
        this.quality = [
        ...
        this.fund = [
            { value: '1', label: "Fund released" },
            { value: '2', label: "Not yet released" }
        ];
    }
    getSurveyQuestions() {
        this.awsService.getSurveyQuestions(this.surveyId).subscribe(res => {
            if (res) {
                //debugger
                this.data = res.filter(val => val.QuestTyp != '6');
                this.photoData = res.filter(val => val.QuestTyp == '6');
                this.onSurveyList(this.data);
            }
        });
    }
    onSurveyList(item) {
        this.username = window.localStorage.getItem('username');
        const control = this.form.controls['survey_details'];
        ...
        if (item.length > 0) {
            for (let i = 0; i < item.length; i++) {
                ...
                if (this.queslist.value[i]['SrvyID'] == 5001 && this.queslist.value[i]['RespInt'] == 1) {
                    this.form.controls['survey_details']['controls'][i].controls['value'].setValue('Yes');
                }
                else {
                    this.form.controls['survey_details']['controls'][i].controls['value'].setValue('No');
                }
                if (this.queslist.value[i]['QuestTyp'] == 5) {
                    this.form.controls['survey_details']['controls'][i].controls['RespInt'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required);
                }
                else {
                    this.form.controls['survey_details']['controls'][i].controls['RespInt'].setValidators(null);
                }
                this.form.controls['survey_details']['controls'][i].controls['RespInt'].updateValueAndValidity();
                if (this.queslist.value[i]['Quest'] == 'Remarks' || this.queslist.value[i]['QuestTyp'] == 4) {
    ...
    goToSurveyList() {
        this.router.navigate(['tabs/civilbuildinglist'], { queryParams: { 'Id': this.Id }, skipLocationChange: false });
    }
    goToHome() {
        this.router.navigate(['tabs/home']);
    }
    onConstructionChange(e, i) {
        if (e.detail.value == 2) {
    ...
    onFinalSave() {
        ...
        const surveyList = this.form.value.survey_details;
        this.formData = surveyList.forEach(a => {
            if (a.QuestTyp == "6" && a.RespChar == null) {
                a.RespChar = this.kayvalue;
            }
            if (a.QuestTyp == "4") {
                a.RespChar = this.pipe.transform(a.RespChar, 'yyyy-MM-dd');
            }
        });
        var resdata = {
        ...
        if (this.form.valid) {
            if (this.form.value.Pht1 || this.form.value.Pht2 || this.form.value.Pht3) {
                this.userService.saveCivilSurvey(resdata).subscribe(res => {
                    if (res.dataStatus) {
                ...
                fileReader.onload = (event) => {
                    ...
                    this.uploadService.getSignedUrl(bucketName, ext, filename, expiry).subscribe((result) => {
                        if (result) {
                            ...
                            let file = files[0];
                            this.uploadService.uploadFile(result.url, file).subscribe((res) => {
                                this.form.controls.Pht2.setValue(result.key);
                                //  this.kayvalue.push(this.form.value.Pht2);
                                this.getUploadedFiles2(result.key);
                            });
                            this.alertService.success('File Uploaded Successfully');
                        }
                        else {
    ...
    getUploadedFiles2(filename) {
        var bucketName = "renewalapplicationemis";
        var filename = filename;
        let expiry = 1800;
        this.uploadService.getUploadedFiles(bucketName, filename, expiry).subscribe((result) => {
            if (result) {
                this.image2 = result.url;
            }
            else {
                this.alertService.error('Error in Uploading File please try again');
            }
                ...
                fileReader.onload = (event) => {
                    ...
                    this.uploadService.getSignedUrl(bucketName, ext, filename, expiry).subscribe((result) => {
                        if (result) {
                            ...
                            let file = files[0];
                            this.uploadService.uploadFile(result.url, file).subscribe((res) => {
                                this.form.controls.Pht3.setValue(result.key);
                                // this.kayvalue.push(this.form.value.Pht3);
                                this.getUploadedFiles3(result.key);
                            });
                            this.alertService.success('File Uploaded Successfully');
                        }
                        else {
    ...
    getUploadedFiles3(filename) {
        var bucketName = "renewalapplicationemis";
        var filename = filename;
        let expiry = 1800;
        this.uploadService.getUploadedFiles(bucketName, filename, expiry).subscribe((result) => {
            if (result) {
                this.image3 = result.url;
            }
            else {
                this.alertService.error('Error in Uploading File please try again');
            }
...
InspectiondetailsPage.ctorParameters = () => [
...
InspectiondetailsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
...
//# sourceMappingURL=src_app_pages_civil_civil_inspectiondetails_inspectiondetails_module_ts-es2015.js.map