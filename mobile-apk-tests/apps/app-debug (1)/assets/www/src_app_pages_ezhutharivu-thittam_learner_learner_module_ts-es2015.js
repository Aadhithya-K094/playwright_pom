...
/* harmony export */   "LearnerPageRoutingModule": function() { return /* binding */ LearnerPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _learner_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./learner.page */ 65585);
...
let LearnerPageRoutingModule = class LearnerPageRoutingModule {
};
LearnerPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], LearnerPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LearnerPageModule": function() { return /* binding */ LearnerPageModule; }
/* harmony export */ });
...
/* harmony import */ var _learner_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./learner-routing.module */ 40095);
/* harmony import */ var _learner_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./learner.page */ 65585);
...
let LearnerPageModule = class LearnerPageModule {
};
LearnerPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            ...
            _learner_routing_module__WEBPACK_IMPORTED_MODULE_0__.LearnerPageRoutingModule
        ],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LearnerPage": function() { return /* binding */ LearnerPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_learner_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./learner.page.html */ 59890);
/* harmony import */ var _learner_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./learner.page.scss */ 27297);
...
// import { SharedService } from 'src/app/services/emis/shared.service';



let LearnerPage = class LearnerPage {
    constructor(activeRoute, router, fb, sharedService, http, emisService, alertService, ionicstorage, usersessionService) {
        ...
        let menuData = this.activeRoute.snapshot.queryParams.menudata;
        let schoolData = this.activeRoute.snapshot.queryParams.schooldata;
    ...
    ngOnInit() {
        ...
        // (this.menuData.id == 1 || this.menuData.id == 2) ? this.dropdownList() : this.savedList();
    ...
    dropdownList() {
        ...
        this.Occupation = [
            ...
            { value: "2", label: "NREGA" },
            { value: "3", label: "Self Help Group" },
            { value: "4", label: "Daily wages" },
            { value: "5", label: "Factory" },
            { value: "6", label: "Mills" },
            { value: "7", label: "House wife" },
        ...
        this.SocialCategory = [
            ...
            { value: "3", label: "BC" },
            { value: "4", label: "MBC" },
            { value: "5", label: "MINORITIES" },
            { value: "6", label: "OTHERS" }
        ];
        this.WhetherLearner = [
            { value: "1", label: "Never Enrolled" },
            { value: "2", label: "Dropout" }
        ];
        ...
        this.ionicstorage.getData('district').then((data) => {
            if (data) {
                let allDistBlockList = data.result;
                this.districtList = [];
                this.districtList = this.sharedService.unique(allDistBlockList, ['district_id']);
                this.districtList.sort(this.sharedService.compareValues('district_name', 'asc'));
            }
        });
        // this.http.get<any>('https://d1wpyxz35bzzz4.cloudfront.net/statewise.json').subscribe((data) => {
        //   let stateList = data.state;
        this.ionicstorage.getData('state').then((data) => {
            if (data) {
                let stateList = data.result;
                this.stateList = [];
                this.stateList = this.sharedService.unique(stateList, ['state_code']);
                this.stateList.sort(this.sharedService.compareValues('state_name', 'asc'));
            }
        });
        // this.http.get<any>('https://d1wpyxz35bzzz4.cloudfront.net/cognates_language_wise.json').subscribe((data) => {
        this.ionicstorage.getData('language').then((data) => {
            if (data) {
                let removeLng = ["English", "Undefined"];
                debugger;
                let languageList = data.result.filter(obj => { return obj.language_name && !removeLng.includes(obj.language_name); });
                // let languageList = data.language;
                this.languageList = [];
                this.languageList = this.sharedService.unique(languageList, ['id']);
                this.languageList.sort(this.sharedService.compareValues('language_name', 'asc'));
            }
        });
        // } else {
        this.MotherTongue = [
            ...
            { value: "3", label: "Telegu" },
            { value: "4", label: "Hindi" },
            { value: "5", label: "Urdu" },
            { value: "6", label: "Malayam" }
        ];
        this.VlntrType = [
            { value: "1", label: "Teachers" },
            { value: "2", label: "ITK" },
            { value: "3", label: "School Students" },
            { value: "4", label: "College Students" },
    ...
    onSave(id) {
        debugger;
        if (id == 1) {
            let dob = this.pipe.transform(this.learnerForm.value.Dob, 'yyyy-MM-dd');
            let enrollmentDate = this.pipe.transform(this.learnerForm.value.EnrollmentDate, 'yyyy-MM-dd');
            this.learnerForm.controls['Dob'].setValue(dob);
            this.learnerForm.controls['EnrollmentDate'].setValue(enrollmentDate);
            let GuardianNameTamil = (this.learnerForm.value.GuardianNameTamil).trim();
            ...
            let LearnerNameTamil = (this.learnerForm.value.LearnerNameTamil).trim();
            ...
            let LearnerAddress = (this.learnerForm.value.LearnerAddress).trim();
            ...
            let SpecialStudied = (this.learnerForm.value.SpecialStudied).trim();
            ...
            if (!this.learnerPincode && !this.learnerContact) {
                ...
                let msg = (this.learnerPincode && this.learnerContact) ? 'Please Fill Valid Pincode and Contact Number' :
                    this.learnerPincode ? 'Please Fill Valid Pincode' : 'Please Fill Valid Contact Number';
                this.alertService.error(msg);
            }
        }
        else {
            let dob = this.pipe.transform(this.volunteerForm.value.Dob, 'yyyy-MM-dd');
            let Doj = this.pipe.transform(this.volunteerForm.value.Doj, 'yyyy-MM-dd');
            this.volunteerForm.controls['Dob'].setValue(dob);
            this.volunteerForm.controls['Doj'].setValue(Doj);
            let VlntrNameTamil = (this.volunteerForm.value.VlntrNameTamil).trim();
            ...
            if (!this.volContact) {
                ...
                let msg = 'Please Fill Valid Mobile Number';
                this.alertService.error(msg);
            }
        }
    }
    onFormSubmit(id) {
        ...
        if (id == 1 ? this.learnerForm.valid : this.volunteerForm.valid) {
            this.emisService.learnersSave(id, { "records": id == 1 ? this.learnerForm.value : this.volunteerForm.value }).subscribe(res => {
                if (res.dataStatus) {
    ...
    learnersDetails() {
        this.learnersList = [];
        this.emisService.learnerGet(this.SchoolId).subscribe((res) => {
            if (res.dataStatus) {
                if (res.result.length > 0) {
                    this.learnersList = res.result;
                    this.noData = false;
                }
                else {
                    this.noData = true;
    ...
    volunteersDetails() {
        this.volunteersList = [];
        this.emisService.volunteersGet(this.SchoolId).subscribe((res) => {
            if (res.dataStatus) {
                if (res.result.length > 0) {
                    this.volunteersList = res.result;
                    this.noData = false;
                }
                else {
                    this.noData = true;
    ...
    patchForm(id, data) {
        debugger;
        let MotherTongue = this.languageList.filter(obj => { return obj.id == data.MotherTongue; });
        let OtherState = this.stateList.filter(obj => { return obj.state_code == data.OtherState; });
        if (id == 1) {
            this.viewLearner = true;
            this.viewVolunteer = false;
    ...
    tamilPatchVal(event, form, field) {
        debugger;
    ...
    onKeydown(id, key, value, len) {
        debugger;
        if (value.length < len) {
            let concatValue = key + value;
            let splitValue = concatValue.split('');
            if (concatValue.length == len) {
                const allEqual = arr => arr.every(val => val === arr[0]);
                let result = allEqual(splitValue);
                if (result) {
...
LearnerPage = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
...
//# sourceMappingURL=src_app_pages_ezhutharivu-thittam_learner_learner_module_ts-es2015.js.map