  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_tnvn_assessment_omr-random-student_omr-random-student_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "OmrRandomStudentComponent": function OmrRandomStudentComponent() {
          return (
            /* binding */
            _OmrRandomStudentComponent
          );
        }
        /* harmony export */
      ...
      var _raw_loader_omr_random_student_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./omr-random-student.html */
      71243);
      /* harmony import */


      var _omr_random_student_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./omr-random-student.component.scss */
      58267);
      /* harmony import */
      ...
      var _OmrRandomStudentComponent = /*#__PURE__*/function () {
        function OmrRandomStudentComponent(modalController, _storage, _apiService, userSessionService, _router, loading, ionicStore, _alertService, _translate) {
          _classCallCheck(this, OmrRandomStudentComponent);
        ...
        return _createClass(OmrRandomStudentComponent, [{
          key: "ngOnInit",
                  ...
                  case 1:
                    this.ionicStore.getStoreData().then(function (response) {
                      return (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__awaiter)(_this, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee() {
                        ...
                        var _a, notebookquestions, i, studentList, idx, colorCodes, apiData;
                        ...
                        return _regenerator().w(function (_context) {
                          while (1) switch (_context.n) {
                            case 0:
                              ...
                              if (this.languageType == 'en') {
                                notebookquestions = this.masterApiResponse.methodology_questions_lang.filter(function (data) {
                                  return data.lang == _this2.languageType && Number(data.sec_id) == 7;
                                });
                              ...
                              this.notebookQuestionList = this.notebookQuestionList.filter(function (data) {
                                return JSON.parse(data["class"].includes(_this2.storeDetail.pages.pageData[5].correctedDetails.class_id));
                              });
                              studentList = []; // if(this.storeDetail.pages.pageData[18]?.omrData.length>0){
                            ...
                            case 2:
                              this.loading.dismiss(); // if(this.storeDetail.pages.pageData[18]?.omrData.length>0){          
          ...
          value: function moveBack() {
            if (this.isQuestionsDisplayed) {
              ...
              this._router.navigate(["/tnvntabs/page-route/assessment"]); // if(this.storeDetail.pages.pageData[5].correctedDetails.class_id){
          ...
          value: function getRandomQuestions() {
            ...
            var _loop = function _loop() {
              var idx;
              idx = _this5.getRandomInt(0, _this5.questionList.length);

              var found = _this5.randomQuestionList.some(function (el) {
                return el == _this5.questionList[idx];
              });

              if (!found) {
                _this5.randomQuestionList.push(_this5.questionList[idx]);
              } else {
                idx = _this5.getRandomInt(0, _this5.questionList.length);
      ...
      _OmrRandomStudentComponent.ctorParameters = function () {
        return [{
      ...
      _OmrRandomStudentComponent = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_13__.Component)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "OmrRandomStudentModule": function OmrRandomStudentModule() {
          return (
            /* binding */
            _OmrRandomStudentModule
          );
        }
        /* harmony export */
      ...
      var _omr_random_student_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./omr-random-student.component */
      46931);
      /* harmony import */
      ...
      var _OmrRandomStudentModule = /*#__PURE__*/_createClass(function OmrRandomStudentModule() {
        _classCallCheck(this, OmrRandomStudentModule);
      });

      _OmrRandomStudentModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
...
//# sourceMappingURL=src_app_pages_tnvn_assessment_omr-random-student_omr-random-student_module_ts-es5.js.map