...
/* harmony import */ var _class_list_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./class-list.page */ 92134);
...
/* harmony import */ var _class_list_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./class-list-routing.module */ 34884);
/* harmony import */ var _class_list_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./class-list.page */ 92134);
...
/* harmony import */ var _raw_loader_class_list_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./class-list.page.html */ 51995);
/* harmony import */ var _class_list_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./class-list.page.scss */ 91019);
...
let ClassListPage = class ClassListPage {
    constructor(router, healthServices, route, sqliteDB, alertService, usersessionService) {
        this.router = router;
    ...
    nextPage(classId, SchoolId) {
        this.router.navigate(['/tabs/section-list'], {
            queryParams: { classId, SchoolId }
        });
    }
    getTotalClassData() {
        this.healthServices.getTotalSchoolCont(this.schoolId).subscribe((response) => {
            this.totalSchool = response.result.TotStuCount[0].Count;
            this.totalScnTech = response.result.TotStuScrndCount[0].Count;
            this.totalrefPmoa = response.result.TotStuRefrdPmoa[0].Count;
            this.totalscnPmoa = response.result.TotStuScrndByPmoa[0].Count;
        });
    }
    getClassSecData() {
        this.healthServices.getTotalClassData(this.schoolId).subscribe((response) => {
            ...
            if (response.dataStatus) {
                ...
                this.classSecListData = response.result;
                this.classSecListData = [...new Map(response.result.map(item => [JSON.stringify(item.class_studying_id), item.class_studying_id])).values()];
...
ClassListPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
//# sourceMappingURL=src_app_pages_pmoa_pmoa_class-list_class-list_module_ts-es2015.js.map