  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_sids_primary-school_primary-building_primary-room-questions_primary-room-questi-eef77c"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimaryRoomQuestionsPageRoutingModule": function PrimaryRoomQuestionsPageRoutingModule() {
          return (
            /* binding */
            _PrimaryRoomQuestionsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _primary_room_questions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./primary-room-questions.page */
      80641);
      ...
      var _PrimaryRoomQuestionsPageRoutingModule = /*#__PURE__*/_createClass(function PrimaryRoomQuestionsPageRoutingModule() {
        _classCallCheck(this, PrimaryRoomQuestionsPageRoutingModule);
      });

      _PrimaryRoomQuestionsPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimaryRoomQuestionsPageModule": function PrimaryRoomQuestionsPageModule() {
          return (
            /* binding */
            _PrimaryRoomQuestionsPageModule
          );
        }
        /* harmony export */
      ...
      var _primary_room_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./primary-room-questions-routing.module */
      41421);
      /* harmony import */


      var _primary_room_questions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./primary-room-questions.page */
      80641);

      var _PrimaryRoomQuestionsPageModule = /*#__PURE__*/_createClass(function PrimaryRoomQuestionsPageModule() {
        _classCallCheck(this, PrimaryRoomQuestionsPageModule);
      });

      _PrimaryRoomQuestionsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _primary_room_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__.PrimaryRoomQuestionsPageRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimaryRoomQuestionsPage": function PrimaryRoomQuestionsPage() {
          return (
            /* binding */
            _PrimaryRoomQuestionsPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_primary_room_questions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./primary-room-questions.page.html */
      2531);
      /* harmony import */


      var _primary_room_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./primary-room-questions.page.scss */
      81660);
      /* harmony import */
      ...
      var blob_util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! blob-util */
      1230);
      /* harmony import */
      ...
      var _PrimaryRoomQuestionsPage = /*#__PURE__*/function () {
        function PrimaryRoomQuestionsPage(formBuilder, route, router, el, sqliteDB, toastController, alertService, utilityService, androidPermissions, file, camera, geolocation) {
          _classCallCheck(this, PrimaryRoomQuestionsPage);
        ...
        return _createClass(PrimaryRoomQuestionsPage, [{
          key: "ngOnInit",
          ...
          value: function onSelectedRoom() {
            ...
            if (+this.RoomUse == 7) {
              ...
              this.form.controls['KitchenCleanYn'].setValue(false); // this.form.controls['KitchenWtrSrc'].setValidators(Validators.required);
            } else {
              this.form.controls['KitchenLPGConYn'].setValue(false);
              this.form.controls['KitchenWtrSrc'].setValue('');
              this.form.controls['KitchenWtrSupply'].setValue(false);
            ...
            if (+this.RoomUse == 10) {
              ...
              this.form.controls['ToiletWasteDis'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required); // this.form.controls['Iwccubicles'].setValidators(Validators.required);
              ...
              if (this.form.value.ToiletType == 1 || this.form.value.ToiletType == 2 || this.form.value.ToiletType == 3 || this.form.value.ToiletType == 7 || this.form.value.ToiletType == 8 || this.form.value.ToiletType == 9) {
          ...
          value: function onSave() {
            ...
            if (this.RoomUse != '' && this.RoomName != '' && this.form.valid) {
              ...
              this.status = 2;
              var query = 'DELETE FROM newPrimaryRoomscommons' + ' WHERE SchlId = "' + this.schoolId + '"' + ' And BldgId = "' + this.buildingId + '"' + ' And FloorId = "' + this.floorId + '"' + ' And RoomId = "' + this.roomid + '"' + ' And VistId = "' + this.vistId + '"';
              return this.sqliteDB.getDataLocalDB(query).then(function (data) {
                if (data.rows.length == 0) {
                  var insertRows = [];
                  insertRows.push(["INSERT INTO newPrimaryRoomscommons VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [null, _this.form.value.IndxId, _this.form.value.ToiletIndxId, _this.schoolId, _this.vistId, _this.form.value.BldgIdxId, _this.buildingId, _this.form.value.FloorIdxId, _this.floorId, _this.roomid, _this.RoomUse, _this.RoomName, _this.form.value.RoomCondition, _this.form.value.RepairType, _this.form.value.MajorRepair, _this.form.value.MinorRepair, _this.form.value.AreaPlastering, _this.form.value.AreaExtWw, _this.form.value.AreaIntWw, _this.form.value.AreaReplastering, _this.form.value.AreaReflooring, _this.form.value.AreaPatchwork, _this.form.value.DoorReplace, _this.form.value.WindowReplace, _this.form.value.DoorRepair, _this.form.value.WindowRepair, _this.form.value.DoorRepaint, _this.form.value.WindowRepaint, _this.form.value.LatrinReplace, _this.form.value.UrinalReplace, _this.form.value.PipeNeed, _this.form.value.DrainageNeed, _this.form.value.RoomLength, _this.form.value.RoomBreadth, _this.form.value.RoomHeight, _this.form.value.FloorType, _this.form.value.BenchFunc, _this.form.value.DeskFunc, _this.form.value.TubelightFunc, _this.form.value.FansFunc, _this.form.value.Cupboard, _this.form.value.RoomCeilingYn, _this.form.value.RoomCeilingPhoto, _this.form.value.RoomCeilingPhotoName, _this.form.value.RoomCeilingLatitude, _this.form.value.RoomCeilingLongitude, _this.form.value.TeacherTableYn, _this.form.value.TelevisionYn, _this.form.value.TelevisionFuncYn, _this.form.value.SmartboardPrjtYn, _this.form.value.SmartboardPrjtFuncYn, _this.form.value.ClassRoomProjYn, _this.form.value.ClassRoomProjFuncYn, _this.form.value.LabType, _this.form.value.LabComputerYn, _this.form.value.LabComputerFunc, _this.form.value.LabComputerRepair, _this.form.value.LabWatersupplyYn, _this.form.value.LabDrainage, _this.form.value.LabPhotoOne, _this.form.value.LabPhotoOneName, _this.form.value.LabLatitude, _this.form.value.LabLongitude, _this.form.value.LibraryBooks, _this.form.value.HmRoomTblYn, _this.form.value.StaffrmUsedBy, _this.form.value.KitchenWtrSrc, _this.form.value.KitchenLPGConYn, _this.form.value.KitchenWtrSupply, _this.form.value.KitchenStorageYn, _this.form.value.KitchenCleanYn, _this.form.value.DiningFunctionalYn, _this.form.value.DiningSeatingCapacity, _this.form.value.DiningSeatingWtrSupply, _this.form.value.NoonmealStorageClean, _this.form.value.StoreRoomPurpose, _this.form.value.StrroomStorageClean, _this.form.value.ReasonEmpty, _this.form.value.ToiletType, _this.form.value.ToiletWaterCon, _this.form.value.ToiletWasteDis, _this.form.value.IwcToilet, _this.form.value.Iwccubicles, _this.form.value.IwccubiclesFunc, _this.form.value.EwcToilet, _this.form.value.Ewccubicles, _this.form.value.Ewccubiclesfunc, _this.form.value.UrinalToilet, _this.form.value.Urinals, _this.form.value.Urinalsfunc, _this.form.value.ToiletTapsFunc, _this.form.value.ToiletNeedTabs, _this.form.value.ToiletBucket, _this.form.value.Toiletmugs, _this.form.value.SizeSuitable, _this.form.value.Roof, _this.form.value.SanitWasteDisp, _this.form.value.HwFacility, _this.form.value.AuditoriumYn, _this.form.value.AuditoriumStageYn, _this.form.value.AuditoriumStageReqt, _this.form.value.AuditoriumStageArea, _this.form.value.AuditoriumStageHeight, _this.form.value.AuditoriumStageAreaLevel, _this.form.value.AuditoriumLights, _this.form.value.AuditoriumFans, _this.form.value.AuditoriumPrjtYn, _this.form.value.AuditoriumPrjtFunc, _this.form.value.SmartRoomFacilityYn, _this.form.value.SmartRoomDeviceFunYn, _this.form.value.SmartRoomComputersYn, _this.form.value.SmartRoomFunComp, _this.form.value.SmartRoomFunCompRepair, _this.form.value.SmartRoomPhotoOne, _this.form.value.SmartRoomPhotoOneName, _this.form.value.SmartRoomLatitude, _this.form.value.SmartRoomLongitude]]);
                  ...
                  _this.sqliteDB.bulkInsert(insertRows).then(function (result) {
                    ...
                    var updateQuery = 'UPDATE sidsPrimaryRoomSaves SET Status = 2 , RoomName="' + _this.RoomName + '"' + ' WHERE SclId = "' + _this.schoolId + '"' + ' And BuildIndx = "' + id + '"' + ' And FloorIndx = "' + floor + '"' + ' And RoomId = "' + _this.roomid + '"';
                    var flooor = 'UPDATE sidsPrimaryFloorSaveDatas SET RoomCondition = 1 WHERE SclId = "' + _this.schoolId + '"' + ' And BuildIndx = "' + id + '"' + ' And FloorId = "' + _this.floorId + '"';
          ...
          value: function checkLocalDb() {
            ...
            debugger;
            var query = 'SELECT * FROM newPrimaryRoomscommons' + ' WHERE SchlId = "' + this.schoolId + '"' + ' And BldgId = "' + this.buildingId + '"' + ' And FloorId = "' + this.floorId + '"' + ' And RoomId = "' + this.roomid + '"' + ' And VistId = "' + this.vistId + '"';
            return this.sqliteDB.getDataLocalDB(query).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                setTimeout(function () {
                  _this3.form.patchValue({
                    "IndxId": _this3.dataList[0].IndxId,
                    "ToiletIndxId": _this3.dataList[0].ToiletIndxId,
                    "SchlId": _this3.schoolId,
                    "VistId": _this3.vistId,
                    "BldgIdxId": _this3.dataList[0].BldgIdxId,
                    "BldgId": _this3.buildingId,
                    "FloorIdxId": _this3.dataList[0].FloorIdxId,
                    ...
                    "RoomHeight": _this3.dataList[0].RoomHeight,
                    ...
                    "BenchFunc": _this3.dataList[0].BenchFunc,
                    "DeskFunc": _this3.dataList[0].DeskFunc,
                    "TubelightFunc": _this3.dataList[0].TubelightFunc,
                    "FansFunc": _this3.dataList[0].FansFunc,
                    "Cupboard": _this3.dataList[0].Cupboard,
                    "RoomCeilingYn": _this3.dataList[0].RoomCeilingYn,
                    "RoomCeilingPhoto": _this3.dataList[0].RoomCeilingPhoto,
                    "RoomCeilingPhotoName": _this3.dataList[0].RoomCeilingPhotoName,
                    "RoomCeilingLatitude": _this3.dataList[0].RoomCeilingLatitude,
                    "RoomCeilingLongitude": _this3.dataList[0].RoomCeilingLongitude,
                    ...
                    "TelevisionYn": _this3.dataList[0].TelevisionYn == "false" ? false : _this3.dataList[0].TelevisionYn == "true" ? true : _this3.dataList[0].TelevisionYn == true ? true : false,
                    ...
                    "SmartboardPrjtYn": _this3.dataList[0].SmartboardPrjtYn == "false" ? false : _this3.dataList[0].SmartboardPrjtYn == "true" ? true : _this3.dataList[0].SmartboardPrjtYn == true ? true : false,
                    ...
                    "ClassRoomProjFuncYn": _this3.dataList[0].ClassRoomProjFuncYn == "false" ? false : _this3.dataList[0].ClassRoomProjFuncYn == "true" ? true : _this3.dataList[0].ClassRoomProjFuncYn == true ? true : false,
                    "LabType": _this3.dataList[0].LabType,
                    "LabComputerYn": _this3.dataList[0].LabComputerYn == "false" ? false : _this3.dataList[0].LabComputerYn == "true" ? true : _this3.dataList[0].LabComputerYn == true ? true : false,
                    ...
                    "LabLongitude": _this3.dataList[0].LabLongitude,
                    ...
                    "HmRoomTblYn": _this3.dataList[0].HmRoomTblYn == "false" ? false : _this3.dataList[0].HmRoomTblYn == "true" ? true : _this3.dataList[0].HmRoomTblYn == true ? true : false,
                    ...
                    "IwcToilet": _this3.dataList[0].IwcToilet == "false" ? false : _this3.dataList[0].IwcToilet == "true" ? true : _this3.dataList[0].IwcToilet == true ? true : false,
                    "Iwccubicles": _this3.dataList[0].Iwccubicles,
                    "IwccubiclesFunc": _this3.dataList[0].IwccubiclesFunc,
                    "EwcToilet": _this3.dataList[0].EwcToilet == "false" ? false : _this3.dataList[0].EwcToilet == "true" ? true : _this3.dataList[0].EwcToilet == true ? true : false,
                    "Ewccubicles": _this3.dataList[0].Ewccubicles,
                    "Ewccubiclesfunc": _this3.dataList[0].Ewccubiclesfunc,
                    "UrinalToilet": _this3.dataList[0].UrinalToilet == "false" ? false : _this3.dataList[0].UrinalToilet == "true" ? true : _this3.dataList[0].UrinalToilet == true ? true : false,
                    ...
                    "AuditoriumStageReqt": _this3.dataList[0].AuditoriumStageReqt,
                    "AuditoriumStageArea": _this3.dataList[0].AuditoriumStageArea,
                    "AuditoriumStageHeight": _this3.dataList[0].AuditoriumStageHeight,
                    "AuditoriumStageAreaLevel": _this3.dataList[0].AuditoriumStageAreaLevel,
                    ...
                    "AuditoriumPrjtFunc": _this3.dataList[0].AuditoriumPrjtFunc == "false" ? false : _this3.dataList[0].AuditoriumPrjtFunc == "true" ? true : _this3.dataList[0].AuditoriumPrjtFunc == true ? true : false,
                    ...
                    "SmartRoomPhotoOne": _this3.dataList[0].SmartRoomPhotoOne,
                    "SmartRoomPhotoOneName": _this3.dataList[0].SmartRoomPhotoOneName,
                    "SmartRoomLatitude": _this3.dataList[0].SmartRoomLatitude,
                    "SmartRoomLongitude": _this3.dataList[0].SmartRoomLongitude
                  });
          ...
          value: function checkLocalDbBuild() {
            ...
            return this.sqliteDB.getDataLocalDB(query).then(function (data) {
              if (data.rows.length > 0) {
                ...
                console.log("Room Build Data", _this4.dataListBuild);
          ...
          key: "checkLocalDbFloor",
          value: function checkLocalDbFloor() {
            var _this5 = this;
            ...
            return this.sqliteDB.getDataLocalDB(query).then(function (data) {
              if (data.rows.length > 0) {
                _this5.dataListFloor = [];

                for (var i = 0; i < data.rows.length; i++) {
                  _this5.dataListFloor.push(data.rows.item(i));
                }

                console.log("Room Floor Data", _this5.dataListFloor);

                _this5.form.patchValue({
                  "FloorIdxId": _this5.dataListFloor[0].FloorIndx
                });
              }
            });
          }
            ...
            this.camera.getPicture(options).then(function (imageData) {
              ...
              _this6.file.readAsDataURL(imagename, filename).then(function (base64string) {
                if (base64string) {
                  ...
                  var blob = (0, blob_util__WEBPACK_IMPORTED_MODULE_5__.base64StringToBlob)(base[1], 'image/jpg');

                  if (blob.size <= 3145728) {
                    if (i == 1) {
                      _this6.form.controls['LabPhotoOne'].setValue(base64string);

                      _this6.form.controls['LabPhotoOneName'].setValue(splitedImage[0] + '.png');

                      _this6.getLatLong(1);
                    }

                    if (i == 2) {
                      _this6.form.controls['SmartRoomPhotoOne'].setValue(base64string);

                      _this6.form.controls['SmartRoomPhotoOneName'].setValue(splitedImage[0] + '.png');

                      _this6.getLatLong(2);
                    }

                    if (i == 3) {
                      _this6.form.controls['RoomCeilingPhoto'].setValue(base64string);

                      _this6.form.controls['RoomCeilingPhotoName'].setValue(splitedImage[0] + '.png');
          ...
          value: function uploadImgDelete(id) {
            ...
            setTimeout(function () {
              _this8.getLatLong(id);
            }, 1000);
          }
        }, {
          key: "getLatLong",
          value: function getLatLong(id) {
            var _this9 = this;
            ...
            this.geolocation.getCurrentPosition({
              ...
              if (id == 1) {
                _this9.form.controls['LabLatitude'].setValue(_this9.locationCordinates.latitude);

                _this9.form.controls['LabLongitude'].setValue(_this9.locationCordinates.longitude);

                _this9.form.get('LabLatitude').updateValueAndValidity();

                _this9.form.get('LabLongitude').updateValueAndValidity();
              }

              if (id == 2) {
                _this9.form.controls['SmartRoomLatitude'].setValue(_this9.locationCordinates.latitude);

                _this9.form.controls['SmartRoomLongitude'].setValue(_this9.locationCordinates.longitude);

                _this9.form.get('SmartRoomLatitude').updateValueAndValidity();

                _this9.form.get('SmartRoomLongitude').updateValueAndValidity();
              }

              if (id == 3) {
                _this9.form.controls['RoomCeilingLatitude'].setValue(_this9.locationCordinates.latitude);

                _this9.form.controls['RoomCeilingLongitude'].setValue(_this9.locationCordinates.longitude);

                _this9.form.get('RoomCeilingLatitude').updateValueAndValidity();

                _this9.form.get('RoomCeilingLongitude').updateValueAndValidity();
              }
          ...
          key: "ceilingChange",
          value: function ceilingChange(event) {
            debugger;
      ...
      _PrimaryRoomQuestionsPage.ctorParameters = function () {
        return [{
      ...
      _PrimaryRoomQuestionsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_13__.Component)({
...
//# sourceMappingURL=src_app_pages_sids_primary-school_primary-building_primary-room-questions_primary-room-questi-eef77c-es5.js.map