  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_tnvn_classroom-type_classroom-type_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ClassroomTypePageModule": function ClassroomTypePageModule() {
          return (
            /* binding */
            _ClassroomTypePageModule
          );
        }
        /* harmony export */
      ...
      var _classroom_type_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./classroom-type.page */
      90149);
      /* harmony import */
      ...
      var _ClassroomTypePageModule = /*#__PURE__*/_createClass(function ClassroomTypePageModule() {
        _classCallCheck(this, ClassroomTypePageModule);
      });

      _ClassroomTypePageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ClassroomTypePage": function ClassroomTypePage() {
          return (
            /* binding */
            _ClassroomTypePage
          );
      ...
      var _raw_loader_classroom_type_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./classroom-type.page.html */
      8989);
      /* harmony import */


      var _classroom_type_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./classroom-type.page.scss */
      19593);
      /* harmony import */
      ...
      var src_app_services_tnvn_services_file_handler_file_handler_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _ClassroomTypePage = /*#__PURE__*/function () {
        function ClassroomTypePage(fb, router, activateRoute, fileService, apiService, ionicStorage, plt, toastService) {
          var _this = this;

          _classCallCheck(this, ClassroomTypePage);
          ...
          this.activateRoute.queryParams.subscribe(function (params) {
            if (params.class_sec_info) {
              _this.param_class_sec_info = JSON.parse(params.class_sec_info);
            }

            if (params.class_data) {
              _this.param_class_data = JSON.parse(params.class_data);
            }

            if (params.teacher_info) {
              _this.param_teacher_data = JSON.parse(params.teacher_info);
            }
          });
          var class_numb;
          var sec_numb;
        ...
        return _createClass(ClassroomTypePage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.ionicStorage.getData('classroom-data').then(function (Response) {
              if (Response) {
                var cate_type = Response.classroom_data[1].cate_type.split(' ')[0];

                if (cate_type.toUpperCase() == 'PRIMARY') {
                  _this2.class_list_forClasses = _this2.class_list.slice(0, 5);
                } else {}
              }
            });
            this.ionicStorage.getData('classroom-type').then(function (Response) {
              if (Response) {
                _this2.classroomTypeForm.patchValue(Response.classroom_type);
              }
            });
            this.ionicStorage.getData('teacherlist').then(function (res) {
              if (res) {
                _this2.teacher_list = res;
              } else {}
            });
          ...
          value: function onSubmit() {
            ...
            if (this.plt.is('cordova')) {
              if (this.classroomTypeForm.invalid) {
                Object.keys(this.classroomTypeForm.controls).forEach(function (field) {
                  var control = _this3.classroomTypeForm.get(field);
            ...
            this.ionicStorage.insertData_Replace('classroom-type', {
              classroom_type: this.classroomTypeForm.value
            });
            var curr_template = this.template_list.filter(function (val) {
              return val.template_name.includes(_this3.template_class);
            });
          ...
          value: function getTemplateFromFile() {
            var _this4 = this;

            if (this.plt.is('cordova')) {
              this.template_list = [];
              this.fileService.listDirectory('templates').then(function (res) {
                var dir_list = res;
                var template_list_temp;
                dir_list.forEach(function (file_name) {
                  _this4.fileService.readFile({
                    dir: 'templates',
                    file_name: file_name.name
                  }).then(function (file) {
                    _this4.template_list.push(JSON.parse(file));
                  }, function (err) {
                    _this4.toastService.presentToast("Network Error" + err, 'error');
                  });
                });
              }, function (err) {
                _this4.toastService.presentToast("Network Error" + err, 'error');
              ...
              this.apiService.getAllTemplates().subscribe(function (res) {
                _this4.template_list = res['records'];
              });
            }
          }
        }, {
          ...
          key: "getTotalList",
          value: function getTotalList() {
            var _this5 = this;

            if (this.classroomTypeForm.value["class"] != '' && this.classroomTypeForm.value.section != '') {
              this.ionicStorage.getData('studentlist').then(function (res) {
                if (res) {
                  _this5.student_list = res;

                  var sec_upper = _this5.classroomTypeForm.value.section.toUpperCase();

                  var curr_class_info = _this5.student_list.filter(function (val) {
                    return val.class_studying_id == _this5.classroomTypeForm.value["class"] && val.class_section == sec_upper;
                  })[0];

                  if (curr_class_info != '') {
                    var tot = parseInt(curr_class_info.male) + parseInt(curr_class_info.female);

                    _this5.classroomTypeForm.controls['tot_students'].setValue({
                      value: tot,
                      disabled: true
                    });
                  }
      ...
      _ClassroomTypePage.ctorParameters = function () {
        return [{
      ...
      _ClassroomTypePage = (0, tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
...
//# sourceMappingURL=src_app_pages_tnvn_classroom-type_classroom-type_module_ts-es5.js.map