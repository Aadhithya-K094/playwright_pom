  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_inspection_writing_inspection_writing-inspection_writing-inspection_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "WritingInspectionPageRoutingModule": function WritingInspectionPageRoutingModule() {
          return (
            /* binding */
            _WritingInspectionPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _writing_inspection_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./writing-inspection.page */
      82790);
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! ./my-inspection/my-inspection.module */
        ...
        loadChildren: function loadChildren() {
          ...
          /*! ./my-inspection-dashboard/my-inspection-dashboard.module */
        ...
        loadChildren: function loadChildren() {
          ...
          /*! ./my-inspection-question/my-inspection-question.module */
      ...
      var _WritingInspectionPageRoutingModule = /*#__PURE__*/_createClass(function WritingInspectionPageRoutingModule() {
        _classCallCheck(this, WritingInspectionPageRoutingModule);
      });

      _WritingInspectionPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "WritingInspectionPageModule": function WritingInspectionPageModule() {
          return (
            /* binding */
            _WritingInspectionPageModule
          );
        }
        /* harmony export */
      ...
      var _writing_inspection_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./writing-inspection-routing.module */
      43347);
      /* harmony import */


      var _writing_inspection_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./writing-inspection.page */
      82790);

      var _WritingInspectionPageModule = /*#__PURE__*/_createClass(function WritingInspectionPageModule() {
        _classCallCheck(this, WritingInspectionPageModule);
      });

      _WritingInspectionPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _writing_inspection_routing_module__WEBPACK_IMPORTED_MODULE_0__.WritingInspectionPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "WritingInspectionPage": function WritingInspectionPage() {
          return (
            /* binding */
            _WritingInspectionPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_writing_inspection_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./writing-inspection.page.html */
      94282);
      /* harmony import */


      var _writing_inspection_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./writing-inspection.page.scss */
      49533);
      /* harmony import */
      ...
      var _WritingInspectionPage = /*#__PURE__*/function () {
        function WritingInspectionPage(fb, utilityService, router, route, userSessionService, alertService) {
          _classCallCheck(this, WritingInspectionPage);
        ...
        return _createClass(WritingInspectionPage, [{
          key: "ngOnInit",
          ...
          value: function ionViewDidEnter() {
            ...
            this.userid = this.userSessionService.emis_username(); // this.jsonData()
            // this.getDistricData()
          ...
          value: function jsonData() {
            ...
            this.jsonIfData = [];
            this.utilityService.getQuestion().subscribe(function (response) {
              _this.jsonIfData = response.result;

              _this.onFormArray(response.result);
            });
          }
        }, {
          ...
          key: "onChangeData",
          value: function onChangeData(val) {
          ...
          value: function onChangeLanguage(val) {
            if (val == 'Tamil') {
              this.tamilData = true;
            } else {
          ...
          key: "onChangeSession",
          value: function onChangeSession(val) {
          ...
          key: "onChangeRPs",
          value: function onChangeRPs(val) {
            if (val == '1') {
          ...
          key: "onChangeothers",
          value: function onChangeothers(val, i) {
            if (i == '13') {
              if (val == 'Other') {
                this.other = true;
              } else {
          ...
          key: "onFormArray",
          value: function onFormArray(questionData) {
            ...
            if (questionData.length > 0) {
              for (var _i = 0; _i < questionData.length; _i++) {
                this.queslist.push(this.fb.group({
                  IndxId: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl('', null),
                  QuestId: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(questionData[_i].IndxId, null),
                  QText: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(questionData[_i].Questions, null),
                ...
                if (questionData[_i].IndxId == 5 || questionData[_i].IndxId == 9 || questionData[_i].IndxId == 9 || questionData[_i].IndxId == 10 || questionData[_i].IndxId == 11 || questionData[_i].IndxId == 12 || questionData[_i].IndxId == 13 || questionData[_i].IndxId == 14 || questionData[_i].IndxId == 15 || questionData[_i].IndxId == 22 || questionData[_i].IndxId == 24 || questionData[_i].IndxId == 25 || questionData[_i].IndxId == 26) {
                  this.form.controls['questions']['controls'][_i].controls['QuesResp'].setValue("");

                  this.form.controls['questions']['controls'][_i].controls['QuesResp'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_6__.Validators.required);

                  this.form.controls['questions']['controls'][_i].controls['QuesResp'].updateValueAndValidity();
                }
              }
            }
          ...
          key: "onFormArrays",
          value: function onFormArrays(questionData) {
            var control = this.form.controls['questions'];
            ...
            if (questionData.length > 0) {
              for (var _i2 = 0; _i2 < questionData.length; _i2++) {
                this.queslist.push(this.fb.group({
                  IndxId: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl('', null),
                  QuestId: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(questionData[_i2].IndxId, null),
                  QText: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(questionData[_i2].Questions, null),
                  QuesResp: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl('', null),
                  UserId: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(this.userid, null)
                }));
              }
          ...
          key: "onFormArrayData",
          value: function onFormArrayData(questionData) {
            this.severData = true;
            var control = this.form.controls['questions'];
            ...
            if (questionData.length > 0) {
              for (var _i3 = 0; _i3 < questionData.length; _i3++) {
                this.queslist.push(this.fb.group({
                  IndxId: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl('', null),
                  QuestId: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(questionData[_i3].QuestId, null),
                  QText: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(questionData[_i3].ques, null),
                  QuesResp: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(questionData[_i3].QuesResp, null),
                  UserId: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(this.userid, null)
                }));
                var temp = questionData[_i3].QuesResp;

                if (questionData[_i3].QuestId == 10 || questionData[_i3].QuestId == 11 || questionData[_i3].QuestId == 13) {
                  this.sessionSever = true;
                  var data = temp.split(',');
                  console.log(data, "data");

                  this.form.controls['questions']['controls'][_i3].controls['QuesResp'].setValue(data);

                  this.form.controls['questions']['controls'][_i3].controls['QuesResp'].updateValueAndValidity();
                }

                if (questionData[_i3].QuesResp != '' && (questionData[_i3].QuestId == 6 || questionData[_i3].QuestId == 7 || questionData[_i3].QuestId == 8)) {
                  var _data = [];
                  ...
                  this.form.controls['questions']['controls'][_i3].controls['QuesResp'].setValue(_data);
          ...
          key: "getDistricData",
          value: function getDistricData() {
            var _this3 = this;

            this.utilityService.getDistrict().subscribe(function (response) {
              _this3.districData = [];
              _this3.districData = response.result.schooldist;
            });
          }
        }, {
          key: "getAnsData",
          value: function getAnsData() {
            var _this4 = this;

            this.utilityService.getTrainerData(this.teacherid, this.date, this.id, this.time).subscribe(function (response) {
              _this4.questionAnsData = [];
              _this4.questionAnsData = response.result;

              if (response.dataStatus) {
                _this4.onFormArrayData(_this4.questionAnsData);
              } else {
                _this4.jsonData();
              }
          ...
          key: "getBlockData",
          value: function getBlockData(id) {
            var _this5 = this;

            var districtId = this.districData.filter(function (item) {
              return item.district_name == id;
            });
            this.utilityService.getBlock(districtId[0].id).subscribe(function (response) {
              _this5.blockData = [];
              _this5.blockData = response.blockList;
              console.log(_this5.blockData, "list");
            });
          }
        }, {
          key: "onChangeString",
          value: function onChangeString(data, i) {
            var item = data.toString();
            this.form.controls['questions']['controls'][i].controls['QuesResp'].setValue(item); //    this.form.controls['questions']['controls'][i].controls['ques_response'].setValidators(false);

            this.form.controls['questions']['controls'][i].controls['QuesResp'].updateValueAndValidity();
          }
        }, {
          key: "onChangeDataothers",
          value: function onChangeDataothers(data, i) {
          ...
          value: function onSave() {
            ...
            if (this.form.valid) {
              ...
              for (var i = 0; i < this.form.value.questions.length; i++) {
              ...
              this.utilityService.saveEnnumEzhuthum(data).subscribe(function (res) {
                if (res.dataStatus) {
                  _this6.alertService.success('Saved');
          ...
          value: function onUniqueCode() {
            ...
            this.utilityService.getUniCodeData(this.form.value.training_id, this.todayDateFormat).subscribe(function (res) {
              if (res.dataStatus) {
                _this7.QuesActive = true;
                _this7.trainerCodeDate = res.result[0];
              } else {
                _this7.QuesActive = false;

                _this7.alertService.error('Invalid Training Unique Code');
      ...
      _WritingInspectionPage.ctorParameters = function () {
        return [{
      ...
      _WritingInspectionPage = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
...
//# sourceMappingURL=src_app_pages_inspection_writing_inspection_writing-inspection_writing-inspection_module_ts-es5.js.map