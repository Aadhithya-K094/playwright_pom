...
/* harmony export */   "PrimaryNewDashboardPageRoutingModule": function() { return /* binding */ PrimaryNewDashboardPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _primary_new_dashboard_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primary-new-dashboard.page */ 62001);
...
let PrimaryNewDashboardPageRoutingModule = class PrimaryNewDashboardPageRoutingModule {
};
PrimaryNewDashboardPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], PrimaryNewDashboardPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrimaryNewDashboardPageModule": function() { return /* binding */ PrimaryNewDashboardPageModule; }
/* harmony export */ });
...
/* harmony import */ var _primary_new_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primary-new-dashboard-routing.module */ 39136);
/* harmony import */ var _primary_new_dashboard_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./primary-new-dashboard.page */ 62001);
...
let PrimaryNewDashboardPageModule = class PrimaryNewDashboardPageModule {
};
PrimaryNewDashboardPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _primary_new_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_0__.PrimaryNewDashboardPageRoutingModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule
        ],
        declarations: [_primary_new_dashboard_page__WEBPACK_IMPORTED_MODULE_1__.PrimaryNewDashboardPage]
    })
], PrimaryNewDashboardPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrimaryNewDashboardPage": function() { return /* binding */ PrimaryNewDashboardPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_primary_new_dashboard_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./primary-new-dashboard.page.html */ 7146);
/* harmony import */ var _primary_new_dashboard_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./primary-new-dashboard.page.scss */ 61828);
...
let PrimaryNewDashboardPage = class PrimaryNewDashboardPage {
    constructor(router, ionicStorage, formBuilder, sidsService, route, networkService, utilityService, emisService, sqliteDB, alertController, toastController, alertService, userSessionService) {
        this.router = router;
    ...
    expandfloor(i, n, value, item, build, floor) {
        this.expbuild = i;
        this.expfloor = n;
        this.exproom = value;
            ...
            const alert = yield this.alertController.create({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        text: 'Delete',
                        handler: data => {
                            let buildId = parseInt(id) + 100;
                            let query1 = 'SELECT * FROM sidsPrimaryBuildingQuestion' +
                                ' WHERE SclId = "' + this.schoolId + '"' +
                                ...
                                if (data.rows.length > 0) {
                                    ...
                                    if (sidsBuild[0].BuildingIndex) {
                                        ...
                                        if (this.networkService.getCurrentNetworkStatus() == 0) {
                                            this.sidsService.StgSidsDelBuilding(dataSet).subscribe(res => {
                                                if (res.dataStatus) {
                                                    this.onDelete(id);
                                                }
                                            });
    ...
    onDelete(id) {
        ...
        let query = 'DELETE FROM sidsPrimaryBuildSavesDatas' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildingId = "' + dataId + '"' +
            ' And VistId = "' + this.vistId + '"';
        let query2 = 'DELETE FROM sidsPrimaryBuildingQuestion' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildingId = "' + dataId + '"' +
            ' And VistId = "' + this.vistId + '"';
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            ...
            const alert = yield this.alertController.create({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        text: 'Delete',
                        handler: data => {
                            let bldg_id = parseInt(id) + 100;
                            let floor_id = parseInt(floor) + 1000;
                            let query = 'SELECT * FROM sidsPrimaryFloorQuestion' +
                                ' WHERE SclId = "' + this.schoolId + '"' +
                                ' And BuildingId = "' + bldg_id + '"' +
                                ' And FloorId = "' + floor_id + '"' +
                                ' And VistId = "' + this.vistId + '"';
                            return this.sqliteDB.getDataLocalDB(query).then(data => {
                                let sidsFloor = [];
                                if (data.rows.length > 0) {
                                    ...
                                    if (sidsFloor.length > 0) {
                                        if (sidsFloor[0].FloorIndx) {
                                            ...
                                            if (this.networkService.getCurrentNetworkStatus() == 0) {
                                                this.sidsService.StgSidsDelFloor(dataSet).subscribe(res => {
                                                    if (res.dataStatus) {
                                                        this.onForceDeleteFloor(id, floor);
                                                    }
                                                });
                                            }
                                            else {
    ...
    onForceDeleteFloor(id, floor) {
        // this.isDisabled = false 
        debugger;
        let dataId = 100 + parseInt(id);
        let dataId1 = 1000 + parseInt(floor);
        console.log(this.schoolId, this.vistId, dataId);
        let query = 'DELETE FROM sidsPrimaryFloorSaveDatas' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildIndx = "' + id + '"' +
            ' And FloorId = "' + dataId1 + '"' +
            ' And VistId = "' + this.vistId + '"';
        let query2 = 'DELETE FROM sidsPrimaryFloorQuestion' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildingId = "' + dataId + '"' +
            ' And FloorId = "' + dataId1 + '"' +
            ' And VistId = "' + this.vistId + '"';
        let empty = 0;
        let query3 = 'UPDATE sidsPrimaryBuildSavesDatas SET FloorCondition = ' + empty + ' WHERE sidsPrimaryBuildSavesDatas.SclId = "' + this.schoolId + '" And sidsPrimaryBuildSavesDatas.BuildingId = "' + id + '"';
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            return this.sqliteDB.getDataLocalDB(query2).then(data => {
                if (data.rowsAffected > 0) {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        handler: data => {
                            ...
                            let dataIdF = 1000 + parseInt(floor);
                            ...
                            return this.sqliteDB.getDataLocalDB(query).then(data => {
                                ...
                                if (data.rows.length > 0) {
                                    ...
                                    if (sidsRoom[0].IndxId) {
                                        ...
                                        if (this.networkService.getCurrentNetworkStatus() == 0) {
                                            this.sidsService.StgSidsDelRoom(dataSet).subscribe(res => {
                                                if (res.dataStatus) {
                                                    this.onForceDeleteRoom(id, floor, room);
                                                }
                                            });
                                        }
                                        else {
    ...
    onForceDeleteRoom(id, floor, room) {
        // this.isDisabled = false 
        debugger;
        let dataIdB = 100 + parseInt(id);
        let dataIdF = 1000 + parseInt(id);
        let dataIdR = 10000 + parseInt(room);
        let query = 'DELETE FROM sidsPrimaryRoomSaves' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildIndx = "' + id + '"' +
            ' And FloorIndx = "' + floor + '"' +
            ' And RoomId = "' + dataIdR + '"' +
            ' And VistId = "' + this.vistId + '"';
        let query2 = 'DELETE FROM newPrimaryRoomscommons' +
            ' WHERE SchlId = "' + this.schoolId + '"' +
            ' And BldgId = "' + dataIdB + '"' +
            ' And FloorId = "' + dataIdF + '"' +
            ' And RoomId = "' + dataIdR + '"' +
    ...
    getBuildAddData(id) {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length == 0) {
                let insertRows = [];
                insertRows.push([
                    "INSERT INTO sidsPrimaryBuildSavesDatas VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)",
    ...
    addQuesnBuildingDetails(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            this.queslist.push(this.formBuilder.group({
                Id: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].Id),
                SclId: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].SclId),
                VistId: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].VistId, null),
                BuildIndx: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].BuildIndx, null),
                BuildIndex: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].BuildIndex, null),
                BuildingId: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].BuildingId, null),
                Status: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].Status, null),
                Condition: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(false, null),
                BuildName: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].BuildName, null),
                BuildCondi: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].BuildCondi, null),
                ClosingQuestions: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].ClosingQuestions, null),
                FloorCondition: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].FloorCondition, null)
            }));
    ...
    checkFloorSavedata(bulId) {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length == 0) {
                ...
                let buildId = parseInt(bulId) + 100;
    ...
    getdashboardFloorData(bulId, id, p) {
        let query = 'SELECT * FROM sidsPrimaryFloorSaveDatas' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildIndx = "' + bulId + '"' +
            ' And VistId = "' + this.vistId + '"';
        return this.sqliteDB.getDataLocalDB(query).then(floor => {
            if (floor.rows.length == 0) {
                ...
                return this.sqliteDB.getDataLocalDB(query).then(data => {
                    ...
                    if (buildSaveData.length > 0) {
                        if (+buildSaveData[0].BuildCondi == 2 || +buildSaveData[0].BuildCondi == 3) {
                            ...
                            this.getdashboardAddFloorData(bulId, id, p);
                        }
                    }
                    else {
                        this.getdashboardAddFloorData(bulId, id, p);
                ...
                let sidsPrimaryFloorSaveDatas = sidsFloor.filter(dd => +dd.Status == 1);
                    ...
                    if (sidsFloor[floorLength].FloorName == "Terrace" || +sidsFloor[floorLength].FloorCondi == 2 || +sidsFloor[floorLength].FloorCondi == 3) {
                        ...
                        return this.sqliteDB.getDataLocalDB(query).then(data => {
                            if (data.rows.length == 0) {
                                ...
                                let sidsPrimaryFloorSaveDatas = dataListFloor.filter(dd => +dd.Status == 1);
    ...
    getdashboardAddFloorData(bulId, id, p) {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            ...
            if (data.rows.length == 0) {
                ...
                let insertRows = [];
                insertRows.push([
                    "INSERT INTO sidsPrimaryFloorSaveDatas VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                    [null, id, this.schoolId, this.vistId, bulId, "", dataId, "1", "Floor Name", "", "1", "true", (_a = this.form.value.sids[p]) === null || _a === void 0 ? void 0 : _a.BuildIndex, ""]
                ]);
                this.sqliteDB.bulkInsert(insertRows).then((result) => {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length == 0) {
                ...
                if (this.expFloorId && this.expIdBuild && !this.deleteRoom) { // Abdullah 
                    this.expandfloor(this.expIdBuild, this.expFloorId, this.expIdFloor, true, this.expBuildId, this.expIdFloor);
                }
    ...
    addFloorQuestionDetail(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            this.queslistfloor.push(this.formBuilder.group({
                ...
                VistId: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].VistId, null),
                BuildIndx: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].BuildIndx, null),
                FloorIndx: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].FloorIndx, null),
                FloorId: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].FloorId, null),
                Status: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].Status, null),
                Condition: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(false, null),
                FloorName: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].FloorName, null),
                FloorCondi: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].FloorCondi, null),
                FloorClose: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].FloorClose, null),
                RoomCondition: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].RoomCondition, null),
                BuildIndex: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].BuildIndex, null),
                FloorIndex: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].FloorIndex, null),
            }));
    ...
    addRoomQuestionDetail(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            this.queslistroom.push(this.formBuilder.group({
                ...
                BuildIndx: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].BuildIndx, null),
                FloorIndx: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].FloorIndx, null),
                RoomId: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].RoomId, null),
                Status: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].Status, null),
                Condition: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(false, null),
                RoomName: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl(data[i].RoomName, null)
            }));
    ...
    getdashboardRoomData(bulId, floor, id, h, j) {
        let query = 'SELECT * FROM sidsPrimaryRoomSaves' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildIndx = "' + bulId + '"' +
            ' And FloorIndx = "' + floor + '"' +
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length == 0) {
                this.getdashboardAddRoomData(bulId, floor, id, h, j);
            }
            else {
                let dataListFloor = [];
                for (var i = 0; i < data.rows.length; i++) {
    ...
    getdashboardAddRoomData(bulId, floor, id, h, j) {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            ...
            if (data.rows.length == 0) {
                let insertRows = [];
                insertRows.push([
                    "INSERT INTO sidsPrimaryRoomSaves VALUES (?,?,?,?,?,?,?,?,?,?,?,?)",
                    [null, id, this.schoolId, this.vistId, bulId, floor, dataId, "1", "Room", (_a = this.form.value.sids[h]) === null || _a === void 0 ? void 0 : _a.BuildIndex, (_b = this.formfloor.value.sidsfloor[j]) === null || _b === void 0 ? void 0 : _b.FloorIndex, ""]
                ]);
                this.sqliteDB.bulkInsert(insertRows).then((result) => {
                    console.info("Dashboard Room SIDS Details Stored Locally");
                });
                this.checkRoomSavedata(bulId, floor, dataId, h, j);
            }
            else {
                this.getRoomLocalData(bulId, floor, h, j);
            }
        });
    }
    checkRoomSavedata(bulId, floor, dataId, h, j) {
        let query = 'SELECT * FROM sidsPrimaryRoomSaves' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildIndx = "' + bulId + '"' +
            ' And FloorIndx = "' + floor + '"' +
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length == 0) {
                this.getRoomLocalData(bulId, 1, h, j);
            }
            else {
                this.getRoomLocalData(bulId, floor, h, j);
            }
    ...
    getRoomLocalData(bulId, floor, h, j) {
                    ...
                    if (data.rows.length == 0) {
                        ...
                        if (FloorServerData.length > 0) {
                            ...
                            if (filterFloorSavedData.length > 0) {
                                this.getdashboardAddRoomData(bulId, floor, 0, h, j);
                            }
                            else {
    ...
    goToBack() {
        ...
        this.router.navigate(['/tabs/primary-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId }, skipLocationChange: false });
    }
    onBuilding(id, status) {
        ...
        this.router.navigate(['/tabs/primary-building-questions'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'buildingId': dataId, 'status': status }, skipLocationChange: false });
    }
    onFloor(id, floor, status, buildName) {
        ...
        this.router.navigate(['/tabs/primary-floor-questions'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'buildingId': bdataId, 'floorId': fdataId, 'status': status, 'buildName': buildName }, skipLocationChange: false });
    }
    onRoom(id, floor, room, status, buildName) {
        id = 100 + parseInt(id);
        floor = 1000 + parseInt(floor);
        room = 10000 + parseInt(room);
        this.router.navigate(['/tabs/primary-room-questions'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'buildingId': id, 'floorId': floor, 'roomId': room, 'status': status, 'buildName': buildName }, skipLocationChange: false });
    }
    ...
    onSaveBuilding(id) {
        var _a;
        this.buldid = 100 + parseInt(id);
        let dataImage = (_a = this.dataListBuildingSave[0].BldgFrontPhoto) === null || _a === void 0 ? void 0 : _a.split(',');
        // for (let i = 0; i < data.length; i++) {
        let data = {
            "records": {
        ...
        this.utilityService.saveBuildingSids(data).subscribe(res => {
            if (res.dataStatus) {
                ...
                if (dataImage.length > 1) {
                    let imgObj = {
                        "records": {
                            "Photo": dataImage[1],
                            "PhotoName": this.dataListBuildingSave[0].BldgFrontPhotoName
                        }
                    };
                    this.emisService.S3ImageSave(imgObj).subscribe(res => { });
                }
                this.buildingDelete();
                let query = 'UPDATE sidsPrimaryBuildSavesDatas SET Status = ' + "3" + ',ClosingQuestions =' + "3" + ',BuildIndex = ' + res.IndexId + ' WHERE sidsPrimaryBuildSavesDatas.SclId = "' + this.schoolId + '" And sidsPrimaryBuildSavesDatas.BuildingId = "' + this.buldid + '" And sidsPrimaryBuildSavesDatas.VistId = "' + this.vistId + '"';
                let query1 = 'UPDATE sidsPrimaryBuildingQuestion SET BuildingIndex ="' + res.IndexId + '" WHERE sidsPrimaryBuildingQuestion.SclId = "' + this.schoolId + '" And sidsPrimaryBuildingQuestion.BuildingId = "' + this.buldid + '"';
    ...
    buildingDelete() {
        let selectQuery = 'SELECT * FROM DeleteBuilding';
        this.sqliteDB.getDataLocalDB(selectQuery).then(data => {
            if (data.rows.length > 0) {
                let DeleteBUilding = [];
                for (var i = 0; i < data.rows.length; i++) {
                ...
                if (DeleteBUilding.length > 0) {
                    for (let i = 0; i < DeleteBUilding.length; i++) {
                        let dataSet = JSON.parse(DeleteBUilding[i].Records);
                        this.sidsService.StgSidsDelBuilding(dataSet).subscribe(res => {
                            if (res.dataStatus) {
                                console.log(DeleteBUilding[i].BuildId, "Building Deleted Completed");
                                let deleteQuery = 'DELETE FROM DeleteBuilding WHERE schoolId = ' + DeleteBUilding[i].schoolId + ' And visitId = ' + DeleteBUilding[i].visitId + ' And BuildId = ' + DeleteBUilding[i].BuildId;
                                this.sqliteDB.getDataLocalDB(deleteQuery).then(data => {
    ...
    getfloor(id, indBuild, floorId) {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(responce => {
            if (responce.rows.length == 0) {
                this.utilityService.getFloorSids(this.vistId, indBuild).subscribe(res => {
                    if (res.dataStatus) {
    ...
    onFloorBuild(iId, buildingId, floorId, item1) {
        ...
        if (this.filterbuild.length == 0) {
            ...
            let query5 = 'SELECT * FROM sidsPrimaryBuildSavesDatas' +
                ' WHERE SclId = "' + this.schoolId + '"' +
    ...
    onSaveFloor(bulid, floorid, i) {
        ...
        this.utilityService.saveFloorSids(data).subscribe(res => {
            // this.checkRoomLocalDb(bulid, floorid)
            // if (res.dataStatus) {
            // console.log(data, res)
            this.floorDelete();
            let query = 'UPDATE sidsPrimaryFloorSaveDatas SET Status = ' + "3" + ', FloorClose = ' + "3" + ', BuildIndex = ' + this.filterbuild[0].IndexId + ', FloorIndex = ' + res.IndexId + ' WHERE sidsPrimaryFloorSaveDatas.SclId = "' + this.schoolId + '" And sidsPrimaryFloorSaveDatas.BuildIndx = "' + bulid + '" And sidsPrimaryFloorSaveDatas.FloorId = "' + floorid + '" And sidsPrimaryFloorSaveDatas.VistId = "' + this.vistId + '"';
            debugger;
            let query2 = 'UPDATE sidsPrimaryFloorQuestion SET FloorIndx ="' + res.IndexId +
                '" WHERE sidsPrimaryFloorQuestion.SclId = "' + this.schoolId + '" And sidsPrimaryFloorQuestion.BuildingId = "' + this.dataListFloorSave[0].BuildingId + '" And sidsPrimaryFloorQuestion.VistId = "' + this.vistId + '" And sidsPrimaryFloorQuestion.FloorId = "' + floorid + '"';
            ...
            return this.sqliteDB.update(query).then(data => {
                return this.sqliteDB.update(query2).then(data => {
                    ...
                    // this.formfloor.controls['sidsfloor']['controls'][i].controls['Status'].updateValueAndValidity();
                    //   this.checkRoomLocalDb(bulid, floorid)
                    this.getfloor(bulid, this.filterbuild[0].IndexId, floorid);
                });
            });
        });
        this.router.navigate(['/tabs/primary-new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId }, skipLocationChange: false });
    }
    floorDelete() {
        let selectQuery = 'SELECT * FROM DeleteFloor';
        this.sqliteDB.getDataLocalDB(selectQuery).then(data => {
            if (data.rows.length > 0) {
                let DeleteFloor = [];
                for (var i = 0; i < data.rows.length; i++) {
                ...
                if (DeleteFloor.length > 0) {
                    for (let i = 0; i < DeleteFloor.length; i++) {
                        let dataSet = JSON.parse(DeleteFloor[i].Records);
                        this.sidsService.StgSidsDelFloor(dataSet).subscribe(res => {
                            if (res.dataStatus) {
                                console.log(DeleteFloor[i].FloorId, "Floor Deleted Completed");
                                let deleteQuery = 'DELETE FROM DeleteFloor WHERE schoolId = ' + DeleteFloor[i].schoolId + ' And visitId = ' + DeleteFloor[i].visitId + ' And FloorId = ' + DeleteFloor[i].FloorId;
                                this.sqliteDB.getDataLocalDB(deleteQuery).then(data => {
                                });
                            }
                        });
    ...
    onSaveRoom(id, floor, roomid, iId) {
        ...
        if (this.filterfloor.length == 0) {
            ...
            let query5 = 'SELECT * FROM sidsPrimaryFloorSaveDatas' +
                ' WHERE SclId = "' + this.schoolId + '"' +
                ' And BuildIndx = "' + id + '"' +
                ...
                if (floorSuccess.length > 0) {
                    ...
                    return this.sqliteDB.getDataLocalDB(query).then(data => {
                        ...
                        if (data.rows.length > 0) {
                            ...
                            debugger;
                            let dataFI = dataListData[0].FloorIndex ? dataListData[0].FloorIndex : this.filterfloor[0].IndexId;
                            console.log(this.dataListData, "data room");
                            let dataImage1 = (_a = this.dataListData[0].LabPhotoOne) === null || _a === void 0 ? void 0 : _a.split(',');
                            let dataImage2 = (_b = this.dataListData[0].SmartRoomPhotoOne) === null || _b === void 0 ? void 0 : _b.split(',');
                            let dataImage3 = (_c = this.dataListData[0].RoomCeilingPhoto) === null || _c === void 0 ? void 0 : _c.split(',');
                            let datarecords = {
                                "records": {
                                    "IndxId": this.dataListData[0].IndxId,
                                    "SchlId": this.schoolId,
                                    "VistId": this.vistId,
                                    "BldgIdxId": this.filterbuild[0].IndexId,
                                    "BldgId": this.buldid,
                                    ...
                                    "BenchFunc": this.dataListData[0].BenchFunc,
                                    "DeskFunc": this.dataListData[0].DeskFunc,
                                    ...
                                    "RoomCeilingYn": this.dataListData[0].RoomCeilingYn,
                                    "RoomCeilingPhoto": this.dataListData[0].RoomCeilingPhotoName,
                                    // "RoomCeilingPhotoName": this.dataListData[0].RoomCeilingPhotoName,
                                    "RoomCeilingLatitude": this.dataListData[0].RoomCeilingLatitude,
                                    "RoomCeilingLongitude": this.dataListData[0].RoomCeilingLongitude,
                                    ...
                                    "LabPhotoOne": this.dataListData[0].LabPhotoOneName,
                                    "LabLatitude": this.dataListData[0].LabLatitude,
                                    "LabLongitude": this.dataListData[0].LabLongitude,
                                    ...
                                    "SmartRoomPhotoOne": this.dataListData[0].SmartRoomPhotoOneName,
                                    "SmartRoomLatitude": this.dataListData[0].SmartRoomLatitude,
                                    "SmartRoomLongitude": this.dataListData[0].SmartRoomLongitude,
                                }
                            };
                            this.utilityService.saveRoomSids(datarecords).subscribe(res => {
                                let floors = parseInt(floor) - 1000;
                                console.log(floors);
                                this.dataListData[0].IndxId = res.IndexId;
                                if (dataImage1.length > 1) {
                                    let imgObj = {
                                        "records": {
                                            "Photo": dataImage1[1],
                                            "PhotoName": this.dataListData[0].LabPhotoOneName
                                        }
                                    };
                                    this.emisService.S3ImageSave(imgObj).subscribe(res => { });
                                }
                                if (dataImage2.length > 1) {
                                    let imgObj = {
                                        "records": {
                                            "Photo": dataImage2[1],
                                            "PhotoName": this.dataListData[0].SmartRoomPhotoOneName
                                        }
                                    };
                                    this.emisService.S3ImageSave(imgObj).subscribe(res => { });
                                }
                                if (dataImage3.length > 1) {
                                    let imgObj = {
                                        "records": {
                                            "Photo": dataImage3[1],
                                            "PhotoName": this.dataListData[0].RoomCeilingPhotoName
                                        }
                                    };
                                    this.emisService.S3ImageSave(imgObj).subscribe(res => { });
                                }
                                let query2 = 'UPDATE newPrimaryRoomscommons SET IndxId = ' + res.IndexId +
                                    ' WHERE SchlId = "' + this.schoolId + '"' +
                                    ' And BldgId = "' + this.buldid + '"' +
                                    ' And FloorId = "' + this.floorid + '"' +
                                    ' And RoomId = "' + this.roomid + '"' +
                                    ' And VistId = "' + this.vistId + '"';
                                let query = 'UPDATE sidsPrimaryRoomSaves SET Status = ' + "3" + ', RoomIndex = ' + res.IndexId + ' WHERE sidsPrimaryRoomSaves.SclId = "' + this.schoolId + '" And sidsPrimaryRoomSaves.BuildIndx = "' + id + '" And sidsPrimaryRoomSaves.FloorIndx = "' + floor + '" And sidsPrimaryRoomSaves.RoomId = "' + this.roomid + '"';
                                this.sqliteDB.update(query).then(data => {
                                    if (this.dataListData[0].RoomUse != '10') {
                                    }
                                    console.log(this.formroom.value);
                                    this.sqliteDB.update(query2).then(data => {
                                    });
                                ...
                                if (+this.dataListData[0].RoomUse == 10) {
                                    let toiletData = {
                                        "records": {
                                            "IndexId": this.dataListData[0].ToiletIndxId,
                                            "SchoolId": this.schoolId,
                                            "VisitId": this.vistId,
                                            "BuildId": this.filterbuild[0].IndexId,
                                            "FloorId": dataFI,
                                            "RoomId": this.roomid,
                                            "RoomIdxId": this.dataListData[0].IndxId,
                                    ...
                                    this.utilityService.saveToiletSids(toiletData).subscribe(ress => {
                                        let query3 = 'UPDATE newPrimaryRoomscommons SET ToiletIndxId = ' + ress.IndexId +
                                            ' WHERE SchlId = "' + this.schoolId + '"' +
                                            ' And BldgId = "' + this.buldid + '"' +
                                            ' And FloorId = "' + this.floorid + '"' +
                                            ' And RoomId = "' + this.roomid + '"' +
                ...
                if (filterLocalBuild.length > 0) {
                    ...
                    if (filterCloseBuild.length > 0) {
                        ...
                        if (+filterLocalBuild2[buildLength].BuildCondi == 2 || +filterLocalBuild2[buildLength].BuildCondi == 3) {
                            this.getBuildAddData(parseInt(id) + 1);
                            this.lastRoomId = 0;
                        }
                        else {
    ...
    buildingFloor(id, filterServerBuild2) {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(floor => {
            ...
            if (sidsFloor.length > 0) {
                ...
                this.utilityService.getFloorSids(this.vistId, filterServerBuild2[0].IndexId).subscribe(res => {
                    if (res.dataStatus) {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(room => {
            ...
            if (sidsRoom.length > 0) {
                ...
                if (+sidsBuild[0].Status == 3 && +sidsFloor[0].Status == 3) {
                    this.utilityService.getRoomSids(this.vistId, this.filterbuild[0].IndexId, this.filterfloor[0].FoolrId).subscribe(res => {
    ...
    floorInsideRoom(id, floor) {
        ...
        let query = 'DELETE FROM sidsPrimaryRoomSaves' +
            ...
            // ' And RoomId = "' + dataIdR + '"' +
            ' And VistId = "' + this.vistId + '"';
        let query2 = 'SELECT * FROM newPrimaryRoomscommons' +
            ' WHERE SchlId = "' + this.schoolId + '"' +
            ' And BldgId = "' + dataIdB + '"' +
            ' And FloorId = "' + dataIdF + '"' +
            // ' And RoomId = "' + dataIdR + '"' +
    ...
    buildingInsideFloorRoom(id) {
        ...
        let query2 = 'DELETE FROM sidsPrimaryFloorQuestion' +
            ...
            ' And BuildingId = "' + dataId + '"' +
            ' And VistId = "' + this.vistId + '"';
        let query3 = 'DELETE FROM sidsPrimaryRoomSaves' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildIndx = "' + id + '"' +
            ' And VistId = "' + this.vistId + '"';
        let query4 = 'DELETE FROM newPrimaryRoomscommons' +
            ' WHERE SchlId = "' + this.schoolId + '"' +
            ' And BldgId = "' + dataId + '"' +
            ' And VistId = "' + this.vistId + '"';
        return this.sqliteDB.getDataLocalDB(query).then(data => {
    ...
    addBuildingServer(id) {
        ...
        this.utilityService.getBuildingSids(this.vistId, this.schoolId).subscribe(res => {
            if (res.dataStatus) {
                ...
                this.utilityService.getFloorSids(this.vistId, this.filterbuild[0].IndexId).subscribe(res => {
                    if (res.dataStatus) {
                        this.filterfloor = res.result.filter((item) => item.BldgId == this.buldid);
                        console.log("filterfloor", this.filterfloor);
                        this.utilityService.getRoomSids(this.vistId, this.filterbuild[0].IndexId, this.filterfloor[0].IndexId).subscribe(res => {
                            if (res.dataStatus) {
    ...
    getFloorClosingQues(buildId, item, n, buildName) {
        ...
        this.router.navigate(['/tabs/primary-floor-closing-questions'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'buildingId': bdataId, 'floorId': fdataId, 'status': item.value.Status, 'buildName': buildName }, skipLocationChange: false });
    }
    ionViewWillLeave() {
...
PrimaryNewDashboardPage.ctorParameters = () => [
...
PrimaryNewDashboardPage = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
...
//# sourceMappingURL=src_app_pages_sids_primary-school_primary-building_primary-new-dashboard_primary-new-dashboar-78e4ad-es2015.js.map