...
/* harmony export */   "VolunteerSearchPageRoutingModule": function() { return /* binding */ VolunteerSearchPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _volunteer_search_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./volunteer-search.page */ 17005);
...
let VolunteerSearchPageRoutingModule = class VolunteerSearchPageRoutingModule {
};
VolunteerSearchPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], VolunteerSearchPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VounteerSearchPageModule": function() { return /* binding */ VounteerSearchPageModule; }
/* harmony export */ });
...
/* harmony import */ var _volunteer_search_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./volunteer-search-routing.module */ 91671);
/* harmony import */ var _volunteer_search_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./volunteer-search.page */ 17005);
...
let VounteerSearchPageModule = class VounteerSearchPageModule {
};
VounteerSearchPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            ...
            _volunteer_search_routing_module__WEBPACK_IMPORTED_MODULE_0__.VolunteerSearchPageRoutingModule
        ],
        declarations: [_volunteer_search_page__WEBPACK_IMPORTED_MODULE_1__.VolunteerSearchPage]
    })
], VounteerSearchPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VolunteerSearchPage": function() { return /* binding */ VolunteerSearchPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_volunteer_search_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./volunteer-search.page.html */ 47425);
/* harmony import */ var _volunteer_search_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./volunteer-search.page.scss */ 86440);
...
let VolunteerSearchPage = class VolunteerSearchPage {
    constructor(route, navCtrl, router, userSessionService, emisService, alertService) {
        this.route = route;
    ...
    ionViewDidEnter() {
        ...
        if (this.paramsVolunteerId) {
            ...
            this.emisService.searchVolunteerById(this.searchTxt).subscribe((res) => {
                if (res && res.dataStatus) {
                    this.noData = false;
                    this.volInfo = res.result[0];
                    this.showList = true;
                }
                else {
            ...
            this.emisService.searchVolunteerByPhone(this.searchTxt).subscribe((res) => {
                if (res && res.dataStatus) {
                    this.noData = false;
                    this.volInfo = res.result[0];
                    this.showList = true;
        ...
        if (this.searchOption == 'id') {
            this.emisService.searchVolunteerById(this.searchTxt).subscribe((res) => {
                if (res && res.dataStatus) {
                    ...
                    this.noData = true;
                    // this.alertService.error("This id or phone number is not available / volunteer discontinued")
                    this.alertService.error(res.message);
                }
                else {
                    this.noData = true;
    ...
    startInspection() {
        this.router.navigate(['/tabs/volunteer-inspection'], { queryParams: { searchTxt: this.searchTxt,
...
VolunteerSearchPage.ctorParameters = () => [
...
VolunteerSearchPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
//# sourceMappingURL=src_app_pages_itk-center-support_volunteer-search_volunteer-search_module_ts-es2015.js.map