...
/* harmony export */   "PrimaryBuildingClosingQuestionsPageRoutingModule": function() { return /* binding */ PrimaryBuildingClosingQuestionsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _primary_building_closing_questions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primary-building-closing-questions.page */ 84458);
...
let PrimaryBuildingClosingQuestionsPageRoutingModule = class PrimaryBuildingClosingQuestionsPageRoutingModule {
};
PrimaryBuildingClosingQuestionsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], PrimaryBuildingClosingQuestionsPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrimaryBuildingClosingQuestionsPageModule": function() { return /* binding */ PrimaryBuildingClosingQuestionsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _primary_building_closing_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primary-building-closing-questions-routing.module */ 90251);
/* harmony import */ var _primary_building_closing_questions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./primary-building-closing-questions.page */ 84458);
...
let PrimaryBuildingClosingQuestionsPageModule = class PrimaryBuildingClosingQuestionsPageModule {
};
PrimaryBuildingClosingQuestionsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _primary_building_closing_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__.PrimaryBuildingClosingQuestionsPageRoutingModule,
...
], PrimaryBuildingClosingQuestionsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrimaryBuildingClosingQuestionsPage": function() { return /* binding */ PrimaryBuildingClosingQuestionsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_primary_building_closing_questions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./primary-building-closing-questions.page.html */ 17612);
/* harmony import */ var _primary_building_closing_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./primary-building-closing-questions.page.scss */ 39633);
...
let PrimaryBuildingClosingQuestionsPage = class PrimaryBuildingClosingQuestionsPage {
    constructor(router, formBuilder, route, alertController, sqliteDB, utilityService, userSessionService, alertService, el) {
        this.router = router;
    ...
    onSave() {
        ...
        if (this.form.valid) {
            ...
            let query = 'UPDATE sidsPrimaryBuildingQuestion SET RampAvailYn ="' + this.form.value.RampAvailYn +
                '", RampRepairYn = "' + this.form.value.RampRepairYn +
                '", FireExtYn = "' + this.form.value.FireExtYn + '", FirstAidKit = "' + this.form.value.FirstAidKit +
                '", CCTVCameraYn = "' + this.form.value.CCTVCameraYn + '", BuildTabsYn = "' + this.form.value.BuildTabsYn +
                '", BuildTabsNumber = "' + this.form.value.BuildTabsNumber + '", BuildReapairComArea = "' + this.form.value.BuildReapairComArea +
                '", BldgRepair = "' + this.form.value.BldgRepair +
                '", AreaWeatheringReq = "' + this.form.value.AreaWeatheringReq + '", AreaPressedTiles = "' + this.form.value.AreaPressedTiles +
                '", PipeNeedHwDw = "' + this.form.value.PipeNeedHwDw + '", PipeNeedToilet = "' + this.form.value.PipeNeedToilet +
                '", WireLenElectrcty = "' + this.form.value.WireLenElectrcty + '", AreaWaterLeakage = "' + this.form.value.AreaWaterLeakage +
                '", AreaExtWw = "' + this.form.value.AreaExtWw + '", AreaIntWw = "' + this.form.value.AreaIntWw +
                '", AreaReplasting = "' + this.form.value.AreaReplasting + '", AreaReflooring = "' + this.form.value.AreaReflooring +
                '", AreaFlrPatchwrk = "' + this.form.value.AreaFlrPatchwrk + '" WHERE sidsPrimaryBuildingQuestion.SclId = "' + this.schoolId +
                '" And sidsPrimaryBuildingQuestion.BuildingId = "' + this.buildingId + '" And sidsPrimaryBuildingQuestion.VistId = "' + this.vistId + '"';
            let query2 = 'UPDATE sidsPrimaryBuildSavesDatas SET ClosingQuestions = 2, Status = 2 WHERE sidsPrimaryBuildSavesDatas.SclId = "' + this.schoolId + '" And sidsPrimaryBuildSavesDatas.BuildingId = "' + this.buildingId + '"';
    ...
    checkLocalDb() {
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length > 0) {
                ...
                if (this.form.value.BldgRepair) {
                    this.onFunRepair(this.form.value.BldgRepair, 1);
                }
            }
            else {
...
PrimaryBuildingClosingQuestionsPage.ctorParameters = () => [
...
PrimaryBuildingClosingQuestionsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
...
], PrimaryBuildingClosingQuestionsPage);
...
//# sourceMappingURL=src_app_pages_sids_primary-school_primary-building_primary-building-closing-questions_primary-350265-es2015.js.map