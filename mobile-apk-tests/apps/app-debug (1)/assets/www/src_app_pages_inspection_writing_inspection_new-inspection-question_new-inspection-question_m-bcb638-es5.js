  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_inspection_writing_inspection_new-inspection-question_new-inspection-question_m-bcb638"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "NewInspectionQuestionPageRoutingModule": function NewInspectionQuestionPageRoutingModule() {
          return (
            /* binding */
            _NewInspectionQuestionPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _new_inspection_question_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./new-inspection-question.page */
      4267);
      ...
      var _NewInspectionQuestionPageRoutingModule = /*#__PURE__*/_createClass(function NewInspectionQuestionPageRoutingModule() {
        _classCallCheck(this, NewInspectionQuestionPageRoutingModule);
      });

      _NewInspectionQuestionPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "NewInspectionQuestionPageModule": function NewInspectionQuestionPageModule() {
          return (
            /* binding */
            _NewInspectionQuestionPageModule
          );
        }
        /* harmony export */
      ...
      var _new_inspection_question_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./new-inspection-question-routing.module */
      48745);
      /* harmony import */


      var _new_inspection_question_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./new-inspection-question.page */
      4267);

      var _NewInspectionQuestionPageModule = /*#__PURE__*/_createClass(function NewInspectionQuestionPageModule() {
        _classCallCheck(this, NewInspectionQuestionPageModule);
      });

      _NewInspectionQuestionPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _new_inspection_question_routing_module__WEBPACK_IMPORTED_MODULE_0__.NewInspectionQuestionPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "NewInspectionQuestionPage": function NewInspectionQuestionPage() {
          return (
            /* binding */
            _NewInspectionQuestionPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_new_inspection_question_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./new-inspection-question.page.html */
      40071);
      /* harmony import */


      var _new_inspection_question_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./new-inspection-question.page.scss */
      43625);
      /* harmony import */
      ...
      var _NewInspectionQuestionPage = /*#__PURE__*/function () {
        function NewInspectionQuestionPage(router, alertService, route, userService, uploadService, http, fb, el, usersessionService) {
          _classCallCheck(this, NewInspectionQuestionPage);
          ...
          this.PP_Training1_5 = [{
            ...
            Obser_focus: "",
            Options: [{
              label: 'Explained the purpose and/or objectives of the session',
              value: '1'
            }, {
              label: 'Shared the agenda of the session',
              value: '2'
            }, {
              label: 'Shared the expectations for participation',
              value: '3'
            }, {
            ...
            Obser_focus: "",
            Options: [{
              label: 'Observed the discussion/practice',
              value: '1'
            }, {
              label: 'Spent time with different groups',
              value: '2'
            }, {
              label: 'Asked questions',
              value: '3'
            }, {
              label: 'Encouraged participation',
              value: '4'
            }, {
              label: 'Cleared doubts',
              value: '5'
            }, {
              label: 'Not applicable',
              value: '6'
            ...
            Obser_focus: "",
            Options: [{
              label: 'Content was read out word-by-word',
              value: '1'
            }, {
              label: 'Content was used to explain the PPT using own words',
              value: '2'
            }, {
              label: 'Explanation was different from the content on the PPT',
              value: '3'
            }, {
              label: 'Not applicable',
              value: '4'
            ...
            Obser_focus: "",
            Options: [{
              label: 'Yes/no questions like "Did you understand?"',
              value: '1'
            }, {
              label: 'Factual questions about recalling the content explained',
              value: '2'
            }, {
              label: 'Factual questions about recalling the instructions for activities',
              value: '3'
            }, {
              label: 'Open questions about explaining the content using their own words',
              value: '4'
            }, {
              label: 'No questions were asked',
              value: '5'
            ...
            Obser_focus: "",
            Options: [{
              label: 'Repeated the explanation',
              value: '1'
            }, {
              label: 'Explained using a different example',
              value: '2'
            }, {
              label: 'Asked follow up questions',
              value: '3'
            }, {
              label: 'Encouraged participants to ask questions or share doubts',
              value: '4'
            }, {
              label: 'Not Applicable',
              value: '5'
            ...
            Obser_focus: "",
            Options: [{
              label: 'A facilitator presented most of the training content; The other facilitator supported',
              value: '1'
            }, {
              label: 'The facilitators took turns to present the training content',
              value: '2'
            }, {
              label: 'There was no coordination/planning between the facilitators',
              value: '3'
            }, {
              label: 'Not applicable',
              value: '4'
          ...
          this.PP_Training1_6 = [{
            ...
            Obser_focus: "",
            Options: [{
              label: 'Ventilated Trainig Rooms',
              value: '1'
            }, {
              label: 'Clean Toilets',
              value: '2'
              ...
              label: 'Mobile network connectivity',
              value: '6'
            }]
          }, {
            QNo: "4",
            ...
            Options: [{
              ...
              label: 'Not applicable for this session',
              value: '6'
            }]
          }, {
            QNo: "5",
            ...
            Options: [{
              ...
              label: 'Actively discussed in small groups',
              value: '2'
            }, {
              label: 'Actively discussed in larger groups',
              value: '3'
            }, {
              label: 'Actively involved in the demo',
              value: '4'
            }, {
              label: 'Not applicable for this session',
              value: '5'
            ...
            Obser_focus: "",
            Options: [{
              label: 'Yes, at the end of the session',
              value: '1'
            }, {
              label: 'Yes, at different points of the session',
              value: '2'
            }, {
              label: 'No questions were asked',
              value: '3'
            ...
            Options: [{
              ...
              label: 'No questions or doubts were asked',
              value: '4'
            }]
          }, {
            QNo: "11",
            ...
            Obser_focus: "",
            Options: [{
              label: 'The content was clear - all of the explanation and discussion was about the topic',
              value: '1'
            }, {
              label: 'The content was not completely clear - some parts of the explanation or discussion were not related to the topic or too short/long',
              value: '2'
            }, {
              label: 'The content was not clear - most of the explanation or discussion was not about the topic or too short/long',
              value: '3'
            }, {
              label: 'Other',
              value: '4'
            ...
            Obser_focus: "",
            Options: [{
              label: 'The resource person(s) summarized the main points',
              value: '1'
            }, {
              label: 'The resource person(s) guided the participants to summarize the main points',
              value: '2'
            }, {
              label: 'There was no summary',
              value: '3'
            }]
          }];
          this.PP_Training1_7 = [{
            ...
            Obser_focus: "",
            Options: [{
              label: 'The content was clear - participants were able to have open discussions was about the topic',
              value: '1'
            }, {
              label: 'The content was not completely clear - some parts of the explanation or discussion were too prescriptive and not engaging',
              value: '2'
            }, {
              label: 'The content was not clear - most of the explanation or discussion was not about the topic or too short/long as well as not engaging the audience',
              value: '3'
            }, {
              label: 'Other',
              value: '4'
            ...
            Options: [{
              ...
              label: 'Some participants seemed to have clarity about some aspects',
              value: '2'
            }, {
              label: 'Majority participants seemed to have clarity about the core agenda.',
              value: '3'
            }, {
              label: 'All participants not only seem to have clarity but were sharing new ideas to add to the agenda',
              value: '4'
            }]
          }, {
            QNo: "4",
        ...
        return _createClass(NewInspectionQuestionPage, [{
          key: "ngOnInit",
          ...
          key: "onKeyup",
          value: function onKeyup(item, nextElement, id) {
            if (item.keyCode == 8) {
          ...
          value: function onUniqueCode() {
            ...
            if (this.form.valid) {
              ...
              this.otp = value4;
              debugger;
              this.userService.getOTPData(value4, this.dateFormat).subscribe(function (res) {
                if (res.dataStatus) {
                  _this.QuesActive = true;
                  _this.trainerCodeDate = res.result[0];

                  if (_this.trainerCodeDate.ProgramType == '11' || _this.trainerCodeDate.ProgramType == '12' || _this.trainerCodeDate.ProgramType == '13' || _this.trainerCodeDate.ProgramType == '17') {
                    _this.ActiveQuetion = true;
                  }

                  if (_this.trainerCodeDate.ProgramType == '21' || _this.trainerCodeDate.ProgramType == '22' || _this.trainerCodeDate.ProgramType == '23') {
                    _this.PP_ActiveQuestion = true;
                  }

                  if (_this.trainerCodeDate.ProgramType == '26') {
                    _this.cpt_ActiveQuestion = true;
                  }

                  if (_this.trainerCodeDate.ProgramType == '29' || _this.trainerCodeDate.ProgramType == '30') {
                    _this.tpd2_ActiveQuestion = true;
                  }

                  console.log(_this.trainerCodeDate.ProgramType, "code");

                  _this.studentData();
                } else {
                  _this.QuesActive = false;

                  _this.alertService.error('Invalid Code');

                  _this.router.navigate(['/tabs/home']); // this.studentData()
          ...
          value: function studentData() {
            ...
            var expiry = 1800;
            this.uploadService.getUploadedFiles(bucketName1, filename1, expiry).subscribe(function (result) {
              if (result) {
                _this2.http.get(result.url).subscribe(function (data) {
                  _this2.question = data;

                  _this2.questionJson3(_this2.question);
                });
              }
            ...
            if (this.trainerCodeDate.ActiveJson == '1') {
              ...
              var expiry1 = 1800;
              this.uploadService.getUploadedFiles(bucketName, filename, expiry1).subscribe(function (result) {
                if (result) {
                  _this2.jsonActive = true;

                  _this2.http.get(result.url).subscribe(function (data) {
                    _this2.question5 = data;

                    _this2.questionJson5(_this2.question5);
                  });
                } else {
                  _this2.jsonActive = false;
                }
              });
            } else {
              var control = this.questionform.controls['tpd_question'];
          ...
          value: function questionJson(item) {
            var control = this.questionform.controls['survey_question'];
            ...
            if (item.length > 0) {
              for (var _i = 0; _i < item.length; _i++) {
                this.queslist.push(this.fb.group({
                  ...
                  Qid: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i].QNo),
                  Question: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i].Question),
                  option: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i].Options),
                  AnsType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i].AnsType),
          ...
          value: function questionJson1(item) {
            var control = this.questionform.controls['itk_question'];
            ...
            if (item.length > 0) {
              for (var _i2 = 0; _i2 < item.length; _i2++) {
                this.queslist1.push(this.fb.group({
                  ...
                  ProgramType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(''),
                  OtpNo: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(this.otp),
                  Qid: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(this.queslist3.length + _i2 + 1),
                  Question: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i2].Question),
                  option: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i2].Options),
                  AnsType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i2].AnsType),
                  Response: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required),
                  CreationUser: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('')
                }));
              }
          ...
          key: "questionJson2",
          value: function questionJson2(item) {
            var control = this.questionform.controls['training_question'];
            ...
            if (item.length > 0) {
              for (var _i3 = 0; _i3 < item.length; _i3++) {
                this.queslist2.push(this.fb.group({
                  ...
                  ProgramType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(''),
                  OtpNo: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(this.otp),
                  Qid: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_i3 + 1 + this.queslist3.length),
                  Question: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i3].Question),
                  option: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i3].Options),
                  AnsType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i3].AnsType),
                  Response: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required),
                  CreationUser: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('')
                }));
              }
          ...
          key: "questionJson3",
          value: function questionJson3(item) {
            var control = this.questionform.controls['general_question'];
            ...
            if (item.length > 0) {
              for (var _i4 = 0; _i4 < item.length; _i4++) {
                this.queslist3.push(this.fb.group({
                  ...
                  ProgramType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(''),
                  OtpNo: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(this.otp),
                  Qid: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i4].QNo),
                  Question: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i4].Question),
                  option: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i4].Options),
                  AnsType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i4].AnsType),
                  Response: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required),
                  CreationUser: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('')
                }));
              }
          ...
          key: "questionJson5",
          value: function questionJson5(item) {
            ...
            if (item.length > 0) {
              for (var _i5 = 0; _i5 < item.length; _i5++) {
                this.queslist5.push(this.fb.group({
                  ...
                  ProgramType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(''),
                  OtpNo: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(this.otp),
                  Qid: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(this.queslist3.length + _i5 + 1),
                  Question: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i5].Question),
                  option: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i5].Options),
                  AnsType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i5].AnsType),
                  Response: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required),
                  CreationUser: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('')
                }));
              }
          ...
          key: "questionJson4",
          value: function questionJson4(item) {
            var control = this.questionform.controls['cpt_question'];
            ...
            if (item.length > 0) {
              for (var _i6 = 0; _i6 < item.length; _i6++) {
                this.queslist4.push(this.fb.group({
                  ...
                  ProgramType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(''),
                  OtpNo: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(this.otp),
                  Qid: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(this.queslist3.length + _i6 + 1),
                  Question: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i6].Question),
                  option: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i6].Options),
                  AnsType: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(item[_i6].AnsType),
                  Response: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required),
                  CreationUser: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('')
                }));
              }
          ...
          value: function onSave() {
            ...
            if (this.questionform.valid) {
              ...
              for (var i = 0; i < this.queslist3.length; i++) {
                record = [{
                  "IndexId": "",
              ...
              if (this.jsonActive) {
                for (var _i7 = 0; _i7 < this.queslist5.value.length; _i7++) {
                  record = [{
                    "IndexId": "",
                    "ProgramType": this.trainerCodeDate.ProgramType,
                    "OtpNo": this.otp,
                    "Qid": this.queslist5.value[_i7].Qid,
                    "Response": this.queslist5.value[_i7].Response.toString(),
                    "CreationUser": this.sessionEmisUsertype
                  }];
                  this.recordData.push(record[0]);
                }
              ...
              this.userService.savepayirchiparvai(data).subscribe(function (res) {
                console.log(res, "res");

                _this3.alertService.success('Success');

                _this3.router.navigate(['/tabs/home']);
              });
            } else {
              this.submitted = true;
      ...
      _NewInspectionQuestionPage.ctorParameters = function () {
        return [{
      ...
      _NewInspectionQuestionPage = (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
...
//# sourceMappingURL=src_app_pages_inspection_writing_inspection_new-inspection-question_new-inspection-question_m-bcb638-es5.js.map