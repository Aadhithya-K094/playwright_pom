...
/* harmony export */   "RecordVerificationPageModule": function() { return /* binding */ RecordVerificationPageModule; }
/* harmony export */ });
...
/* harmony import */ var _record_verification_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./record-verification.page */ 81441);
...
let RecordVerificationPageModule = class RecordVerificationPageModule {
};
RecordVerificationPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RecordVerificationPage": function() { return /* binding */ RecordVerificationPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_record_verification_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./record-verification.page.html */ 77371);
/* harmony import */ var _record_verification_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./record-verification.page.scss */ 28);
...
let RecordVerificationPage = class RecordVerificationPage {
    ...
    getLocalData() {
        this.ionicStorageService.getData('record-verification').then(Response => {
            if (Response) {
                this.last_saved_data.pedagogy_info = Response.record_verification;
    ...
    assignDataAndControl() {
        ...
        this.curr_template = temp.questions.filter(val => val.section == "5");
    ...
    onSubmit() {
        ...
        this.ionicStorageService.insertData_Replace("record-verification", { record_verification: records.pedagogy_info });
        this.navCtrl.navigateBack(['/tnvntabs/page-route', 'question-template-list'], navigationExtras);
    }
};
RecordVerificationPage.ctorParameters = () => [
...
RecordVerificationPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
...
//# sourceMappingURL=src_app_pages_tnvn_observation-data_record-verification_record-verification_module_ts-es2015.js.map