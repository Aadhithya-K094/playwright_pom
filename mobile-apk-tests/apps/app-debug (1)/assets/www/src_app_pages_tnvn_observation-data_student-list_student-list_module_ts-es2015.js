...
/* harmony import */ var _student_list_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./student-list.page */ 29062);
...
StudentListPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/* harmony import */ var _raw_loader_student_list_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./student-list.page.html */ 37860);
/* harmony import */ var _student_list_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./student-list.page.scss */ 37437);
...
let StudentListPage = class StudentListPage {
    constructor(api, fb, activateRoute, modalCtrl, navCtrl, toastService, ionicStorageService, ionicStorage, authService, platform) {
        this.api = api;
        this.fb = fb;
    ...
    dynamicTemplate(option) {
        if (option == 'no') {
            ...
            const control = this.studentGrade.get('questions');
    ...
    assignDataAndControl() {
        ...
        this.curr_template_ques.forEach((res, index) => {
            ...
            if (res.ques_ans_json.type != '5') {
                ...
                const control = this.studentGrade.controls['questions'];
    ...
    onChange(data, event, i) {
    }
    valueChanges(event, data, i) {
    }
};
...
StudentListPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
...
//# sourceMappingURL=src_app_pages_tnvn_observation-data_student-list_student-list_module_ts-es2015.js.map