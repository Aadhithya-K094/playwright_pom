  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_kgbv_hostel-staff-attendance_hostel-staff-attendance_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "HostelStaffAttendancePageRoutingModule": function HostelStaffAttendancePageRoutingModule() {
          return (
            /* binding */
            _HostelStaffAttendancePageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _hostel_staff_attendance_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./hostel-staff-attendance.page */
      2889);
      ...
      var _HostelStaffAttendancePageRoutingModule = /*#__PURE__*/_createClass(function HostelStaffAttendancePageRoutingModule() {
        _classCallCheck(this, HostelStaffAttendancePageRoutingModule);
      });

      _HostelStaffAttendancePageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "HostelStaffAttendancePageModule": function HostelStaffAttendancePageModule() {
          return (
            /* binding */
            _HostelStaffAttendancePageModule
          );
        }
        /* harmony export */
      ...
      var _hostel_staff_attendance_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./hostel-staff-attendance-routing.module */
      2822);
      /* harmony import */


      var _hostel_staff_attendance_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./hostel-staff-attendance.page */
      2889);

      var _HostelStaffAttendancePageModule = /*#__PURE__*/_createClass(function HostelStaffAttendancePageModule() {
        _classCallCheck(this, HostelStaffAttendancePageModule);
      });

      _HostelStaffAttendancePageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _hostel_staff_attendance_routing_module__WEBPACK_IMPORTED_MODULE_0__.HostelStaffAttendancePageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */
        "HostelStaffAttendancePage": function HostelStaffAttendancePage() {
          return (
            /* binding */
            _HostelStaffAttendancePage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_hostel_staff_attendance_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./hostel-staff-attendance.page.html */
      30181);
      /* harmony import */


      var _hostel_staff_attendance_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./hostel-staff-attendance.page.scss */
      17049);
      /* harmony import */
      ...
      var _HostelStaffAttendancePage = /*#__PURE__*/function () {
        function HostelStaffAttendancePage(route, emisService, userService, alertService, cdr, fb, networkService, apiService, alertController, geolocation, locationAccuracy, androidPermissions, sqliteDB, diagnostic, plt, network) {
          var _this = this;

          _classCallCheck(this, HostelStaffAttendancePage);
        ...
        return _createClass(HostelStaffAttendancePage, [{
          ...
          value: function onSync() {
            ...
            if (this.networkService.getCurrentNetworkStatus() == 0) {
              var query = 'DELETE FROM hostelStaffAttendance';
          ...
          value: function checkLocalDB(visitDate, sts) {
            ...
            if (this.networkService.getCurrentNetworkStatus() == 0) {
              var sql = "SELECT * from hostelStaffAttendance WHERE attendance_at = " + "'" + visitDate + "';";
              this.sqliteDB.executeQuery(sql).then(function (data) {
                if (data.rows.length > 0) {
                  ...
                  setTimeout(function () {
                    ...
                    if (card3 && card4) {
                      var card1Height = card3.offsetHeight;
                      card4.style.top = "".concat(card1Height / 2 + 12, "%");
                    }
                  ...
                  var query = "DELETE FROM hostelStaffAttendance WHERE attendance_at = " + "'" + visitDate + "';";

                  _this6.sqliteDB.executeQuery(query).then(function (res) {
                    if (res) {
                      _this6.emisService.hostelStaffListGet(_this6.userId, visitDate).subscribe(function (res) {
                        if (res.dataStatus) {
                          ...
                          if (_this6.stuMasterList.length > 0) {
                            ...
                            _this6.stuMasterList.forEach(function (element) {
                              sqlArray.push(['INSERT INTO hostelStaffAttendance VALUES (?,?,?,?,?,?,?,?)', [null, element.staff_id, element.teacher_name, element.type_teacher, element.attendance_an, element.attendance_fn, element.school_id, visitDate]]);
              ...
              var query = "SELECT * from hostelStaffAttendance WHERE attendance_at = " + "'" + visitDate + "';";
          ...
          value: function submitForm() {
            ...
            if (this.attendanceForm.valid) {
              ...
              if (this.networkService.getCurrentNetworkStatus() == 0) {
                ...
                this.emisService.hostelStaffAttUpt(data).subscribe(function (res) {
                  if (res.dataStatus) {
      ...
      _HostelStaffAttendancePage.ctorParameters = function () {
        return [{
      ...
      _HostelStaffAttendancePage = (0, tslib__WEBPACK_IMPORTED_MODULE_15__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_18__.Component)({
...
//# sourceMappingURL=src_app_pages_kgbv_hostel-staff-attendance_hostel-staff-attendance_module_ts-es5.js.map