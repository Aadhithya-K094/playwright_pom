...
/* harmony export */   "MeasurementQuestionsPageRoutingModule": function() { return /* binding */ MeasurementQuestionsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _measurement_questions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./measurement-questions.page */ 82604);
...
let MeasurementQuestionsPageRoutingModule = class MeasurementQuestionsPageRoutingModule {
};
MeasurementQuestionsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], MeasurementQuestionsPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MeasurementQuestionsPageModule": function() { return /* binding */ MeasurementQuestionsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _measurement_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./measurement-questions-routing.module */ 59059);
/* harmony import */ var _measurement_questions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./measurement-questions.page */ 82604);
...
let MeasurementQuestionsPageModule = class MeasurementQuestionsPageModule {
};
MeasurementQuestionsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _measurement_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__.MeasurementQuestionsPageRoutingModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule,
        ],
        declarations: [_measurement_questions_page__WEBPACK_IMPORTED_MODULE_1__.MeasurementQuestionsPage]
    })
], MeasurementQuestionsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MeasurementQuestionsPage": function() { return /* binding */ MeasurementQuestionsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_measurement_questions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./measurement-questions.page.html */ 69968);
/* harmony import */ var _measurement_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./measurement-questions.page.scss */ 80710);
...
let MeasurementQuestionsPage = class MeasurementQuestionsPage {
    constructor(router, route, sqliteDB, fb, cdref, el, NetworkService, userService, alertController, alertService, usersessionService) {
        this.router = router;
        this.route = route;
    ...
    getStudentList() {
        this.studList = [];
        let query = 'SELECT * FROM uniformStudentlistData WHERE user_id =' + this.user_id;
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length > 0) {
                for (var i = 0; i < data.rows.length; i++) {
                    this.studList.push(data.rows.item(i));
                }
                console.log("studList", this.studList);
                this.form.controls['IndexId'].setValue(this.studList[0].IndexId);
                if (this.studList[0].IndexId != "" && this.studList[0].IndexId != null) {
                    if (+this.gender == 1) {
                        this.form.controls['boysSholderLength'].setValue(this.studList[0].boys_shoulder_len);
                        this.form.controls['boysShirtHeight'].setValue(this.studList[0].boys_shirt_height);
                        this.form.controls['boysHandLength'].setValue(this.studList[0].boys_hand_length);
                        this.form.controls['boysChestCircum'].setValue(this.studList[0].boys_chest_circum);
                        this.form.controls['boysHandCircum'].setValue(this.studList[0].boys_hand_circum);
                        this.form.controls['boysHipCircum'].setValue(this.studList[0].boys_hip_circum);
                        this.form.controls['boysPantHeight'].setValue(this.studList[0].boys_Pant_height);
                        this.form.controls['boysThighCircum'].setValue(this.studList[0].boys_thigh_circum);
                        if ((+this.region == 1 && +this.classId == 2) || +this.region == 2) {
                            this.form.controls['boysLegCircum'].setValue(this.studList[0].boys_leg_circum);
                        }
                        this.form.controls['boysSholderLength'].updateValueAndValidity();
                        this.form.controls['boysShirtHeight'].updateValueAndValidity();
                        this.form.controls['boysHandLength'].updateValueAndValidity();
                        ...
                        this.form.controls['girlsTopSholder'].setValue(this.studList[0].girls_top_sholder);
                        this.form.controls['girlsTopHeight'].setValue(this.studList[0].girls_top_height);
                        this.form.controls['girlsTopHandLength'].setValue(this.studList[0].girls_top_hand_len);
                        this.form.controls['girlsTopChestCircum'].setValue(this.studList[0].girls_top_chest_circum);
                        if (+this.region == 1 && +this.classId == 1) {
                            this.form.controls['girlsTopHandCircum'].setValue(this.studList[0].girls_top_hand_circum);
                        }
                        this.form.controls['girlsBottomHeight'].setValue(this.studList[0].girls_bottom_height);
                        this.form.controls['girlsBottomHipCircum'].setValue(this.studList[0].girls_bottom_hip_circum);
                        if ((+this.region == 1 && +this.classId == 2) || +this.region == 2) {
                            this.form.controls['girlsBottomLegCircum'].setValue(this.studList[0].girls_bottom_leg_circum);
                        }
                        if ((this.region == 1 && +this.classId == 2) || this.region == 2) {
                            this.form.controls['girlsOvercoatSholder'].setValue(this.studList[0].girls_overcoat_sholder);
                            this.form.controls['girlsOvercoatHeight'].setValue(this.studList[0].girls_overcoat_height);
                            this.form.controls['girlsOvercoatChestCircum'].setValue(this.studList[0].girls_overcoat_chest_cir);
                        }
                        this.form.controls['girlsTopSholder'].updateValueAndValidity();
                        this.form.controls['girlsTopHeight'].updateValueAndValidity();
                        this.form.controls['girlsTopHandLength'].updateValueAndValidity();
    ...
    selectBottomlength(event, id) {
        this.bottomlength = event.detail.value;
        let measurementpant = [];
        if (id == 1) {
            measurementpant = this.masterList.filter(item => item.pant_height == this.bottomlength);
        }
        if (id == 2) {
            measurementpant = this.masterList.filter(item => item.hip_circum == this.bottomlength);
        }
        this.bottommeasurement = measurementpant;
    }
    navigateNext() {
        this.router.navigate(['/tabs/uniform-studentlist'], { queryParams: { class_studying_id: this.class_studying_id, sec: this.sec, schoolId: this.schoolId, schoolName: this.schoolName, region: this.region, "measurement_completed": this.measurement_completed } });
    }
    onSave() {
        let data = { "records": {
        ...
        this.userService.submitUniformData(data).subscribe((res) => {
            if (res.dataStatus) {
                let measurement_completed;
                if (this.form.value.IndexId) {
                    measurement_completed = parseInt(this.measurement_completed);
                }
                else {
                    measurement_completed = parseInt(this.measurement_completed) + 1;
                }
                this.form.controls['IndexId'].setValue(res.IndexId);
                this.form.controls['IndexId'].updateValueAndValidity();
                let query3 = 'UPDATE uniformStudentlistData SET status = "' + '2' + '" WHERE uniformStudentlistData.user_id = "' + this.user_id + '" And uniformStudentlistData.school_id = "' + this.schoolId + '"';
                let query = 'UPDATE uniformschoollists SET measurement_completed = "' + measurement_completed + '" WHERE uniformschoollists.school_id = "' + this.schoolId + '"';
                this.sqliteDB.update(query3).then(res => {
                    this.sqliteDB.update(query).then(res => {
                        this.updateStudList();
                        // let measurement_completed = parseInt(this.measurement_completed) + 1
                        this.router.navigate(['/tabs/uniform-studentlist'], { queryParams: { class_studying_id: this.class_studying_id, sec: this.sec, schoolId: this.schoolId, schoolName: this.schoolName, region: this.region, "measurement_completed": measurement_completed } });
                        this.alertService.success('Measured Successfully');
                    });
                });
            }
            else {
    ...
    updateStudList() {
        let query = 'UPDATE uniformStudentlistData SET boys_shoulder_len ="' + this.form.value.boysSholderLength +
            '", boys_shirt_height = "' + this.form.value.boysShirtHeight +
            '", boys_hand_length = "' + this.form.value.boysHandLength +
            '", boys_chest_circum = "' + this.form.value.boysChestCircum +
            '", boys_hand_circum = "' + this.form.value.boysHandCircum +
            '", boys_hip_circum = "' + this.form.value.boysHipCircum +
            '", boys_Pant_height = "' + this.form.value.boysPantHeight + '", boys_thigh_circum = "' + this.form.value.boysThighCircum +
            '", boys_leg_circum = "' + this.form.value.boysLegCircum + '", girls_top_sholder = "' + this.form.value.girlsTopSholder +
            '", girls_top_height = "' + this.form.value.girlsTopHeight + '", girls_top_hand_len = "' + this.form.value.girlsTopHandLength +
            '", girls_top_chest_circum = "' + this.form.value.girlsTopChestCircum + '", girls_top_hand_circum = "' + this.form.value.girlsTopHandCircum +
            '", girls_bottom_height = "' + this.form.value.girlsBottomHeight +
            '", girls_bottom_hip_circum = "' + this.form.value.girlsBottomHipCircum +
            '", girls_bottom_leg_circum = "' + this.form.value.girlsBottomLegCircum +
            '", girls_overcoat_sholder = "' + this.form.value.girlsOvercoatSholder +
            ...
            '", isCompleted = "' + 2 +
            '" WHERE uniformStudentlistData.user_id = "' + this.user_id + '" And uniformStudentlistData.school_id = "' + this.schoolId + '"';
        this.sqliteDB.update(query).then(res => {
...
MeasurementQuestionsPage.ctorParameters = () => [
...
MeasurementQuestionsPage.propDecorators = {
...
MeasurementQuestionsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
...
//# sourceMappingURL=src_app_pages_uniform_measurement-questions_measurement-questions_module_ts-es2015.js.map