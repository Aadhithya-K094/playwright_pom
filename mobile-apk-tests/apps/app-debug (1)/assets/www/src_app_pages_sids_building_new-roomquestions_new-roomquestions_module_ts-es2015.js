...
/* harmony export */   "NewRoomquestionsPageRoutingModule": function() { return /* binding */ NewRoomquestionsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _new_roomquestions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./new-roomquestions.page */ 67438);
...
let NewRoomquestionsPageRoutingModule = class NewRoomquestionsPageRoutingModule {
};
NewRoomquestionsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NewRoomquestionsPageModule": function() { return /* binding */ NewRoomquestionsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _new_roomquestions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./new-roomquestions-routing.module */ 1834);
/* harmony import */ var _new_roomquestions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./new-roomquestions.page */ 67438);
...
let NewRoomquestionsPageModule = class NewRoomquestionsPageModule {
};
NewRoomquestionsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            ...
            _new_roomquestions_routing_module__WEBPACK_IMPORTED_MODULE_0__.NewRoomquestionsPageRoutingModule
        ],
        declarations: [_new_roomquestions_page__WEBPACK_IMPORTED_MODULE_1__.NewRoomquestionsPage]
    })
], NewRoomquestionsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NewRoomquestionsPage": function() { return /* binding */ NewRoomquestionsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_new_roomquestions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./new-roomquestions.page.html */ 58585);
/* harmony import */ var _new_roomquestions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./new-roomquestions.page.scss */ 32416);
...
let NewRoomquestionsPage = class NewRoomquestionsPage {
    constructor(formBuilder, route, camera, router, el, androidPermissions, sqliteDB, toastController, alertService, utilityService, file, uploadService, geolocation) {
    ...
    initialValidator() {
        this.form = this.formBuilder.group({
            ...
            "SmartServiceProviderOthersRmrk": new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormControl('', null),
            // "AreaExtWw": new FormControl('', null),
    ...
    onSelectedRoom() {
        ...
        if (+this.RoomUse == 2) {
            ...
            // this.form.controls['LabPhotoTwoName'].setValue('');
            this.form.controls['LabType'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required);
            ...
            this.form.controls['LabPhotoOne'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required);
        ...
        // this.form.controls['LabPrinterWebcam'].updateValueAndValidity();
        ...
        // this.form.controls['LabPhotoTwo'].updateValueAndValidity();
        this.form.controls['LabPhotoOneName'].updateValueAndValidity();
        // this.form.controls['LabPhotoTwoName'].updateValueAndValidity();
    ...
    onSelectChange(event, id) {
        ...
        if (id == 3) {
            ...
            if (this.RoomUse == 10 && (this.form.value.ToiletType == '1' || this.form.value.ToiletType == '2' ||
                this.form.value.ToiletType == '3' || this.form.value.ToiletType == '4' || this.form.value.ToiletType == '5' || this.form.value.ToiletType == '6' ||
                this.form.value.ToiletType == '7' || this.form.value.ToiletType == '8' || this.form.value.ToiletType == '9')) {
            ...
            if (this.RoomUse == 10 && (this.form.value.ToiletType == 1 ||
                this.form.value.ToiletType == 2 || this.form.value.ToiletType == 3 ||
                this.form.value.ToiletType == 7)) {
                this.form.controls['Urinals'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required);
            }
            else {
                this.form.controls['Urinals'].setValidators(null);
            }
            if (this.RoomUse == 10 && this.form.value.Ewccubicles && (this.form.value.ToiletType == '1' ||
                this.form.value.ToiletType == '2' || this.form.value.ToiletType == '3' || this.form.value.ToiletType == '4' || this.form.value.ToiletType == '5' || this.form.value.ToiletType == '6' ||
                this.form.value.ToiletType == '7' || this.form.value.ToiletType == '8' || this.form.value.ToiletType == '9')) {
            ...
            if (this.RoomUse == 10 && this.form.value.Urinals && (this.form.value.ToiletType == 1
                || this.form.value.ToiletType == 2 || this.form.value.ToiletType == 3 ||
                this.form.value.ToiletType == 7)) {
    ...
    onChangeBuildingData(event, id) {
        if (id == 11) {
            ...
            if (this.form.value.RoomBreadth) {
                let area = this.form.value.RoomBreadth * event;
                this.form.controls['RoomArea'].setValue(area);
            }
        }
        if (id == 12) {
            let area = this.form.value.RoomLength * event;
            this.form.controls['RoomArea'].setValue(area);
        }
    ...
    onSave() {
        ...
        if (this.RoomUse != '' && this.RoomName != '' && this.form.valid) {
            ...
            let query = 'DELETE FROM newRoomscommons' + ' WHERE SchlId = "' + this.schoolId + '"' +
            ...
            return this.sqliteDB.getDataLocalDB(query).then(data => {
                if (data.rows.length == 0) {
                    let insertRows = [];
                    insertRows.push([
                        "INSERT INTO newRoomscommons VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                        [
                            null, null, this.schoolId, this.vistId, "", this.buildingId, "", this.floorId, this.roomid,
                            ...
                            // .this.form.value.AreaExtWw, 
                            this.form.value.AreaIntWw, this.form.value.AreaReplastering,
                            ...
                            this.form.value.RoomLength, this.form.value.RoomBreadth,
                            // .this.form.value.RoomHeight,
                            this.form.value.FloorType, this.form.value.NumBenchAvail, this.form.value.NumDesksAvail,
                            this.form.value.TubelightFunc, this.form.value.FansFunc, this.form.value.Cupboard, this.form.value.NumCupboardReq,
                            this.form.value.TeacherTableYn,
                            // .this.form.value.TelevisionYn, 
                            this.form.value.TelevisionFuncYn,
                            // .this.form.value.SmartboardPrjtYn, 
                            this.form.value.SmartboardPrjtFuncYn,
                            this.form.value.ClassRoomProjYn,
                            // .this.form.value.ClassRoomProjFuncYn,
                            this.form.value.LabType,
                            // .this.form.value.LabComputerYn, 
                            this.form.value.LabComputerFunc,
                            this.form.value.LabComputerRepair, this.form.value.LabWatersupplyYn, this.form.value.LabDrainage,
                            this.form.value.LibraryBooks,
                            // .this.form.value.HmRoomTblYn, 
                            this.form.value.StaffrmUsedBy,
                            this.form.value.KitchenWtrSrc, this.form.value.KitchenLPGConYn, this.form.value.KitchenWtrSupply,
                            this.form.value.KitchenStorageYn, this.form.value.KitchenCleanYn, this.form.value.KitchenGardenYn,
                            ...
                            // .this.form.value.IwcToilet,
                            this.form.value.Iwccubicles, this.form.value.IwccubiclesFunc,
                            // .this.form.value.EwcToilet,
                            this.form.value.Ewccubicles,
                            this.form.value.Ewccubiclesfunc,
                            // .this.form.value.UrinalToilet, 
                            this.form.value.Urinals, this.form.value.Urinalsfunc,
                            this.form.value.ToiletTapsFunc, this.form.value.ToiletNeedTabs, this.form.value.ToiletBucket,
                            this.form.value.Toiletmugs, this.form.value.SizeSuitable, this.form.value.Roof, this.form.value.ToiletSanitaryPad,
                            this.form.value.SanitWasteDisp, this.form.value.HwFacility,
                            this.form.value.AuditoriumYn, this.form.value.AuditoriumStageYn,
                            ...
                            this.form.value.RoomArea, this.form.value.NumChairAvail, this.form.value.NumTableAvail,
                            this.form.value.LabInternetConn, this.form.value.LabInternetConnType, this.form.value.LabBandwidth,
                            this.form.value.LabServiceProvider, this.form.value.LabServiceProviderOthers, this.form.value.LabProjector, this.form.value.LabPrinter,
                            this.form.value.LabWebCamera, this.form.value.LabMic, this.form.value.LabHeadphones, this.form.value.LabLatitude, this.form.value.LabLogitude,
                            this.form.value.LabPhotoOne, this.form.value.LabPhotoOneName,
                            // this.form.value.LabPhotoTwo, this.form.value.LabPhotoTwoName,
                            this.form.value.HmRoomToiletYn, this.form.value.HmRoomToiletStatus,
                            this.form.value.DiningRoomHandwash, this.form.value.DiningNumTapFunc, this.form.value.ToiletCubicSideHandRail,
                            this.form.value.AudiStageStatus, this.form.value.SmartTabletFunc, this.form.value.SmartSpeakerFunc,
                            this.form.value.SmartPaFunc, this.form.value.SmartInternet, this.form.value.SmartInternetConnType, this.form.value.SmartInternetConnTypeOthers, this.form.value.SmartBandwidth, this.form.value.SmartServiceProvider, this.form.value.SmartServiceProviderOthers,
                        ]
                    ]);
                    this.sqliteDB.bulkInsert(insertRows).then((result) => {
                        ...
                        let updateQuery = 'UPDATE sidsRoomSaves SET Status = 2 , RoomName="' + this.RoomName + '"' +
                            ' WHERE SclId = "' + this.schoolId + '"' + ' And BuildIndx = "' + id + '"' +
                            ' And FloorIndx = "' + floor + '"' + ' And RoomId = "' + this.roomid + '"';
                        let flooor = 'UPDATE sidsFloorSaveDatas SET RoomCondition = 1 WHERE SclId = "' + this.schoolId + '"' +
                            ' And BuildIndx = "' + id + '"' +
                        ...
                        return this.sqliteDB.update(updateQuery).then(data => {
                            ...
                            if (this.status == 3) {
                                this.router.navigate(['/tabs/new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '3', expIdBuild: build, expBuildId: buildId, expIdFloor: floorId, expFloorId: floor, expIdRoom: room, expRoomId: roomId }, skipLocationChange: false });
                            }
                            if (this.status != 3) {
                                this.router.navigate(['/tabs/new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '2', expIdBuild: build, expBuildId: buildId, expIdFloor: floorId, expFloorId: floor, expIdRoom: room, expRoomId: roomId }, skipLocationChange: false });
                            }
    ...
    onGoBack() {
        ...
        let roomId = parseInt(this.roomid) - 10000;
        if (this.status == 1) {
            this.router.navigate(['/tabs/new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '1', expIdBuild: build, expBuildId: buildId, expIdFloor: floorId, expFloorId: floor, expIdRoom: room, expRoomId: roomId }, skipLocationChange: false });
        }
        if (this.status == 2) {
            this.router.navigate(['/tabs/new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '2', expIdBuild: build, expBuildId: buildId, expIdFloor: floorId, expFloorId: floor, expIdRoom: room, expRoomId: roomId }, skipLocationChange: false });
        }
            ...
            if (data.rows.length > 0) {
                ...
                setTimeout(() => {
                    this.form.patchValue({
                        ...
                        "NumBenchAvail": this.dataList[0].NumBenchAvail,
                        "NumDesksAvail": this.dataList[0].NumDesksAvail,
                        "TubelightFunc": this.dataList[0].TubelightFunc,
                        "FansFunc": this.dataList[0].FansFunc,
                        "Cupboard": this.dataList[0].Cupboard,
                        "NumCupboardReq": this.dataList[0].NumCupboardReq,
                        "RoomArea": this.dataList[0].RoomArea,
                        "NumChairAvail": this.dataList[0].NumChairAvail,
                        "NumTableAvail": this.dataList[0].NumTableAvail,
                        ...
                        "LabInternetConn": this.dataList[0].LabInternetConn == "false" ? false : this.dataList[0].LabInternetConn == "true" ? true : this.dataList[0].LabInternetConn == true ? true : false,
                        "LabInternetConnType": this.dataList[0].LabInternetConnType,
                        "LabBandwidth": this.dataList[0].LabBandwidth,
                        "LabServiceProvider": this.dataList[0].LabServiceProvider,
                        "LabServiceProviderOthers": this.dataList[0].LabServiceProviderOthers,
                        "LabProjector": this.dataList[0].LabProjector,
                        // "LabPrinterWebcam": this.dataList[0].LabPrinterWebcam,
                        "LabPrinter": this.dataList[0].LabPrinter,
                        "LabWebCamera": this.dataList[0].LabWebCamera,
                        "LabMic": this.dataList[0].LabMic,
                        "LabHeadphones": this.dataList[0].LabHeadphones,
                        ...
                        "LabLogitude": this.dataList[0].LabLogitude,
                        ...
                        "HmRoomToiletYn": this.dataList[0].HmRoomToiletYn == "false" ? false : this.dataList[0].HmRoomToiletYn == "true" ? true : this.dataList[0].HmRoomToiletYn == true ? true : false,
                        "HmRoomToiletStatus": this.dataList[0].HmRoomToiletStatus,
                        ...
                        "KitchenGardenYn": this.dataList[0].KitchenGardenYn == "false" ? false : this.dataList[0].KitchenGardenYn == "true" ? true : this.dataList[0].KitchenGardenYn == true ? true : false,
                        ...
                        "ToiletCubicSideHandRail": this.dataList[0].ToiletCubicSideHandRail,
                        ...
                        "ToiletSanitaryPad": this.dataList[0].ToiletSanitaryPad,
                        ...
                        "SmartTabletFunc": this.dataList[0].SmartTabletFunc,
                        "SmartSpeakerFunc": this.dataList[0].SmartSpeakerFunc,
                        "SmartPaFunc": this.dataList[0].SmartPaFunc,
                        "SmartInternet": this.dataList[0].SmartInternet == "false" ? false : this.dataList[0].SmartInternet == "true" ? true : this.dataList[0].SmartInternet == true ? true : false,
                        "SmartInternetConnType": this.dataList[0].SmartInternetConnType,
                        "SmartInternetConnTypeOthers": this.dataList[0].SmartInternetConnTypeOthers,
                        "SmartBandwidth": this.dataList[0].SmartBandwidth,
                        "SmartServiceProvider": this.dataList[0].SmartServiceProvider,
                        "SmartServiceProviderOthers": this.dataList[0].SmartServiceProviderOthers,
                    });
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length > 0) {
                ...
                if (+dataList[0].BldgType == 3) {
                    ...
                    this.repair1 = this.repair1.filter(dd => +dd.value != +dataList[0].BldgType);
                }
                else {
                    this.repair1 = [
                        {
    ...
    uploadImgDelete(id) {
        ...
        // this.form.get('LabPhotoTwo').updateValueAndValidity();
    ...
    getLatLong() {
        this.geolocation.getCurrentPosition({
            ...
            this.form.controls['LabLogitude'].setValue(this.locationCordinates.longitude);
            this.form.get('LabLatitude').updateValueAndValidity();
            this.form.get('LabLogitude').updateValueAndValidity();
        }).catch((error) => {
...
NewRoomquestionsPage.ctorParameters = () => [
...
NewRoomquestionsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([
...
//# sourceMappingURL=src_app_pages_sids_building_new-roomquestions_new-roomquestions_module_ts-es2015.js.map