(function () {
  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["node_modules_ionic_core_dist_esm_ion-button_2_entry_js"], {
    /***/
    30392:
    /*!*****************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var Button = /*#__PURE__*/function () {
        function Button(hostRef) {
          ...
          this.handleClick = function (ev) {
            ...
            } else if ((0, _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.l)(_this.el)) {
        ...
        return _createClass(Button, [{
          ...
          value: function render() {
            ...
            return (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, {
              ...
              "class": (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.c)(color, (_ref = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_ref, mode, true), buttonType, true), "".concat(buttonType, "-").concat(expand), expand !== undefined), "".concat(buttonType, "-").concat(finalSize), finalSize !== undefined), "".concat(buttonType, "-").concat(shape), shape !== undefined), "".concat(buttonType, "-").concat(fill), true), "".concat(buttonType, "-strong"), strong), 'in-toolbar', (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.h)('ion-toolbar', this.el)), 'in-toolbar-color', (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.h)('ion-toolbar[color]', this.el)), 'button-has-icon-only', hasIconOnly), _defineProperty(_defineProperty(_defineProperty(_ref, 'button-disabled', disabled), 'ion-activatable', true), 'ion-focusable', true)))
      ...
      var _isValid = function isValid(elm) {
        if (elm.nodeType === 1) {
      ...
      var Icon = /*#__PURE__*/function () {
        ...
        return _createClass(Icon, [{
          ...
          value: function render() {
            ...
            return (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, {
              role: "img",
              "class": Object.assign(Object.assign(_defineProperty({}, mode, true), createColorClasses(this.color)), _defineProperty(_defineProperty({}, "icon-".concat(this.size), !!this.size), 'flip-rtl', !!flipRtl && this.el.ownerDocument.dir === 'rtl'))
