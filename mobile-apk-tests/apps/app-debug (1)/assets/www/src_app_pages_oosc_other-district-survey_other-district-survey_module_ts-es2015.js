...
/* harmony export */   "OtherDistrictSurveyPageRoutingModule": function() { return /* binding */ OtherDistrictSurveyPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _other_district_survey_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./other-district-survey.page */ 3177);
...
let OtherDistrictSurveyPageRoutingModule = class OtherDistrictSurveyPageRoutingModule {
};
OtherDistrictSurveyPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], OtherDistrictSurveyPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OtherDistrictSurveyPageModule": function() { return /* binding */ OtherDistrictSurveyPageModule; }
/* harmony export */ });
...
/* harmony import */ var _other_district_survey_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./other-district-survey-routing.module */ 8106);
/* harmony import */ var _other_district_survey_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./other-district-survey.page */ 3177);
...
let OtherDistrictSurveyPageModule = class OtherDistrictSurveyPageModule {
};
OtherDistrictSurveyPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _other_district_survey_routing_module__WEBPACK_IMPORTED_MODULE_0__.OtherDistrictSurveyPageRoutingModule
        ],
        declarations: [_other_district_survey_page__WEBPACK_IMPORTED_MODULE_1__.OtherDistrictSurveyPage]
    })
], OtherDistrictSurveyPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OtherDistrictSurveyPage": function() { return /* binding */ OtherDistrictSurveyPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_other_district_survey_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./other-district-survey.page.html */ 10395);
/* harmony import */ var _other_district_survey_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./other-district-survey.page.scss */ 88606);
...
let OtherDistrictSurveyPage = class OtherDistrictSurveyPage {
    constructor(alertService, userService, emisService, userSessionService, router, route) {
        ...
        this.userService.getOoscUserDetails(this.teacher_id).subscribe(res => {
            ...
            if (res.dataStatus == true) {
                ...
                if (uerDetails.length > 0) {
                    this.getOoscOtherDistrict(uerDetails[0].district_id);
    ...
    getOoscOtherDistrict(distId) {
        this.emisService.GetOoscOtherDistrict(distId).subscribe((res) => {
            if (res.dataStatus) {
                this.show = false;
                this.otherStudents = res.result;
                console.log('>>>>>>>>>>>hey', this.otherStudents);
                var student = this.otherStudents;
...
OtherDistrictSurveyPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
//# sourceMappingURL=src_app_pages_oosc_other-district-survey_other-district-survey_module_ts-es2015.js.map