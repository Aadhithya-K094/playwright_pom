...
/* harmony export */   "CaInterventionPageRoutingModule": function() { return /* binding */ CaInterventionPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _ca_intervention_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ca-intervention.page */ 45066);
...
let CaInterventionPageRoutingModule = class CaInterventionPageRoutingModule {
};
CaInterventionPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], CaInterventionPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CaInterventionPageModule": function() { return /* binding */ CaInterventionPageModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ 38583);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ 80476);
/* harmony import */ var _ca_intervention_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ca-intervention-routing.module */ 64189);
/* harmony import */ var _ca_intervention_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ca-intervention.page */ 45066);
...
let CaInterventionPageModule = class CaInterventionPageModule {
};
CaInterventionPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_5__.IonicModule,
            _ca_intervention_routing_module__WEBPACK_IMPORTED_MODULE_0__.CaInterventionPageRoutingModule
        ],
        declarations: [_ca_intervention_page__WEBPACK_IMPORTED_MODULE_1__.CaInterventionPage]
    })
], CaInterventionPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CaInterventionPage": function() { return /* binding */ CaInterventionPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_ca_intervention_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./ca-intervention.page.html */ 59588);
/* harmony import */ var _ca_intervention_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ca-intervention.page.scss */ 71987);
...
/* harmony import */ var _apollo_client_utilities__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @apollo/client/utilities */ 22560);
...
let CaInterventionPage = class CaInterventionPage {
    constructor(router, http, eRef, renderer, route, cwsnService, pdfGenerator, alertService, networkService, sqliteDB, alertController, ionicstorage, userSessionService) {
        this.router = router;
        this.http = http;
        this.eRef = eRef;
    ...
    ionViewDidEnter() {
        ...
        // this.menuValue = this.routeData.queryParams.menuValue
    ...
    getInterventionList() {
        let intervention_json = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__.environment.cwsn_intervensions_phase2;
        this.http.get(intervention_json).subscribe((data) => {
            this.InterventionList = data.cwsn_inter_phase2;
    ...
    checkAssementLocal() {
        ...
        this.sqliteDB.executeQuery(query).then(res => {
            if (res.rows.length > 0) {
                ...
                this.assessmentQstnList = temp.filter(obj => {
                    let clsSplit = obj.age_category ? obj.age_category.split(",") : [];
                    return clsSplit.includes(this.class_id);
                });
                this.interventionArray = [];
                this.assStudDetails.forEach(ele => {
                    let domainIndex = this.assessmentQstnList.find((key) => key.intervension_idx_id == ele.intervension_idx_id);
                    if (domainIndex) {
                        ...
                        this.interventionArray.push((0,_apollo_client_utilities__WEBPACK_IMPORTED_MODULE_11__.cloneDeep)(domainIndex));
                    }
                });
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.sqliteDB.executeQuery(query).then((res) => {
                ...
                if (res.rows.length > 0) {
                    ...
                    this.assStudDetails = asstemp.filter(obj => {
    ...
    makingFormArray() {
        if (this.interventionArray.length > 0) {
            this.domainArray = [...new Map(this.interventionArray.map(item => [item['domain_id'], item])).values()];
            // setTimeout(() => {
    ...
    domainFormDetails(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            let qstnIndex = this.interventionArray.filter((key) => key.domain_id == data[i].domain_id);
            // myPromise.then(
            //   function(value) {
            ...
            setTimeout(() => {
                ...
                this.optnArray = [];
                this.assessmentList[i].questionList = [];
                for (let j = 0; j < this.qstnArray[i].length; j++) {
                    ...
                    // setTimeout(() => {
                    this.assessmentList[i].questionList.push({
                    ...
                    this.assessmentList[i].questionList[j].optionList = [];
                    for (let k = 0; k < optnIndex.length; k++) {
                        ...
                        this.assessmentList[i].questionList[j].optionList.push((0,_apollo_client_utilities__WEBPACK_IMPORTED_MODULE_11__.cloneDeep)(newObj));
                        this.interventionReport.push((0,_apollo_client_utilities__WEBPACK_IMPORTED_MODULE_11__.cloneDeep)(newObj));
                    }
                }
            });
        }
    ...
    downloadAsPDF(id) {
        ...
        this.cwsnService.pdfDownloadLog(data).subscribe(res => {
            if (res.dataStatus) {
            }
        });
    }
...
CaInterventionPage.ctorParameters = () => [
...
CaInterventionPage = (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([
...
//# sourceMappingURL=src_app_pages_cwsn-phase2_ca-intervention_ca-intervention_module_ts-es2015.js.map