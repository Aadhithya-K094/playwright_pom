...
/* harmony import */ var _school_data_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./school-data.page */ 37571);
...
/* harmony import */ var _school_data_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./school-data-routing.module */ 69902);
/* harmony import */ var _school_data_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./school-data.page */ 37571);
...
SchoolDataPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            ...
            _school_data_routing_module__WEBPACK_IMPORTED_MODULE_0__.SchoolDataPageRoutingModule
        ],
...
/* harmony import */ var _raw_loader_school_data_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./school-data.page.html */ 91112);
/* harmony import */ var _school_data_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./school-data.page.scss */ 82475);
...
let SchoolDataPage = class SchoolDataPage {
    constructor(SchoolsService, router, userSessionService, route, userService, fb) {
    ...
    ngOnInit() {
        if (this.route.snapshot.queryParamMap.get("id")) {
            ...
            this.school_id = this.route.snapshot.queryParamMap.get("sclid");
            // console.log(this.school_name,this.school_type,this.udise_code)
        }
        this.userService.getUdisePdf(this.school_id).subscribe((response) => {
            //  console.log(response,"dataresponse",this.school_id)
        });
        this.getHeadings();
    }
    getHeadings() {
    ...
    getMediumInstruction(item) {
        const mediumentry = this.form.controls.schoolnew_mediumentry_details;
    ...
    getLanguageList(items) {
        const langtaught_entry = this.form.controls.schoolnew_langtaught_entry_details;
    ...
    getVocationList(data) {
        const vocation_entry = this.form.controls.voc_trade_details;
...
SchoolDataPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
