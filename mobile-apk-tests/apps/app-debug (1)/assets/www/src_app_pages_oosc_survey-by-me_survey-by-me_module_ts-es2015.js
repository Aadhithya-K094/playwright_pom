...
/* harmony export */   "SurveyByMePageRoutingModule": function() { return /* binding */ SurveyByMePageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _survey_by_me_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./survey-by-me.page */ 60551);
...
let SurveyByMePageRoutingModule = class SurveyByMePageRoutingModule {
};
SurveyByMePageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], SurveyByMePageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SurveyByMePageModule": function() { return /* binding */ SurveyByMePageModule; }
/* harmony export */ });
...
/* harmony import */ var _survey_by_me_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./survey-by-me-routing.module */ 48350);
/* harmony import */ var _survey_by_me_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./survey-by-me.page */ 60551);
...
let SurveyByMePageModule = class SurveyByMePageModule {
};
SurveyByMePageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _survey_by_me_routing_module__WEBPACK_IMPORTED_MODULE_0__.SurveyByMePageRoutingModule
        ],
        declarations: [_survey_by_me_page__WEBPACK_IMPORTED_MODULE_1__.SurveyByMePage]
    })
], SurveyByMePageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SurveyByMePage": function() { return /* binding */ SurveyByMePage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_survey_by_me_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./survey-by-me.page.html */ 94157);
/* harmony import */ var _survey_by_me_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./survey-by-me.page.scss */ 15246);
...
let SurveyByMePage = class SurveyByMePage {
    constructor(route, router, emisUser, userSessionService) {
        this.route = route;
        this.router = router;
    ...
    getOOSCstuList(event) {
        ...
        this.nonTarget = [];
        this.studList = [];
        this.emisUser.getAccListSurvey(this.teacher_id, event).subscribe(res => {
            console.log('getAccListSurvey', res);
            if (res.dataStatus == true) {
                this.studList = res.result;
                for (let i = 0; i < this.studList.length; i++) {
                    if (this.studList[i].reason_type == 'To be admitted') {
                        this.toBeAdmitted.push(this.studList[i]);
                    }
                    if (this.studList[i].reason_type == "To be verified") {
                        this.toBeVerified.push(this.studList[i]);
                    }
                    if (this.studList[i].reason_type == 'To be survey') {
                        this.toBeSurvey.push(this.studList[i]);
                    }
                    if (this.studList[i].reason_type == 'Non-Target') {
                        this.nonTarget.push(this.studList[i]);
                    }
                }
                this.studListCopy = this.studList;
    ...
    getNvrEnrollmentStuList() {
        this.emisUser.getNvrEnrolmentStudentListForBRTE(this.teacher_id).subscribe(res => {
            this.studList = res.result;
            this.studListCopy = this.studList;
            console.log('stuList', this.studList);
        });
    }
    getFilterStudlist(event) {
        console.log('test', event);
        this.searchItem = event.detail.value.trim();
        //  this.searchItem = this.searchItem;
        console.log('test1', this.searchItem, this.toBeAdmitted);
        this.toBeAdmitted.forEach((item) => {
            if (item.student_name.toLowerCase().indexOf(this.searchItem.toLowerCase()) > -1) {
            ...
            if (item.Address != null) {
                return item.student_name.toLowerCase().indexOf(this.searchItem.toLowerCase()) > -1 || item.Address.toLowerCase().indexOf(this.searchItem.toLowerCase()) > -1 || item.phone_number > -1 || item.class_studying_id.toLowerCase().indexOf(this.searchItem.toLowerCase()) > -1 || item.gender.toLowerCase().indexOf(this.searchItem.toLowerCase()) > -1;
            }
            else {
                return item.student_name.toLowerCase().indexOf(this.searchItem.toLowerCase()) > -1 || item.phone_number > -1 || item.class_studying_id.toLowerCase().indexOf(this.searchItem.toLowerCase()) > -1 || item.gender.toLowerCase().indexOf(this.searchItem.toLowerCase()) > -1;
            }
        });
    ...
    goToOoscSurvey(studentData) {
        // debugger
        this.router.navigate(['/tabs/ooscquestions'], { queryParams: { 'studentDetails': JSON.stringify(studentData), 'teacher': this.teacher_id, 'school': studentData.school_id, 'Id': this.paramsId, 'active': this.active, 'page': this.pageId, 'distId': this.distId }, skipLocationChange: false });
...
SurveyByMePage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
//# sourceMappingURL=src_app_pages_oosc_survey-by-me_survey-by-me_module_ts-es2015.js.map