  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_sids_general_commonspaces_commonspaces_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "CommonspacesPageRoutingModule": function CommonspacesPageRoutingModule() {
          return (
            /* binding */
            _CommonspacesPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _commonspaces_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./commonspaces.page */
      73173);
      ...
      var _CommonspacesPageRoutingModule = /*#__PURE__*/_createClass(function CommonspacesPageRoutingModule() {
        _classCallCheck(this, CommonspacesPageRoutingModule);
      });

      _CommonspacesPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "CommonspacesPageModule": function CommonspacesPageModule() {
          return (
            /* binding */
            _CommonspacesPageModule
          );
        }
        /* harmony export */
      ...
      var _commonspaces_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./commonspaces-routing.module */
      21428);
      /* harmony import */


      var _commonspaces_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./commonspaces.page */
      73173);

      var _CommonspacesPageModule = /*#__PURE__*/_createClass(function CommonspacesPageModule() {
        _classCallCheck(this, CommonspacesPageModule);
      });

      _CommonspacesPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _commonspaces_routing_module__WEBPACK_IMPORTED_MODULE_0__.CommonspacesPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "CommonspacesPage": function CommonspacesPage() {
          return (
            /* binding */
            _CommonspacesPage
          );
      ...
      var _raw_loader_commonspaces_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./commonspaces.page.html */
      56224);
      /* harmony import */


      var _commonspaces_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./commonspaces.page.scss */
      4567);
      /* harmony import */
      ...
      var _CommonspacesPage = /*#__PURE__*/function () {
        function CommonspacesPage(router, formBuilder, route, alertController, sqliteDB, utilityService, sidsService, userSessionService, alertService, el, ionicstorage) {
          _classCallCheck(this, CommonspacesPage);
        ...
        return _createClass(CommonspacesPage, [{
          key: "ngOnInit",
          ...
          value: function serverData() {
            ...
            var query = 'SELECT * FROM sidsCommonServer' + ' WHERE SclId = "' + this.SchlId + '"' + ' And VistId = "' + this.VistUId + '"';
          ...
          value: function safetyInitial() {
            this.safety = this.formBuilder.group({
              ...
              "CmnDustbinYN": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(false, null) // "ChulhaYn": new FormControl(false, null),
          ...
          key: "getIonStorage",
          value: function getIonStorage() {
            var _this2 = this;

            debugger;
            this.ionicstorage.getData('SecSidsSchlGenrlInfoGetRmrks').then(function (data) {
              if (data != null && data != undefined) {
                ...
                for (var i = 0; i < data.length; i++) {
                  for (var key in data[i]) {
                    ...
                    if (typeof _this2.schlDataRmks[_this2.gtKey] == 'undefined') {
                      _this2.schlDataRmks[_this2.gtKey] = {};
                    }

                    if (key == 'remarks') {
                      _this2.schlDataRmks[_this2.gtKey][key] = gtData[key];
                ...
                console.log(_this2.schlDataRmks, 'keyName');
              }
            }, function (error) {
          ...
          value: function onToggleChange(event, id) {
            ...
            // }
            if (id == 2) {// if(this.safety.value.ChulhaYn){
            ...
            if (id == 4) {
              if (this.playground.value.PlaygroYn) {
                ...
                this.playground.controls['PlaygroOutdoorGamYn'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required); // this.playground.controls['PlayKerbwall'].setValue(false);
              } else {
                this.playground.controls['PlaygroArea'].setValue('');
                this.playground.controls['PlaygroArea'].setValidators(null); // this.playground.controls['PlayKerbwall'].setValue(false);
              }

              this.playground.controls['PlaygroArea'].updateValueAndValidity();
              this.playground.controls['PlaygroOutdoorGamYn'].updateValueAndValidity(); // this.playground.controls['PlayKerbwall'].updateValueAndValidity();
            }

            if (id == 5) {// if(this.playground.value.OutsiClsYN){
          ...
          key: "onSelectChangeWater",
          value: function onSelectChangeWater(event, id) {
            if (event == "1") {
          ...
          value: function onMultiSelectChangeWater(event, id) {
            ...
            if (this.BorWelActive) {
              ...
              this.water.controls['BorWelFunc'].updateValueAndValidity(); // this.water.controls['BorwelClosed'].setValidators(Validators.required);
              ...
              this.water.controls['BorWelFunc'].updateValueAndValidity(); // this.water.controls['BorwelClosed'].setValue(false);
          ...
          key: "onMultiSelectChangeWater2",
          value: function onMultiSelectChangeWater2(event, id) {
            if (id == 1) {
              if (event != "7") {
          ...
          value: function onInputChange(event, id) {
            ...
            if (this.compoundWall.value.CmpdwallReqLen == 0 && id == 8) {
              this.compoundWall.controls['CmpdwallReqLen'].setValue('');
              this.compoundWall.controls['CmpdwallReqLen'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }
          ...
          value: function onSave(id) {
            ...
            if (this.tabsData == 1 && id == 1) {
              if (this.safety.valid) {
                ...
                var deleteQuery = 'DELETE FROM sids_safety_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
                return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
                  var datainsert = 'INSERT INTO sids_safety_data VALUES (?,?,?,?,?,?,?,?,?,?)';

                  _this3.sqliteDB.insert(datainsert, [null, _this3.SchlId, _this3.VistUId, _this3.safety.value.EBliShiYn, _this3.safety.value.RefilAreReq, _this3.safety.value.WatLoggYn, _this3.safety.value.WatLogRepair, _this3.safety.value.OpenWellYn, _this3.safety.value.CmnDustbinYN, 1]).then(function (insertres) {
                    if (insertres.insertId) {
                      _this3.tabsData = 0;
                      _this3.commonSpace = 2;
                      _this3.safetySave = true; // this.getTabs();
                    }
                  });
                });
              } else {
            ...
            if (this.tabsData == 2 && id == 2) {
              if (this.playground.valid) {
                ...
                var _deleteQuery = 'DELETE FROM sids_playground_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
                ...
                return this.sqliteDB.getDataLocalDB(_deleteQuery).then(function (data) {
                  ...
                  _this3.sqliteDB.insert(datainsert, [null, _this3.SchlId, _this3.VistUId, _this3.playground.value.PlaygroYn, _this3.playground.value.PlaygroOutdoorGamYn, _this3.playground.value.PlaygroArea, _this3.playground.value.OutsiClsNum, 1]).then(function (insertres) {
                    if (insertres.insertId) {
                      _this3.tabsData = 0;
                      _this3.playGround = 2;
                      _this3.playgroundSave = true; // this.getTabs();
                    }
                  });
                });
              } else {
            ...
            if (this.tabsData == 3 && id == 3) {
              if (this.water.valid) {
                ...
                var _deleteQuery2 = 'DELETE FROM sids_water_schooldata' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
                ...
                return this.sqliteDB.getDataLocalDB(_deleteQuery2).then(function (data) {
                  ...
                  _this3.sqliteDB.insert(datainsert, [null, _this3.SchlId, _this3.VistUId, _this3.water.value.WatAvaiSchool, _this3.water.value.ResUnAvaiWater, _this3.water.value.srcWaterAvai, _this3.water.value.srcWaterOthers, _this3.water.value.BorWelFunc, _this3.water.value.FreqWaterAvail, _this3.water.value.DWSumpYn, _this3.water.value.DWSumpFun, _this3.water.value.DWSumpAvai, _this3.water.value.DWPumpYn, _this3.water.value.DWPumpFun, _this3.water.value.DWPumpRepair, _this3.water.value.NumDWStation, _this3.water.value.WaterRoFunc, _this3.water.value.srcDrnkWaterAvai, _this3.water.value.srcDrnkWaterAvaiOthers, _this3.water.value.WaterComHandwash]).then(function (insertres) {
                    if (insertres.insertId) {
                      _this3.tabsData = 0;
                      _this3.waterData = 2;
            ...
            if (this.tabsData == 4 && id == 4) {
              if (this.compoundWall.valid) {
                ...
                var _deleteQuery3 = 'DELETE FROM sids_compoundwall_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';

                return this.sqliteDB.getDataLocalDB(_deleteQuery3).then(function (data) {
                  var datainsert = 'INSERT INTO sids_compoundwall_data VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)';

                  _this3.sqliteDB.insert(datainsert, [null, _this3.SchlId, _this3.VistUId, _this3.compoundWall.value.CmpdwallSta, _this3.compoundWall.value.CmpdwallReqLen, _this3.compoundWall.value.CmpdwallReqt, _this3.compoundWall.value.CmpdwallHTInc, _this3.compoundWall.value.AreaWW, _this3.compoundWall.value.AreaReplastering, _this3.compoundWall.value.AreaBrickwork, _this3.compoundWall.value.SchoolTotalGates, _this3.compoundWall.value.GateFunc, 1]).then(function (insertres) {
                    if (insertres.insertId) {
                      _this3.tabsData = 0;
                      _this3.compound_Wall = 2;
                      _this3.compoundSave = true; // this.getTabs();
                    }
                  });
                });
              } else {
          ...
          value: function checkSafetyLocalDb(id) {
            ...
            var deleteQuery = 'SELECT * FROM sids_safety_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                _this4.safetySave = true;
                console.log(_this4.dataList, "dataList");

                if (id == 2) {
                  _this4.commonSpace = 2;
                }

                _this4.safety.patchValue({
                  "SchlId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(_this4.SchlId, null),
                  "VistUId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(_this4.VistUId, null),
                  "EBliShiYn": _this4.dataList[0].EBliShiYn == "false" ? false : _this4.dataList[0].EBliShiYn == "true" ? true : _this4.dataList[0].EBliShiYn,
                  "RefilAreReq": _this4.dataList[0].RefilAreReq == "false" ? false : _this4.dataList[0].RefilAreReq == "true" ? true : _this4.dataList[0].RefilAreReq,
                  // "RefilSqft": this.dataList[0].RefilSqft,
                  "WatLoggYn": _this4.dataList[0].WatLoggYn == "false" ? false : _this4.dataList[0].WatLoggYn == "true" ? true : _this4.dataList[0].WatLoggYn,
                  "WatLogRepair": _this4.dataList[0].WatLogRepair,
                  // "TrePrunReq":this.dataList[0].TrePrunReq == "false" ?  false : this.dataList[0].TrePrunReq == "true" ?  true : this.dataList[0].TrePrunReq,
                  "OpenWellYn": _this4.dataList[0].OpenWellYn == "false" ? false : _this4.dataList[0].OpenWellYn == "true" ? true : _this4.dataList[0].OpenWellYn,
                  "CmnDustbinYN": _this4.dataList[0].CmnDustbinYN == "false" ? false : _this4.dataList[0].CmnDustbinYN == "true" ? true : _this4.dataList[0].CmnDustbinYN // "ChulhaYn":this.dataList[0].ChulhaYn == "false" ?  false : this.dataList[0].ChulhaYn == "true" ?  true : this.dataList[0].ChulhaYn,
                ...
                _this4.safetySave = false;

                _this4.safetyInitial();

                _this4.commonSpace = 1;
              }
            });
          }
        }, {
          ...
          value: function checkPlaygroundLocalDb(id) {
            ...
            var deleteQuery = 'SELECT * FROM sids_playground_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                _this5.playground.patchValue({
                  "SchlId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(_this5.SchlId, null),
                  "VistUId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(_this5.VistUId, null),
                  "PlaygroYn": _this5.dataList[0].PlaygroYn == "false" ? false : _this5.dataList[0].PlaygroYn == "true" ? true : _this5.dataList[0].PlaygroYn,
                  "PlaygroOutdoorGamYn": _this5.dataList[0].PlaygroOutdoorGamYn == "false" ? false : _this5.dataList[0].PlaygroOutdoorGamYn == "true" ? true : _this5.dataList[0].PlaygroOutdoorGamYn,
                  "PlaygroArea": _this5.dataList[0].PlaygroArea,
                  ...
                  "OutsiClsNum": _this5.dataList[0].OutsiClsNum
                });
              } else {
          ...
          value: function checkCompoundWallLocalDb(id) {
            ...
            var deleteQuery = 'SELECT * FROM sids_compoundwall_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                _this6.compoundSave = true;
                console.log(_this6.dataList, "dataList");

                if (id == 2) {
                  _this6.compound_Wall = 2;
                }

                _this6.compoundWall.patchValue({
                  "SchlId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(_this6.SchlId, null),
                  "VistUId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(_this6.VistUId, null),
                  "CmpdwallSta": _this6.dataList[0].CmpdwallSta,
                  "CmpdwallReqLen": _this6.dataList[0].CmpdwallReqLen,
                  "CmpdwallReqt": _this6.dataList[0].CmpdwallReqt ? Array.from(_this6.dataList[0].CmpdwallReqt.split(",")) : _this6.dataList[0].CmpdwallReqt,
                  "CmpdwallHTInc": _this6.dataList[0].CmpdwallHTInc,
                  // "CmpdwallLength": this.dataList[0].CmpdwallLength,
                  "AreaWW": _this6.dataList[0].AreaWW,
                  "AreaReplastering": _this6.dataList[0].AreaReplastering,
                  "AreaBrickwork": _this6.dataList[0].AreaBrickwork,
                  "SchoolTotalGates": _this6.dataList[0].SchoolTotalGates,
                  "GateFunc": _this6.dataList[0].GateFunc
                });
              } else {
                console.log("local data", _this6.isData);

                _this6.playgroundInitial();

                _this6.compoundSave = false;
                _this6.compound_Wall = 1;
              }
            });
          }
        }, {
          ...
          value: function checkWaterLocalDb(id) {
            ...
            var deleteQuery = 'SELECT * FROM sids_water_schooldata' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                for (var i = 0; i < data.rows.length; i++) {
                  _this7.dataList.push(data.rows.item(i));
                }

                _this7.waterSave = true;
                console.log(_this7.dataList, "dataList");

                if (id == 2) {
                  _this7.waterData = 2;
                }

                _this7.water.patchValue({
                  "SchlId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(_this7.SchlId, null),
                  "VistUId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(_this7.VistUId, null),
                  "WatAvaiSchool": _this7.dataList[0].WatAvaiSchool,
                  "ResUnAvaiWater": _this7.dataList[0].ResUnAvaiWater,
                  "srcWaterAvai": _this7.dataList[0].srcWaterAvai ? Array.from(_this7.dataList[0].srcWaterAvai.split(",")) : null,
                  "srcWaterOthers": _this7.dataList[0].srcWaterOthers,
                  "BorWelFunc": _this7.dataList[0].BorWelFunc,
                  ...
                  "FreqWaterAvail": _this7.dataList[0].FreqWaterAvail,
                  "DWSumpYn": _this7.dataList[0].DWSumpYn == "false" ? false : _this7.dataList[0].DWSumpYn == "true" ? true : _this7.dataList[0].DWSumpYn,
                  "DWSumpFun": _this7.dataList[0].DWSumpFun,
                  "DWSumpAvai": _this7.dataList[0].DWSumpAvai,
                  "DWPumpYn": _this7.dataList[0].DWPumpYn == "false" ? false : _this7.dataList[0].DWPumpYn == "true" ? true : _this7.dataList[0].DWPumpYn,
                  "DWPumpFun": _this7.dataList[0].DWPumpFun,
                  "DWPumpRepair": _this7.dataList[0].DWPumpRepair,
                  "NumDWStation": _this7.dataList[0].NumDWStation,
                  "WaterRoFunc": _this7.dataList[0].WaterRoFunc,
                  "srcDrnkWaterAvai": _this7.dataList[0].srcDrnkWaterAvai,
                  "srcDrnkWaterAvaiOthers": _this7.dataList[0].srcDrnkWaterAvaiOthers,
                  "WaterComHandwash": _this7.dataList[0].WaterComHandwash
                });

                if (_this7.water.value.srcDrnkWaterAvai) {
                  _this7.onMultiSelectChangeWater2(_this7.water.value.srcDrnkWaterAvai, 1);
                }
              } else {
                console.log("local data", _this7.isData);

                _this7.waterInitial();

                _this7.waterSave = false;
                _this7.waterData = 1;
              }
            });
          }
          ...
          value: function onSyncSave() {
            ...
            this.sidsService.SecSidsSchlGenrlInfo(data).subscribe(function (res) {
              if (res.dataStatus) {
                _this8.insertLocalDB();

                _this8.alertService.success('Saved Successfully');
              }
            });
          }
        }, {
          ...
          key: "showRemarks",
          value: function showRemarks(data) {
      ...
      _CommonspacesPage.ctorParameters = function () {
        return [{
      ...
      _CommonspacesPage = (0, tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_12__.Component)({
...
//# sourceMappingURL=src_app_pages_sids_general_commonspaces_commonspaces_module_ts-es5.js.map