...
/* harmony export */   "MySchoolsPageRoutingModule": function() { return /* binding */ MySchoolsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _my_schools_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my-schools.page */ 56);
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_art-culture_my-schools_pums-session-details_pums-session-details_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pums-session-details/pums-session-details.module */ 67149)).then(m => m.PumsSessionDetailsPageModule)
    },
    {
        path: 'otp-submission',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_art-culture_my-schools_otp-submission_otp-submission_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./otp-submission/otp-submission.module */ 93674)).then(m => m.OtpSubmissionPageModule)
    }
];
let MySchoolsPageRoutingModule = class MySchoolsPageRoutingModule {
};
MySchoolsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MySchoolsPageModule": function() { return /* binding */ MySchoolsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _my_schools_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my-schools-routing.module */ 57986);
/* harmony import */ var _my_schools_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my-schools.page */ 56);
...
let MySchoolsPageModule = class MySchoolsPageModule {
};
MySchoolsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _my_schools_routing_module__WEBPACK_IMPORTED_MODULE_0__.MySchoolsPageRoutingModule
        ],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MySchoolsPage": function() { return /* binding */ MySchoolsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_my_schools_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./my-schools.page.html */ 9920);
/* harmony import */ var _my_schools_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my-schools.page.scss */ 35741);
...
let MySchoolsPage = class MySchoolsPage {
    ...
    initialGet() {
        ...
        this.schoolListAll = [];
        this.emisService.ArpSchlListBrte(data).subscribe(res => {
            if (res.dataStatus) {
                this.schoolListAll = res.result;
            }
        });
    }
    ionViewDidEnter() {
        ...
        if (this.emis_usertype == '55') {
            ...
            this.schoolList = [];
            this.emisService.ArpSchlDetails(data).subscribe(res => {
    ...
    SchInfohide(i, data) {
        ...
        this.batchGrpList = [];
        this.emisService.ArpBtchGropBrte(this.dataSchoolId).subscribe(res => {
            if (res.dataStatus) {
                this.batchGrpList = res.result;
                this.showtable = true;
                if (this.batchGrpList) {
                    this.batchList = [];
                    for (let i = 0; i < this.batchGrpList.length; i++) {
                        if (this.batchList.indexOf(this.batchGrpList[i].batch_id) === -1) {
                            this.batchList.push(this.batchGrpList[i].batch_id);
                        }
                    }
                }
            }
    ...
    pums_session_details(val) {
        this.router.navigate(["/tabs/pums-session-details"], { queryParams: { 'schoolId': val.school_id } });
    }
    nextpage(val, data) {
        this.router.navigate(["/tabs/session-details"], { queryParams: { 'groupData': JSON.stringify(val), 'schoolData': JSON.stringify(data) } });
    }
    backBtn() {
        this.router.navigate(["/tabs/art-culture"]);
    }
};
MySchoolsPage.ctorParameters = () => [
...
MySchoolsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
...
//# sourceMappingURL=src_app_pages_art-culture_my-schools_my-schools_module_ts-es2015.js.map