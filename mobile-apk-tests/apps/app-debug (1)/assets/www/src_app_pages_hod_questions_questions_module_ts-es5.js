  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_hod_questions_questions_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "QuestionsPageRoutingModule": function QuestionsPageRoutingModule() {
          return (
            /* binding */
            _QuestionsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _QuestionsPageRoutingModule = /*#__PURE__*/_createClass(function QuestionsPageRoutingModule() {
        _classCallCheck(this, QuestionsPageRoutingModule);
      });

      _QuestionsPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _questions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./questions-routing.module */
      90055);
      /* harmony import */


      var _questions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./questions.page */
      9288);
      ...
      _QuestionsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _questions_routing_module__WEBPACK_IMPORTED_MODULE_0__.QuestionsPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_emis_aws_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/services/emis/aws.service */
      56263);

      var _QuestionsPage = /*#__PURE__*/function () {
        function QuestionsPage(router, fb, geolocation, alertService, userSessionService, utilityService, route, awsService) {
        ...
        return _createClass(QuestionsPage, [{
          ...
          value: function getSurveyQuestionsbyId() {
            ...
            this.finaldata = [];
            this.awsService.getSurveyQuestions(1006).subscribe(function (res) {
              if (res) {
                _this2.data = res;
          ...
          key: "onHODQuestions",
          value: function onHODQuestions(item) {
            ...
            if (item.length > 0) {
              for (var _i = 0; _i < item.length; _i++) {
                this.queslist.push(this.fb.group({
                  ...
                  SurId: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(item[_i].survey_id, null),
                  SurDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(this.todayDate, null),
                  QId: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(item[_i].QuestID, null),
                  ...
                  Q_Group: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(item[_i].Q_Group, null),
                  Q_GtropTxt: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(item[_i].Q_GtropTxt, null),
                  ...
                  UserTyp: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(item[_i].UserTyp, null)
                }));

                if (this.queslist.value[_i]['ResInt'] == null || this.queslist.value[_i]['ResInt'] == 1 || this.queslist.value[_i]['ResInt'] == "") {
                  this.form.controls['survey_question']['controls'][_i].controls['ResInt'].setValue('1');
                } else {
                  this.form.controls['survey_question']['controls'][_i].controls['ResInt'].setValue('2');
                }

                if (this.queslist.value[_i]['QuestTyp'] == 2 && (this.queslist.value[_i]['QId'] == 1050 || this.queslist.value[_i]['QId'] == 1040)) {
                  this.form.controls['survey_question']['controls'][_i].controls['ResInt'].setValue('0');

                  this.form.controls['survey_question']['controls'][_i].controls['ResChar'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required);
                } else {
                  this.form.controls['survey_question']['controls'][_i].controls['ResChar'].setValue('');
                ...
                if (this.cattyId == 1 || this.cattyId == 2 || this.cattyId == 3) {
                  if (this.queslist.value[_i]['QuestTyp'] == 1 && (this.queslist.value[_i]['QId'] == 1047 || this.queslist.value[_i]['QId'] == 1048)) {
                    this.form.controls['survey_question']['controls'][_i].controls['ResInt'].setValue('');

                    this.form.controls['survey_question']['controls'][_i].controls['ResChar'].setValue('');
                  }
                }

                if (this.queslist.value[_i]['QId'] == 1053 || this.queslist.value[_i]['QId'] == 1054 || this.queslist.value[_i]['QId'] == 1055 || this.queslist.value[_i]['QId'] == 1056) {
                  this.form.controls['survey_question']['controls'][_i].controls['ResInt'].setValue('0');
                }
              }
            }
          ...
          key: "onRadioChange",
          value: function onRadioChange(event, index, qid) {
          ...
          value: function onFinalSave() {
            ...
            if (this.form.valid) {
              this.utilityService.SaveHodSurvey(resdata).subscribe(function (res) {
                if (res.dataStatus) {
                  _this3.alertService.success(res.message); // this.router.navigate(['/tnvntabs/page-route/dashboardc']);


                  _this3.router.navigate(['/tabs/dashboard']);
                } else {
                  _this3.alertService.error(res.message);

                  _this3.saveActive = false;
          ...
          value: function goToBack(heading) {
            if (heading == 'Academic') {
              ...
              this.headingListIndex = this.headingList[1];
              this.saveActive = false;
            } else {// this.headingListIndex = this.headingList[0];
            }
          }
        }]);
      }();
      ...
      _QuestionsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_11__.Component)({
...
//# sourceMappingURL=src_app_pages_hod_questions_questions_module_ts-es5.js.map