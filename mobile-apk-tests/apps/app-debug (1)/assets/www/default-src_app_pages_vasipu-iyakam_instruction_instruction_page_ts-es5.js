  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["default-src_app_pages_vasipu-iyakam_instruction_instruction_page_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "InstructionPage": function InstructionPage() {
          return (
            /* binding */
            _InstructionPage
          );
      ...
      var _raw_loader_instruction_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./instruction.page.html */
      78960);
      /* harmony import */


      var _instruction_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _InstructionPage = /*#__PURE__*/function () {
        function InstructionPage(router, usersessionService, navParams, modalCtrl, sqliteDB) {
        ...
        return _createClass(InstructionPage, [{
          key: "ngOnInit",
          ...
          value: function onEdit() {
            ...
            if (this.checkBox == true) {// this.router.navigate(['/tabs/vasipu-iyakam/vi-session'], { queryParams: { "schoolId": this.schoolID , "userID":this.username} });
              // this.modalCtrl.dismiss();
            }
          }
        }, {
          key: "insertLocalData",
          value: function insertLocalData() {
            var _this = this;

            var insertRows = []; // elementData.forEach(element => {

            insertRows.push(["INSERT INTO VIInstructionData VALUES (?,?,?,?)", [null, 1, this.schoolID, this.username]]); // });
      ...
      _InstructionPage.ctorParameters = function () {
        return [{
      ...
      _InstructionPage = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
...
//# sourceMappingURL=default-src_app_pages_vasipu-iyakam_instruction_instruction_page_ts-es5.js.map