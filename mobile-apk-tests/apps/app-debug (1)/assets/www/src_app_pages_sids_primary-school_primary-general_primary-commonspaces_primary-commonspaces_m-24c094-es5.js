  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_sids_primary-school_primary-general_primary-commonspaces_primary-commonspaces_m-24c094"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimaryCommonspacesPageRoutingModule": function PrimaryCommonspacesPageRoutingModule() {
          return (
            /* binding */
            _PrimaryCommonspacesPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _primary_commonspaces_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./primary-commonspaces.page */
      17733);
      ...
      var _PrimaryCommonspacesPageRoutingModule = /*#__PURE__*/_createClass(function PrimaryCommonspacesPageRoutingModule() {
        _classCallCheck(this, PrimaryCommonspacesPageRoutingModule);
      });

      _PrimaryCommonspacesPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimaryCommonspacesPageModule": function PrimaryCommonspacesPageModule() {
          return (
            /* binding */
            _PrimaryCommonspacesPageModule
          );
        }
        /* harmony export */
      ...
      var _primary_commonspaces_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./primary-commonspaces-routing.module */
      20604);
      /* harmony import */


      var _primary_commonspaces_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./primary-commonspaces.page */
      17733);

      var _PrimaryCommonspacesPageModule = /*#__PURE__*/_createClass(function PrimaryCommonspacesPageModule() {
        _classCallCheck(this, PrimaryCommonspacesPageModule);
      });

      _PrimaryCommonspacesPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _primary_commonspaces_routing_module__WEBPACK_IMPORTED_MODULE_0__.PrimaryCommonspacesPageRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PrimaryCommonspacesPage": function PrimaryCommonspacesPage() {
          return (
            /* binding */
            _PrimaryCommonspacesPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_primary_commonspaces_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./primary-commonspaces.page.html */
      61741);
      /* harmony import */


      var _primary_commonspaces_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./primary-commonspaces.page.scss */
      62726);
      /* harmony import */
      ...
      var src_app_services_network_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _PrimaryCommonspacesPage = /*#__PURE__*/function () {
        function PrimaryCommonspacesPage(router, formBuilder, route, networkService, alertController, sqliteDB, utilityService, userSessionService, alertService, el) {
          _classCallCheck(this, PrimaryCommonspacesPage);
        ...
        return _createClass(PrimaryCommonspacesPage, [{
          key: "ngOnInit",
          ...
          value: function serverData() {
            ...
            var query = 'SELECT * FROM sidsPrimaryCommonServer' + ' WHERE SclId = "' + this.SchlId + '"' + ' And VistId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(query).then(function (data) {
              if (data.rows.length > 0) {
                ...
                if (dataListData[0].Status == 3) {
                  ...
                  _this.playGround = 3;
                  _this.waterData = 3;
                  _this.compound_Wall = 3;

                  _this.checkSafetyLocalDb(1);

                  _this.checkPlaygroundLocalDb(1);

                  _this.checkCompoundWallLocalDb(1);

                  _this.checkWaterLocalDb(1);
                } else {
                  _this.serverDatas = false;
                  console.log('Local Status');

                  _this.checkSafetyLocalDb(2);

                  _this.checkPlaygroundLocalDb(2);

                  _this.checkCompoundWallLocalDb(2);

                  _this.checkWaterLocalDb(2);
                }
              } else {
                _this.serverDatas = false;
                console.log('Local');
          ...
          key: "playgroundInitial",
          value: function playgroundInitial() {
          ...
          key: "compoundWallInitial",
          value: function compoundWallInitial() {
          ...
          value: function onSelectChange(event, id) {
            if (id == 1) {
              ...
              if (this.compoundWall.value.CmpdwallSta == 2 || this.compoundWall.value.CmpdwallSta == 5) {
                ...
                this.compoundWall.controls['AreaBrickwork'].setValidators(null); // this.compoundWall.controls['CmpdwallLength'].setValue("");
              ...
              this.compoundWall.controls['AreaWW'].updateValueAndValidity(); // this.compoundWall.controls['CmpdwallLength'].updateValueAndValidity();
          ...
          key: "onMultiSelectChangeWater",
          value: function onMultiSelectChangeWater(event) {
          ...
          value: function onInputChange(event, id) {
            if (this.safety.value.RefilSqft == 0 && id == 1) {
              this.safety.controls['RefilSqft'].setValue('');
              this.safety.controls['RefilSqft'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.safety.value.ChulhaFunc == 0 && id == 2) {
              this.safety.controls['ChulhaFunc'].setValue('');
              this.safety.controls['ChulhaFunc'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.safety.value.ChulhaRepair == 0 && id == 3) {
              this.safety.controls['ChulhaRepair'].setValue('');
              this.safety.controls['ChulhaRepair'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.safety.value.SepticTankFun == 0 && id == 4) {
              this.safety.controls['SepticTankFun'].setValue('');
              this.safety.controls['SepticTankFun'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.safety.value.SepticTankRepaired == 0 && id == 5) {
              this.safety.controls['SepticTankRepaired'].setValue('');
              this.safety.controls['SepticTankRepaired'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.playground.value.PlaygroArea == 0 && id == 6) {
              this.playground.controls['PlaygroArea'].setValue('');
              this.playground.controls['PlaygroArea'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            ...
            if (this.compoundWall.value.CmpdwallReq == 0 && id == 8) {
              this.compoundWall.controls['CmpdwallReq'].setValue('');
              this.compoundWall.controls['CmpdwallReq'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.compoundWall.value.CmpdwallHTInc == 0 && id == 9) {
              this.compoundWall.controls['CmpdwallHTInc'].setValue('');
              this.compoundWall.controls['CmpdwallHTInc'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.compoundWall.value.AreaWW == 0 && id == 10) {
              this.compoundWall.controls['AreaWW'].setValue('');
              this.compoundWall.controls['AreaWW'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.compoundWall.value.AreaReplastering == 0 && id == 11) {
              this.compoundWall.controls['AreaReplastering'].setValue('');
              this.compoundWall.controls['AreaReplastering'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            }

            if (this.compoundWall.value.AreaBrickwork == 0 && id == 12) {
              this.compoundWall.controls['AreaBrickwork'].setValue('');
              this.compoundWall.controls['AreaBrickwork'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
            ...
            if (this.compoundWall.value.OutsiClsNum == 0 && id == 14) {
              ...
              this.compoundWall.controls['OutsiClsNum'].updateValueAndValidity(); // this.alertService.error('Please Enter Valid Data');
          ...
          value: function onSave(id) {
            ...
            if (this.tabsData == 1 && id == 1) {
              if (this.safety.valid) {
                ...
                var deleteQuery = 'DELETE FROM sids_primary_safety_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
                return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
                  var datainsert = 'INSERT INTO sids_primary_safety_data VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';

                  _this2.sqliteDB.insert(datainsert, [null, _this2.SchlId, _this2.VistUId, _this2.safety.value.IndexId, _this2.safety.value.EBliShiYn, _this2.safety.value.RefilAreReq, _this2.safety.value.RefilSqft, _this2.safety.value.WatLoggYn, _this2.safety.value.WatLogRepair, _this2.safety.value.TrePrunReq, _this2.safety.value.OpenWellYn, _this2.safety.value.CmnDustbinYN, _this2.safety.value.ChulhaYn, _this2.safety.value.ChulhaFunc, _this2.safety.value.ChulhaRepair, _this2.safety.value.SChSepticTank, _this2.safety.value.SepticTankFun, _this2.safety.value.SepticTankRepaired, 1]).then(function (insertres) {
                    if (insertres.insertId) {
                      _this2.tabsData = 0;
                      _this2.commonSpace = 2;

                      if (_this2.playGround == 3) {
                        _this2.playGround = 2;
                      }

                      if (_this2.waterData == 3) {
                        _this2.waterData = 2;
                      }

                      if (_this2.compound_Wall == 3) {
                        _this2.compound_Wall = 2;
                      }

                      _this2.safetySave = true; // this.getTabs();

                      _this2.deleteCommonSpace();
                    }
                  });
                });
              } else {
            ...
            if (this.tabsData == 2 && id == 2) {
              if (this.playground.valid) {
                ...
                var _deleteQuery = 'DELETE FROM sids_primary_playground_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';

                return this.sqliteDB.getDataLocalDB(_deleteQuery).then(function (data) {
                  var datainsert = 'INSERT INTO sids_primary_playground_data VALUES (?,?,?,?,?,?,?,?,?,?)';

                  _this2.sqliteDB.insert(datainsert, [null, _this2.SchlId, _this2.VistUId, _this2.playground.value.IndexId, _this2.playground.value.PlaygroYn, _this2.playground.value.PlaygroArea, _this2.playground.value.PlayKerbwall, _this2.playground.value.OutsiClsYN, _this2.playground.value.OutsiClsNum, 1]).then(function (insertres) {
                    if (insertres.insertId) {
                      _this2.tabsData = 0;
                      _this2.playGround = 2;
                      _this2.playgroundSave = true;

                      if (_this2.commonSpace == 3) {
                        _this2.commonSpace = 2;
                      }
            ...
            if (this.tabsData == 3 && id == 3) {
              if (this.water.valid) {
                ...
                var _deleteQuery2 = 'DELETE FROM sids_primary_water_schooldata' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';

                return this.sqliteDB.getDataLocalDB(_deleteQuery2).then(function (data) {
                  var datainsert = 'INSERT INTO sids_primary_water_schooldata VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';

                  _this2.sqliteDB.insert(datainsert, [null, _this2.SchlId, _this2.VistUId, _this2.water.value.IndexId, _this2.water.value.WatAvaiSchool, _this2.water.value.ResUnAvaiWater, _this2.water.value.srcWaterAvai, _this2.water.value.BorWelFunc, _this2.water.value.BorwelClosed, _this2.water.value.BorWelReqReapir, _this2.water.value.DWWatAvai, _this2.water.value.DWSumpYn, _this2.water.value.DWSumpFun, _this2.water.value.DWSumpAvai, _this2.water.value.DWPumpYn, _this2.water.value.DWPumpFun, _this2.water.value.DWPumpRepair, _this2.water.value.NumDWStation]).then(function (insertres) {
                    if (insertres.insertId) {
                      _this2.tabsData = 0;
                      _this2.waterData = 2;
                      _this2.waterSave = true;
            ...
            if (this.tabsData == 4 && id == 4) {
              if (this.compoundWall.valid) {
                this.commonSubmitted = false; // this.submitted = false;

                this.alertService.success('Saved Successfully');

                var _deleteQuery3 = 'DELETE FROM sids_primary_compoundwall_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';

                return this.sqliteDB.getDataLocalDB(_deleteQuery3).then(function (data) {
                  var datainsert = 'INSERT INTO sids_primary_compoundwall_data VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';

                  _this2.sqliteDB.insert(datainsert, [null, _this2.SchlId, _this2.VistUId, _this2.compoundWall.value.IndexId, _this2.compoundWall.value.CmpdwallSta, _this2.compoundWall.value.CmpdwallReq, _this2.compoundWall.value.CmpdwallReqt, _this2.compoundWall.value.CmpdwallHTInc, _this2.compoundWall.value.AreaWW, _this2.compoundWall.value.AreaReplastering, _this2.compoundWall.value.AreaBrickwork, _this2.compoundWall.value.GateYn, _this2.compoundWall.value.GateFunc, 1]).then(function (insertres) {
                    if (insertres.insertId) {
                      _this2.tabsData = 0;
                      _this2.compound_Wall = 2;
                      _this2.compoundSave = true;
                ...
                this.alertService.error('Please Enter Valid Data'); // this.submitted = true;
          ...
          key: "checkSafetyLocalDb",
          value: function checkSafetyLocalDb(id) {
            var _this3 = this;

            var deleteQuery = 'SELECT * FROM sids_primary_safety_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                if (id == 2) {
                  _this3.commonSpace = 2;
                }

                _this3.safety.patchValue({
                  "IndexId": _this3.dataList[0].IndexId,
                  "SchlId": new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_this3.SchlId, null),
                  "VistUId": new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_this3.VistUId, null),
                  "EBliShiYn": _this3.dataList[0].EBliShiYn == "false" ? false : _this3.dataList[0].EBliShiYn == "true" ? true : _this3.dataList[0].EBliShiYn,
                  "RefilAreReq": _this3.dataList[0].RefilAreReq == "false" ? false : _this3.dataList[0].RefilAreReq == "true" ? true : _this3.dataList[0].RefilAreReq,
                  "RefilSqft": _this3.dataList[0].RefilSqft,
                  "WatLoggYn": _this3.dataList[0].WatLoggYn == "false" ? false : _this3.dataList[0].WatLoggYn == "true" ? true : _this3.dataList[0].WatLoggYn,
                  "WatLogRepair": _this3.dataList[0].WatLogRepair,
                  "TrePrunReq": _this3.dataList[0].TrePrunReq == "false" ? false : _this3.dataList[0].TrePrunReq == "true" ? true : _this3.dataList[0].TrePrunReq,
                  "OpenWellYn": _this3.dataList[0].OpenWellYn == "false" ? false : _this3.dataList[0].OpenWellYn == "true" ? true : _this3.dataList[0].OpenWellYn,
                  "CmnDustbinYN": _this3.dataList[0].CmnDustbinYN == "false" ? false : _this3.dataList[0].CmnDustbinYN == "true" ? true : _this3.dataList[0].CmnDustbinYN,
                  "ChulhaYn": _this3.dataList[0].ChulhaYn == "false" ? false : _this3.dataList[0].ChulhaYn == "true" ? true : _this3.dataList[0].ChulhaYn,
                  "ChulhaFunc": _this3.dataList[0].ChulhaFunc,
                  "ChulhaRepair": _this3.dataList[0].ChulhaRepair,
                  "SChSepticTank": _this3.dataList[0].SChSepticTank == "false" ? false : _this3.dataList[0].SChSepticTank == "true" ? true : _this3.dataList[0].SChSepticTank,
                  "SepticTankFun": _this3.dataList[0].SepticTankFun,
                  "SepticTankRepaired": _this3.dataList[0].SepticTankRepaired
                });
              } else {
                console.log("local data", _this3.isData);
                _this3.safetySave = false;

                _this3.safetyInitial();
              }
            });
          }
        }, {
          key: "checkPlaygroundLocalDb",
          value: function checkPlaygroundLocalDb(id) {
            var _this4 = this;

            var deleteQuery = 'SELECT * FROM sids_primary_playground_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                _this4.playgroundSave = true;
                console.log(_this4.dataList, "dataList");

                if (id == 2) {
                  _this4.playGround = 2;
                }

                _this4.playground.patchValue({
                  "IndexId": _this4.dataList[0].IndexId,
                  "SchlId": new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_this4.SchlId, null),
                  "VistUId": new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_this4.VistUId, null),
                  "PlaygroYn": _this4.dataList[0].PlaygroYn == "false" ? false : _this4.dataList[0].PlaygroYn == "true" ? true : _this4.dataList[0].PlaygroYn,
                  "PlaygroArea": _this4.dataList[0].PlaygroArea,
                  "PlayKerbwall": _this4.dataList[0].PlayKerbwall == "false" ? false : _this4.dataList[0].PlayKerbwall == "true" ? true : _this4.dataList[0].PlayKerbwall,
                  "OutsiClsYN": _this4.dataList[0].OutsiClsYN == "false" ? false : _this4.dataList[0].OutsiClsYN == "true" ? true : _this4.dataList[0].OutsiClsYN,
                  "OutsiClsNum": _this4.dataList[0].OutsiClsNum
                });
              } else {
                console.log("local data", _this4.isData);

                _this4.playgroundInitial();

                _this4.playgroundSave = false;
              }
            });
          }
        }, {
          key: "checkCompoundWallLocalDb",
          value: function checkCompoundWallLocalDb(id) {
            var _this5 = this;

            var deleteQuery = 'SELECT * FROM sids_primary_compoundwall_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                _this5.compoundSave = true;
                console.log(_this5.dataList, "dataList");

                if (id == 2) {
                  _this5.compound_Wall = 2;
                }

                _this5.compoundWall.patchValue({
                  "IndexId": _this5.dataList[0].IndexId,
                  "SchlId": new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_this5.SchlId, null),
                  "VistUId": new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_this5.VistUId, null),
                  "CmpdwallSta": _this5.dataList[0].CmpdwallSta,
                  "CmpdwallReq": _this5.dataList[0].CmpdwallReq,
                  "CmpdwallReqt": _this5.dataList[0].CmpdwallReqt ? Array.from(_this5.dataList[0].CmpdwallReqt.split(",")) : _this5.dataList[0].CmpdwallReqt,
                  "CmpdwallHTInc": _this5.dataList[0].CmpdwallHTInc,
                  // "CmpdwallLength": this.dataList[0].CmpdwallLength,
                  "AreaWW": _this5.dataList[0].AreaWW,
                  "AreaReplastering": _this5.dataList[0].AreaReplastering,
                  "AreaBrickwork": _this5.dataList[0].AreaBrickwork,
                  "GateYn": _this5.dataList[0].GateYn == "false" ? false : _this5.dataList[0].GateYn == "true" ? true : _this5.dataList[0].GateYn,
                  "GateFunc": _this5.dataList[0].GateFunc
                });
              } else {
                console.log("local data", _this5.isData);

                _this5.playgroundInitial();

                _this5.compoundSave = false;
              }
            });
          }
        }, {
          key: "checkWaterLocalDb",
          value: function checkWaterLocalDb(id) {
            var _this6 = this;

            var deleteQuery = 'SELECT * FROM sids_primary_water_schooldata' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            return this.sqliteDB.getDataLocalDB(deleteQuery).then(function (data) {
              console.log(data);
              ...
              if (data.rows.length > 0) {
                ...
                for (var i = 0; i < data.rows.length; i++) {
                  _this6.dataList.push(data.rows.item(i));
                }

                _this6.waterSave = true;
                console.log(_this6.dataList, "dataList");

                if (id == 2) {
                  _this6.waterData = 2;
                }

                _this6.water.patchValue({
                  "IndexId": _this6.dataList[0].IndexId,
                  "SchlId": new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_this6.SchlId, null),
                  "VistUId": new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(_this6.VistUId, null),
                  "WatAvaiSchool": _this6.dataList[0].WatAvaiSchool,
                  "ResUnAvaiWater": _this6.dataList[0].ResUnAvaiWater,
                  "srcWaterAvai": _this6.dataList[0].srcWaterAvai ? Array.from(_this6.dataList[0].srcWaterAvai.split(",")) : '',
                  "BorWelFunc": _this6.dataList[0].BorWelFunc,
                  "BorwelClosed": _this6.dataList[0].BorwelClosed,
                  "BorWelReqReapir": _this6.dataList[0].BorWelReqReapir,
                  "DWWatAvai": _this6.dataList[0].DWWatAvai,
                  "DWSumpYn": _this6.dataList[0].DWSumpYn == "false" ? false : _this6.dataList[0].DWSumpYn == "true" ? true : _this6.dataList[0].DWSumpYn,
                  "DWSumpFun": _this6.dataList[0].DWSumpFun,
                  "DWSumpAvai": _this6.dataList[0].DWSumpAvai,
                  "DWPumpYn": _this6.dataList[0].DWPumpYn == "false" ? false : _this6.dataList[0].DWPumpYn == "true" ? true : _this6.dataList[0].DWPumpYn,
                  "DWPumpFun": _this6.dataList[0].DWPumpFun,
                  "DWPumpRepair": _this6.dataList[0].DWPumpRepair,
                  "NumDWStation": _this6.dataList[0].NumDWStation
                });
              } else {
                console.log("local data", _this6.isData);

                _this6.waterInitial();

                _this6.waterSave = false;
              }
            });
          }
        }, {
          key: "getOnMultiSelectChange",
          value: function getOnMultiSelectChange(event) {
          ...
          value: function ionViewWillLeave() {// this.form.reset();
          }
        }, {
          key: "onSyncSave",
          value: function onSyncSave() {
            ...
            if (this.safety.valid && this.playground.valid && this.water.valid && this.compoundWall.valid) {
              if (this.networkService.getCurrentNetworkStatus() == 0) {
                ...
                this.utilityService.saveCommonSids(data).subscribe(function (res) {
                  if (res.dataStatus) {
                    _this7.safety.controls['IndexId'].setValue(res.IndexId);

                    _this7.safety.controls['IndexId'].updateValueAndValidity();

                    _this7.playground.controls['IndexId'].setValue(res.IndexId);

                    _this7.playground.controls['IndexId'].updateValueAndValidity();

                    _this7.water.controls['IndexId'].setValue(res.IndexId);

                    _this7.water.controls['IndexId'].updateValueAndValidity();

                    _this7.compoundWall.controls['IndexId'].setValue(res.IndexId);

                    _this7.compoundWall.controls['IndexId'].updateValueAndValidity();

                    _this7.updateAllQuery(3);

                    _this7.insertLocalDB();

                    _this7.alertService.success('Saved Successfully');
                  }
                });
              } else {
          ...
          value: function insertLocalDB() {
            ...
            var deleteQuery = 'DELETE FROM sidsPrimaryCommonServer' + ' WHERE SclId = "' + this.SchlId + '"' + ' And VistId = "' + this.VistUId + '"';
            this.sqliteDB.getDataLocalDB(deleteQuery).then(function (res) {
              var datainsert = "INSERT INTO sidsPrimaryCommonServer VALUES (?,?,?,?)";

              _this8.sqliteDB.insert(datainsert, [null, _this8.SchlId, _this8.VistUId, "3"]).then(function (insertres) {
          ...
          key: "updateAllQuery",
          value: function updateAllQuery(id) {
            var _this9 = this;

            var query1 = 'DELETE FROM sids_primary_safety_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            var query2 = 'DELETE FROM sids_primary_playground_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            var query3 = 'DELETE FROM sids_primary_water_schooldata' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            var query4 = 'DELETE FROM sids_primary_compoundwall_data' + ' WHERE SchlId = "' + this.SchlId + '"' + ' And VistUId = "' + this.VistUId + '"';
            this.sqliteDB.getDataLocalDB(query1).then(function (data) {
              var datainsert = 'INSERT INTO sids_primary_safety_data VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';

              _this9.sqliteDB.insert(datainsert, [null, _this9.SchlId, _this9.VistUId, _this9.safety.value.IndexId, _this9.safety.value.EBliShiYn, _this9.safety.value.RefilAreReq, _this9.safety.value.RefilSqft, _this9.safety.value.WatLoggYn, _this9.safety.value.WatLogRepair, _this9.safety.value.TrePrunReq, _this9.safety.value.OpenWellYn, _this9.safety.value.CmnDustbinYN, _this9.safety.value.ChulhaYn, _this9.safety.value.ChulhaFunc, _this9.safety.value.ChulhaRepair, _this9.safety.value.SChSepticTank, _this9.safety.value.SepticTankFun, _this9.safety.value.SepticTankRepaired, 1]).then(function (insertres) {
                if (insertres.insertId) {
                  _this9.tabsData = 0;
                  _this9.commonSpace = id;
                  _this9.safetySave = true; // this.getTabs();
                }
              });
            });
            this.sqliteDB.getDataLocalDB(query2).then(function (data) {
              var datainsert = 'INSERT INTO sids_primary_playground_data VALUES (?,?,?,?,?,?,?,?,?,?)';

              _this9.sqliteDB.insert(datainsert, [null, _this9.SchlId, _this9.VistUId, _this9.playground.value.IndexId, _this9.playground.value.PlaygroYn, _this9.playground.value.PlaygroArea, _this9.playground.value.PlayKerbwall, _this9.playground.value.OutsiClsYN, _this9.playground.value.OutsiClsNum, 1]).then(function (insertres) {
                if (insertres.insertId) {
                  _this9.tabsData = 0;
                  _this9.playGround = id;
                  _this9.playgroundSave = true; // this.getTabs();
                }
              });
            });
            this.sqliteDB.getDataLocalDB(query3).then(function (data) {
              var datainsert = 'INSERT INTO sids_primary_water_schooldata VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';

              _this9.sqliteDB.insert(datainsert, [null, _this9.SchlId, _this9.VistUId, _this9.water.value.IndexId, _this9.water.value.WatAvaiSchool, _this9.water.value.ResUnAvaiWater, _this9.water.value.srcWaterAvai, _this9.water.value.BorWelFunc, _this9.water.value.BorwelClosed, _this9.water.value.BorWelReqReapir, _this9.water.value.DWWatAvai, _this9.water.value.DWSumpYn, _this9.water.value.DWSumpFun, _this9.water.value.DWSumpAvai, _this9.water.value.DWPumpYn, _this9.water.value.DWPumpFun, _this9.water.value.DWPumpRepair, _this9.water.value.NumDWStation]).then(function (insertres) {
                if (insertres.insertId) {
                  _this9.tabsData = 0;
                  _this9.waterData = id;
                  _this9.waterSave = true;
                }
              });
            });
            this.sqliteDB.getDataLocalDB(query4).then(function (data) {
              var datainsert = 'INSERT INTO sids_primary_compoundwall_data VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';

              _this9.sqliteDB.insert(datainsert, [null, _this9.SchlId, _this9.VistUId, _this9.compoundWall.value.IndexId, _this9.compoundWall.value.CmpdwallSta, _this9.compoundWall.value.CmpdwallReq, _this9.compoundWall.value.CmpdwallReqt, _this9.compoundWall.value.CmpdwallHTInc, _this9.compoundWall.value.AreaWW, _this9.compoundWall.value.AreaReplastering, _this9.compoundWall.value.AreaBrickwork, _this9.compoundWall.value.GateYn, _this9.compoundWall.value.GateFunc, 1]).then(function (insertres) {
                if (insertres.insertId) {
                  _this9.tabsData = 0;
                  _this9.compound_Wall = id;
                  _this9.compoundSave = true; // this.getTabs();
                }
              });
            });
          }
        }, {
          key: "deleteCommonSpace",
          value: function deleteCommonSpace() {
            var deleteQuery = 'UPDATE sidsPrimaryCommonServer SET Status = 2' + ' WHERE SclId = "' + this.SchlId + '"' + ' And VistId = "' + this.VistUId + '"';
            this.sqliteDB.getDataLocalDB(deleteQuery).then(function (res) {
      ...
      _PrimaryCommonspacesPage.ctorParameters = function () {
        return [{
      ...
      _PrimaryCommonspacesPage = (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
...
//# sourceMappingURL=src_app_pages_sids_primary-school_primary-general_primary-commonspaces_primary-commonspaces_m-24c094-es5.js.map