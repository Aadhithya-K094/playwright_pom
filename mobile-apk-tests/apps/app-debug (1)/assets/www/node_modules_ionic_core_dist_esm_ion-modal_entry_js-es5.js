(function () {
  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["node_modules_ionic_core_dist_esm_ion-modal_entry_js"], {
    /***/
    71855:
    /*!**************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var createSwipeToCloseGesture = function createSwipeToCloseGesture(el, animation, onDismiss) {
        ...
        var onMove = function onMove(detail) {
          var step = (0, _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_9__.k)(0.0001, detail.deltaY / height, 0.9999);
      ...
      var iosEnterAnimation = function iosEnterAnimation(baseEl, presentingEl) {
        var backdropAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
          'pointer-events': 'none'
        }).afterClearStyles(['pointer-events']);
        var wrapperAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
        var baseAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().beforeStyles({
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().afterStyles({
                'transform': _finalTransform
      ...
      var iosLeaveAnimation = function iosLeaveAnimation(baseEl, presentingEl) {
        ...
        var backdropAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0.0);
        var wrapperAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
        var baseAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(presentingEl.querySelector('.modal-shadow')).afterStyles({
                'transform': 'translateY(0) scale(1)'
              }).keyframes([{
                offset: 0,
                opacity: '0',
      ...
      var mdEnterAnimation = function mdEnterAnimation(baseEl) {
        var baseAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)();
        var backdropAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)();
        var wrapperAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)();
        ...
        return _createClass(Modal, [{
              ...
              return _regenerator().w(function (_context) {
                while (1) switch (_context.n) {
                  ...
                  case 2:
                    ...
                    _context.n = 3;
                    return (0, _framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.delegate, container, this.component, ['ion-page'], componentProps);

                  case 3:
                    this.usersElement = _context.v;
                    _context.n = 4;
                    return (0, _index_a7711c1e_js__WEBPACK_IMPORTED_MODULE_5__.e)(this.usersElement);
                  ...
                  case 4:
                    ...
                    _context.n = 5;
                    return (0, _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.d)(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
          ...
          value: function initSwipeToClose() {
            ...
            this.gesture = createSwipeToCloseGesture(this.el, ani, function () {
              ...
              _this3.animation.onFinish( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regenerator().m(function _callee2() {
          ...
          key: "dismiss",
          value: function () {
            var _dismiss = _asyncToGenerator( /*#__PURE__*/_regenerator().m(function _callee3(data, role) {
              ...
              return _regenerator().w(function (_context3) {
                while (1) switch (_context3.n) {
                  ...
                  case 1:
                    ...
                    _context3.n = 2;
                    return (0, _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);

                  case 2:
                    dismissed = _context3.v;
                    ...
                    _context3.n = 3;
                    return (0, _framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_2__.d)(this.delegate, this.usersElement);
                  ...
                  case 4:
                    ...
                    return _context3.a(2, dismissed);
                }
              }, _callee3, this);
            }));
          ...
          value: function render() {
            ...
            return (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({
              ...
              "class": Object.assign(_defineProperty(_defineProperty({}, mode, true), "modal-card", this.presentingElement !== undefined && mode === 'ios'), (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.cssClass)),
