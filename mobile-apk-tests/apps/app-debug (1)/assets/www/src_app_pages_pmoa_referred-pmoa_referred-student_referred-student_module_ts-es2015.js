...
/* harmony export */   "ReferredStudentPageRoutingModule": function() { return /* binding */ ReferredStudentPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _referred_student_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./referred-student.page */ 9983);
...
let ReferredStudentPageRoutingModule = class ReferredStudentPageRoutingModule {
};
ReferredStudentPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], ReferredStudentPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ReferredStudentPageModule": function() { return /* binding */ ReferredStudentPageModule; }
/* harmony export */ });
...
/* harmony import */ var _referred_student_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./referred-student-routing.module */ 87569);
/* harmony import */ var _referred_student_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./referred-student.page */ 9983);
...
let ReferredStudentPageModule = class ReferredStudentPageModule {
};
ReferredStudentPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_6__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.IonicModule,
            _referred_student_routing_module__WEBPACK_IMPORTED_MODULE_0__.ReferredStudentPageRoutingModule
        ],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ReferredStudentPage": function() { return /* binding */ ReferredStudentPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_referred_student_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./referred-student.page.html */ 83749);
/* harmony import */ var _referred_student_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./referred-student.page.scss */ 60895);
...
/* harmony import */ var xlsx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! xlsx */ 46351);
/* harmony import */ var _ionic_native_pdf_generator_ngx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic-native/pdf-generator/ngx */ 37961);
...
let ReferredStudentPage = class ReferredStudentPage {
    // finaldata: {
    //   // IndxId: string; SchoolId: any;
    //   // "StdntId": StdntId,
    //   Referral: any; Remarks: any; Date: any;
    // };
    constructor(platform, alertController, router, pdfGenerator, usersessionService, userService, alert, alertService) {
        ...
        this.pmoaHealthStatus = [
            { value: "1", label: "Spectacle Needed" },
            { value: "2", label: "Visit to DEIC" },
            { value: "3", label: "Spectacle Needed and Visit To DEIC" },
            { value: "4", label: "Normal" },
        ];
        this.spectacalStatus = [
            { value: "1", label: "Not received" },
            { value: "2", label: "Verified and received by student" },
            { value: "3", label: "Defective and returned" },
            { value: "4", label: "Correction verified and received" },
        ];
        //   if (this.div == 2){
        //   console.log('if');
        //     this.hideDiv = true;
        ...
        this.platform.ready().then(() => {
            // Your code here, including the use of PdfGenerator
        });
    }
    ngOnInit() {
    }
    showbutton(schId, stdID) {
        this.indx = null;
        this.remarks = null;
        this.disease = null;
        this.date = null;
    ...
    ionViewWillEnter() {
        ...
        // this.SchoolId = this.usersessionService.rsa_school_id();
        // console.log( this.SchoolId," this.SchoolId")
        this.getReferredChildSchList();
        this.hiddenRecords = null;
        this.newDate = moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date()).format('DD-MM-YYYY');
        // this.exportToExcel("printPageButton")
    }
    getReferredChildSchList() {
        this.div = 1;
        this.userService.PmoaReferredSchs(this.UserName).subscribe((res) => {
            if (res.dataStatus) {
                this.schList = res.result;
                this.schListSearch = this.schList;
            }
            else {
    ...
    getfollowup() {
        // this.studentid = item.
        this.getdatafollow = [];
        this.userService.getfollowupdata(this.stdent_id).subscribe((res) => {
            if (res.dataStatus) {
                this.getdatafollow = res.result;
                // this.getdatafollow.Referral ? "1" : "PHC"
            }
        });
    }
    editoption(i, data) {
    ...
    schBtn(item) {
        ...
        this.hideDiv = false;
        this.schId = item.SchlId;
        // this.studentid = item.StdntId
        this.userService.PmoaReferredStudentList(this.schId, this.UserName).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            if (res.dataStatus) {
                this.studList = res.result;
                this.studList2 = res.result;
                // this.studentid = this.studList.StdntId
                ...
                for (var i = 0; i < this.studList.length; i++) {
                    ...
                    let healthsts = this.pmoaHealthStatus.find(j => j.value === this.studList[i].health_status);
                    if (this.studList[i].health_status === healthsts.value) {
                        Object.assign(this.studList[i], { pmoalabel: healthsts.label });
                    }
    ...
    onSumbit() {
        ...
        if (this.remarks != null && this.remarks.trim() !== "" && this.disease !== null && this.disease.trim() !== "" && this.date !== null && this.date.trim() !== "") {
            const formattedDate = moment__WEBPACK_IMPORTED_MODULE_5___default()(this.date).format('YYYY-MM-DD');
            // for(let i=0 ; i<this.getdatafollow.length; i++){
            ...
            this.userService.pmoafollowup(this.finaldata).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (res.dataStatus == true) {
                    this.alertService.alert(res.message);
                    //  this.getfollowup(this.studId);
                    this.getfollowup();
                    this.conformCard = false;
                    this.submitted = false;
                }
    ...
    getFilterItems(event) {
        ...
        var data = this.schListSearch.filter((item) => {
    ...
    detailsget(item, stdId) {
        ...
        this.getfollowup();
        // this.getfollowup(this.stdent_id);
    }
    onGoButton2() {
        this.hideDiv = true;
        this.hiddenRecords = null;
                ...
                buttons: [
                    {
                        ...
                        handler: (item) => {
                            ...
                            this.value = item;
                            let label = this.pmoaHealthStatus.find(j => j.value === this.value);
                            this.labelSelct = label.label;
                            console.log('labelSelct', this.labelSelct);
                            var sortStudentList = this.studList2.filter(tt => tt.health_status == this.value);
                            if (sortStudentList.length > 0) {
                                this.studList = sortStudentList;
                            }
                            else {
                                this.studList = sortStudentList;
                                this.alert.error("No Data Found");
    ...
    exportToExcel11() {
        const header = ['Date', 'Remarks', 'Referral']; // Add more headers if needed
        const data = this.getdatafollow.map(item => [
            item.Date,
            item.Remarks,
            item.Referral
        ]);
        const ws = xlsx__WEBPACK_IMPORTED_MODULE_8__.utils.aoa_to_sheet([header, ...data]);
    ...
    exportTopdf() {
        ...
        setTimeout((item) => {
            ...
            this.pdfGenerator.fromData(content, options)
                ...
                this.router.navigate(["/tabs/referred-student"]);
            }).catch((error) => {
...
ReferredStudentPage.ctorParameters = () => [
...
ReferredStudentPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
//# sourceMappingURL=src_app_pages_pmoa_referred-pmoa_referred-student_referred-student_module_ts-es2015.js.map