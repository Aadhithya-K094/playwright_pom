  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_art-culture_ka-session-verification_ka-session-verification_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "KASessionVerificationPageRoutingModule": function KASessionVerificationPageRoutingModule() {
          return (
            /* binding */
            _KASessionVerificationPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _ka_session_verification_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./ka-session-verification.page */
      35592);
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! ./arp-course-materials/arp-course-materials.module */
      ...
      var _KASessionVerificationPageRoutingModule = /*#__PURE__*/_createClass(function KASessionVerificationPageRoutingModule() {
        _classCallCheck(this, KASessionVerificationPageRoutingModule);
      });

      _KASessionVerificationPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "KASessionVerificationPageModule": function KASessionVerificationPageModule() {
          return (
            /* binding */
            _KASessionVerificationPageModule
          );
        }
        /* harmony export */
      ...
      var _ka_session_verification_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./ka-session-verification-routing.module */
      43000);
      /* harmony import */


      var _ka_session_verification_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./ka-session-verification.page */
      35592);

      var _KASessionVerificationPageModule = /*#__PURE__*/_createClass(function KASessionVerificationPageModule() {
        _classCallCheck(this, KASessionVerificationPageModule);
      });

      _KASessionVerificationPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _ka_session_verification_routing_module__WEBPACK_IMPORTED_MODULE_0__.KASessionVerificationPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "KASessionVerificationPage": function KASessionVerificationPage() {
          return (
            /* binding */
            _KASessionVerificationPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_ka_session_verification_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./ka-session-verification.page.html */
      69303);
      /* harmony import */


      var _ka_session_verification_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./ka-session-verification.page.scss */
      59977);
      /* harmony import */
      ...
      var _KASessionVerificationPage = /*#__PURE__*/function () {
        function KASessionVerificationPage(router, userSessionService, emisService, userService) {
          _classCallCheck(this, KASessionVerificationPage);
          ...
          var date = currentDate.getDate(); // var weekOfMonth = Math.ceil((date - 1 - this.day) / 7);
        ...
        return _createClass(KASessionVerificationPage, [{
          key: "ngOnInit",
          ...
          value: function ionViewDidEnter() {
            ...
            this.schoolList = [];
            this.emisService.ArpTodaySession(data).subscribe(function (res) {
          ...
          value: function initial() {
            ...
            this.arpList = [];
            this.emisService.ArpSessVerifBrte(data).subscribe(function (res) {
              if (res.dataStatus) {
                _this3.arpList = res.result;

                if (_this3.arpList) {
                  _this3.dataList = [];

                  for (var i = 0; i < _this3.arpList.length; i++) {
                    if (_this3.dataList.indexOf(_this3.arpList[i].school_id) === -1) {
                      _this3.dataList.push(_this3.arpList[i].school_id);
                    }
                  }

                  if (_this3.dataList) {
                    _this3.finaldata = [];
                    var key = _this3.dataList;

                    var _loop = function _loop(_i) {
                      var total = _toConsumableArray(new Map(_this3.arpList.map(function (item) {
                        return [item[_i], item];
                      })).values());

                      _this3.finaldata.push(total[_i]);
                    };

                    for (var _i = 0; _i < _this3.dataList.length; _i++) {
                      _loop(_i);
                    }
                  }
                }
          ...
          key: "showsession",
          value: function showsession(data) {
          ...
          value: function SchInfohide(i, data) {
            ...
            if (this.arpList) {
              ...
              for (var _i2 = 0; _i2 < this.arpList.length; _i2++) {
                if (this.arpList[_i2].school_id == data.school_id) {
                  this.batchList.push(this.arpList[_i2]);
                }
              }
              ...
              if (this.batchList) {
                ...
                for (var _i3 = 0; _i3 < this.batchList.length; _i3++) {
                  if (this.finalbatchList.indexOf(this.batchList[_i3].batch_id) === -1) {
                    this.finalbatchList.push(this.batchList[_i3].batch_id);
                  }
                }
              }
            }
          ...
          key: "groupDiv",
          value: function groupDiv(val, data) {
            ...
            if (this.finalgrpList) {
              ...
              for (var _i4 = 0; _i4 < this.finalgrpList.length; _i4++) {
                if (this.finalgrpListdata.indexOf(this.finalgrpList[_i4].id) === -1) {
                  this.finalgrpListdata.push(this.finalgrpList[_i4].id);
                }
              }
              ...
              if (this.finalgrpListdata) {
                ...
                for (var _i5 = 0; _i5 < this.arpList.length; _i5++) {
                  for (var j = 0; j < this.finalgrpListdata.length; j++) {
                    if (this.arpList[_i5].id == this.finalgrpListdata[j]) {
                      this.GrpList.push(this.arpList[_i5]);
                    }
                  }
                }
              }
          ...
          key: "arpstudentdetails",
          value: function arpstudentdetails(data) {
          ...
          key: "arpcoursematerial",
          value: function arpcoursematerial() {
      ...
      _KASessionVerificationPage.ctorParameters = function () {
        return [{
      ...
      _KASessionVerificationPage = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
...
//# sourceMappingURL=src_app_pages_art-culture_ka-session-verification_ka-session-verification_module_ts-es5.js.map