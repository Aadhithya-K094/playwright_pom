  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_inspection_writing_inspection_new-questions_questions1_questions1_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "Questions1PageRoutingModule": function Questions1PageRoutingModule() {
          return (
            /* binding */
            _Questions1PageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _questions1_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./questions1.page */
      74893);
      ...
      var _Questions1PageRoutingModule = /*#__PURE__*/_createClass(function Questions1PageRoutingModule() {
        _classCallCheck(this, Questions1PageRoutingModule);
      });

      _Questions1PageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "Questions1PageModule": function Questions1PageModule() {
          return (
            /* binding */
            _Questions1PageModule
          );
        }
        /* harmony export */
      ...
      var _questions1_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./questions1-routing.module */
      2210);
      /* harmony import */


      var _questions1_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./questions1.page */
      74893);

      var _Questions1PageModule = /*#__PURE__*/_createClass(function Questions1PageModule() {
        _classCallCheck(this, Questions1PageModule);
      });

      _Questions1PageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _questions1_routing_module__WEBPACK_IMPORTED_MODULE_0__.Questions1PageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "Questions1Page": function Questions1Page() {
          return (
            /* binding */
            _Questions1Page
          );
      ...
      var _raw_loader_questions1_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./questions1.page.html */
      68896);
      /* harmony import */


      var _questions1_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./questions1.page.scss */
      66160);
      /* harmony import */
      ...
      var _Questions1Page = /*#__PURE__*/function () {
        function Questions1Page(fb, userService, router, route, userSessionService, alertService) {
          _classCallCheck(this, Questions1Page);
          ...
          this.meeting2 = [{
            value: "1",
            label: "Sharing of best practices"
          }, {
            value: "2",
            label: "Planning for the next month and participant demo presentations"
          }, {
            value: "3",
            label: "TLM Preparation"
          }, {
            value: "4",
          ...
          this.adop3 = [{
            value: "1",
            label: "Ask doubts at the end of the session"
          }, {
            value: "2",
            label: "Avoid phone usage during the session"
          }, {
            value: "3",
            label: "Listen and participate during the session"
          }, {
            value: "4",
            label: "Be on time after break"
          }, {
            value: "5",
            label: "None"
          }];
          ...
          this.adop5 = [{
            value: "1",
            label: "Explained the practices"
          }, {
            value: "2",
            label: "Demonstrated the practices"
          }, {
            value: "3",
            label: "Shared TLMs used in their classrooms"
          }, {
            value: "4",
            label: "Shared photos/videos from their classrooms"
          }, {
            value: "5",
            label: "Presented the outcomes of those practices"
          }];
          this.adop6 = [{
            value: "1",
            ...
            value: "5",
            label: "Filled the Lesson Plan format"
          }];
          this.adop7 = [{
            value: "1",
            label: "Walked around and observed preparation"
          }, {
            value: "2",
            label: "Shared observation and feedback with the teachers"
          }, {
            value: "3",
            label: "Mostly watched teachers practice"
          }, {
            value: "4",
            label: "Didn't support"
          }, {
            value: "5",
            label: "Demo did not happen"
          }];
          this.adop8 = [{
            value: "1",
            label: "More than 90%"
          ...
          this.adop9 = [{
            ...
            value: "5",
            label: "TLM preparation didn't happen"
          }];
          this.adop10 = [{
            value: "1",
          ...
          this.adop11 = [{
            ...
            value: "2",
            label: "Actively discussed as one large group"
          }, {
            value: "3",
            label: "Mostly listened to what the facilitator shared/modelled"
          }, {
            value: "4",
            label: "Mostly listened to what the facilitator shared/modelled"
          }, {
            value: "5",
            label: "Mostly listened to what a few teachers shared/modelled"
          }];
          this.align1 = [{
            value: "1",
            label: "More than 90%"
          ...
          this.fac1 = [{
            value: "1",
            label: "Video was played but was not followed by a discussion"
          }, {
            value: "2",
            label: "Video was played, followed by a discussion"
          }, {
            value: "3",
            label: "Video was not played"
          }, {
            value: "4",
            label: "Other"
          }];
          ...
          this.fac4 = [{
            value: "1",
            label: "Yes, facilitator summarized the main points"
          }, {
            value: "2",
            label: "Yes, facilitator guided the participants to summarise the main points"
          }, {
            value: "3",
            label: "No"
          }];
          this.meeting11 = [{
            value: "1",
            label: "Std 6-10 Tamil"
          }, {
            value: "2",
            label: "Std 6-10 English"
          }, {
            value: "3",
            label: "Std 6-10 Maths"
          }, {
            value: "4",
            label: "Std 6-10 Science"
          }, {
            value: "5",
            label: "Std 6-10 Social science"
          }];
          this.meeting111 = [{
            value: "1",
            label: "Std 1-3 Tamil"
            ...
            value: "2",
            label: "Std 1-3 English"
          }, {
            value: "3",
            label: "Std 1-3 Maths"
          }, {
            value: "4",
            label: "Std 1-3 Phonetics"
          }];
          this.meeting112 = [{
            value: "1",
            label: "Std 4-5 Tamil"
            ...
            value: "2",
            label: "Std 4-5 English"
          }, {
            value: "3",
            label: "Std 4-5 Maths"
          }, {
            value: "4",
            label: "Std 4-5 Bridge Course"
          }, {
            value: "5",
            label: "Std 4-5 Spoken English"
          }];
          this.meeting12 = [{
            value: "1",
            label: "Previous month's lesson review"
          }, {
            value: "2",
            label: "Previous month's lesson exemplar"
          }, {
            value: "3",
            label: "Planning for the next month"
          }, {
            value: "4",
            label: "Next month's lesson exemplar"
          }, {
            value: "5",
            label: "Psychometric game"
          }];
          this.adop21 = [{
            value: "1",
            label: "Computer"
          ...
          this.adop22 = [{
            value: "1",
            label: "Linktree Mapped in Facilitator's App"
          }, {
            value: "2",
            label: "Text books"
          }, {
          ...
          this.align27 = [{
            ...
            value: "3",
            label: "Mostly listened to what the RP shared/modelled"
          }, {
            value: "4",
            label: "Mostly listened to what a few participants shared/modelled"
          }];
          this.align28 = [{
            value: "1",
            label: "Facilitator displayed the video"
          }, {
            value: "2",
            label: "Facilitator gave instructions to play the game"
          }, {
            value: "3",
            label: "Facilitator played the game"
          }, {
            value: "4",
            label: "Participants played the game"
          }];
          this.align29 = [{
            value: "1",
            ...
            value: "2",
            label: "Shared observation and feedback to the teachers"
          }, {
            value: "3",
            label: "Mostly watched teachers practice"
          }, {
          ...
          this.fac_prac3 = [{
            value: "1",
            label: "Yes- Facilitator summarized the major points"
          }, {
            value: "2",
            label: "Yes - Facilitator guided the participants to summarise the main points"
          }, {
          ...
          this.meeting32 = [{
            value: "1",
            label: "Group discussion for remedial activities"
          }, {
            value: "2",
            label: "Learning outcomes and Assessment"
          }, {
            value: "3",
          ...
          this.general3 = [{
            value: "1",
            label: "Std 11-12 Tamil"
          }, {
            value: "2",
            label: "Std 11-12 English"
          }, {
            value: "3",
            label: "Std 11-12 Mathematics"
          }, {
            value: "4",
            label: "Std 11-12 Physics"
          }, {
            value: "5",
            label: "Std 11-12 Chemistry"
          }, {
            value: "6",
            label: "Std 11-12 Biology"
          }, {
            value: "7",
            label: "Std 11-12 Computer Science"
          }, {
            value: "8",
            label: "Std 11-12 Economics"
          }, {
            value: "9",
            label: "Std 11-12 Commerce"
          }, {
            value: "10",
            label: "Std 11-12 Accountancy"
          }, {
            value: "11",
            label: "Std 11-12 History"
          }, {
            value: "12",
            label: "Std 11-12 Geography"
          }];
          this.general4 = [{
            "value": "1",
            "label": "Yes"
        ...
        return _createClass(Questions1Page, [{
          key: "ngOnInit",
          ...
          value: function onChange(event) {
            ...
            var value = this.questionform.value.meeting2;
          ...
          key: "onChanges3",
          value: function onChanges3(event) {
            var _this3 = this;
          ...
          value: function onChange2(event) {
            ...
            if (value.length > 0) {
              value.forEach(function (res) {
                if (res == 1) {
                  _this4.active11 = true;
                }

                if (res == 2) {
                  _this4.active12 = true;
                }

                if (res == 3) {
                  _this4.active13 = true;
                }

                if (res == 4) {
                  _this4.active14 = true;
                }

                if (res == 5) {
                  _this4.active15 = true;
                }
              });
            }
          }
          ...
          value: function onClassChange(event) {
            ...
            if (this.form.value.class_flag == 1) {// if (this.form.value.class_flag == 1) {
          ...
          key: "onChanges",
          value: function onChanges(event) {
            var _this5 = this;

            this.adop5active1 = false;
            var value = this.questionform.value.adop2;

            if (value.length > 0) {
              value.forEach(function (res) {
                if (res == 3) {
                  _this5.adop5active1 = true;
                }
              });
            }
          }
          ...
          value: function onSave() {
            ...
            debugger; // if (this.form.value.class_flag == 1) {
            //     if (this.active1) {
            ...
            if (this.form.valid && this.questionform.valid) {
              ...
              this.userService.saveCRC(data).subscribe(function (res) {
                if (res.dataStatus) {
      ...
      _Questions1Page.ctorParameters = function () {
        return [{
      ...
      _Questions1Page = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
...
//# sourceMappingURL=src_app_pages_inspection_writing_inspection_new-questions_questions1_questions1_module_ts-es5.js.map