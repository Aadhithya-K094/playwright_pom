...
/* harmony export */   "PrimaryFloorClosingQuestionsPageRoutingModule": function() { return /* binding */ PrimaryFloorClosingQuestionsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _primary_floor_closing_questions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primary-floor-closing-questions.page */ 72769);
...
let PrimaryFloorClosingQuestionsPageRoutingModule = class PrimaryFloorClosingQuestionsPageRoutingModule {
};
PrimaryFloorClosingQuestionsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], PrimaryFloorClosingQuestionsPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrimaryFloorClosingQuestionsPageModule": function() { return /* binding */ PrimaryFloorClosingQuestionsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _primary_floor_closing_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primary-floor-closing-questions-routing.module */ 29555);
/* harmony import */ var _primary_floor_closing_questions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./primary-floor-closing-questions.page */ 72769);
...
let PrimaryFloorClosingQuestionsPageModule = class PrimaryFloorClosingQuestionsPageModule {
};
PrimaryFloorClosingQuestionsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _primary_floor_closing_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__.PrimaryFloorClosingQuestionsPageRoutingModule,
...
], PrimaryFloorClosingQuestionsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrimaryFloorClosingQuestionsPage": function() { return /* binding */ PrimaryFloorClosingQuestionsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_primary_floor_closing_questions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./primary-floor-closing-questions.page.html */ 5639);
/* harmony import */ var _primary_floor_closing_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./primary-floor-closing-questions.page.scss */ 29852);
...
let PrimaryFloorClosingQuestionsPage = class PrimaryFloorClosingQuestionsPage {
    ...
    onSave() {
        ...
        if (this.form.valid) {
            ...
            let query = 'UPDATE sidsPrimaryFloorQuestion SET FloorSafety ="' + this.form.value.FloorSafety +
                ...
                '", DoorReplace = "' + this.form.value.DoorReplace + '", JaalisReplace = "' + this.form.value.JaalisReplace +
                '", DoorRepair = "' + this.form.value.DoorRepair + '", JaalisRepair = "' + this.form.value.JaalisRepair +
                '", DoorRepaint = "' + this.form.value.DoorRepaint + '", JaalisRepaint = "' + this.form.value.JaalisRepaint +
                '", BldOhtYn = "' + this.form.value.BldOhtYn + '", FunBldOhtYn = "' + this.form.value.FunBldOhtYn +
                '" WHERE sidsPrimaryFloorQuestion.SclId = "' + this.schoolId + '" And sidsPrimaryFloorQuestion.BuildingId = "' + this.buildingId + '" And sidsPrimaryFloorQuestion.VistId = "' + this.vistId + '" And sidsPrimaryFloorQuestion.FloorId = "' + this.floorId + '"';
            let query2 = 'UPDATE sidsPrimaryFloorSaveDatas SET FloorClose = 2, Status = 2 WHERE SclId = "' + this.schoolId + '" And BuildIndx = "' + idbuild + '" And FloorId = "' + this.floorId + '"';
            console.log(query, query2);
            return this.sqliteDB.update(query).then(data => {
                return this.sqliteDB.update(query2).then(data => {
                    this.alertService.success("Saved Successfully");
                    if (this.status == '3') {
                        this.router.navigate(['/tabs/primary-new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '3', expIdBuild: build, expBuildId: buildId, expIdFloor: floorId, expFloorId: floor, 'visitstatus': this.visitstatus }, skipLocationChange: false });
                    }
                    if (this.status != '3') {
                        this.router.navigate(['/tabs/primary-new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '2', expIdBuild: build, expBuildId: buildId, expIdFloor: floorId, expFloorId: floor, 'visitstatus': this.visitstatus }, skipLocationChange: false });
                    }
                });
            });
        }
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            ...
            if (data.rows.length > 0) {
                ...
                this.form.patchValue({
                    ...
                    "ReqParapetWall": this.dataList[0].ReqParapetWall ? Array.from(this.dataList[0].ReqParapetWall.split(",")) : '',
                    ...
                    "CorridorRepair": this.dataList[0].CorridorRepair ? Array.from(this.dataList[0].CorridorRepair.split(",")) : '',
    ...
    checkLocalFloor() {
        let query = 'SELECT FloorNum FROM sidsPrimaryFloorQuestion' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildingId = "' + this.buildingId + '"' +
            ' And VistId = "' + this.vistId + '"';
        return this.sqliteDB.getDataLocalDB(query).then(data => {
    ...
    goToBack() {
        ...
        if (this.status == '1') {
            this.router.navigate(['/tabs/primary-new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '1', expIdBuild: build, expBuildId: buildId, expIdFloor: floorId, expFloorId: floor, 'visitstatus': this.visitstatus }, skipLocationChange: false });
        }
...
PrimaryFloorClosingQuestionsPage.ctorParameters = () => [
...
PrimaryFloorClosingQuestionsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
], PrimaryFloorClosingQuestionsPage);
...
//# sourceMappingURL=src_app_pages_sids_primary-school_primary-building_primary-floor-closing-questions_primary-fl-729572-es2015.js.map