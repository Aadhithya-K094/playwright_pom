...
/* harmony export */   "ReferredChildDetailsPageRoutingModule": function() { return /* binding */ ReferredChildDetailsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _referred_child_details_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./referred-child-details.page */ 14158);
...
let ReferredChildDetailsPageRoutingModule = class ReferredChildDetailsPageRoutingModule {
};
ReferredChildDetailsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], ReferredChildDetailsPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ReferredChildDetailsPageModule": function() { return /* binding */ ReferredChildDetailsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _referred_child_details_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./referred-child-details-routing.module */ 37295);
/* harmony import */ var _referred_child_details_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./referred-child-details.page */ 14158);
...
let ReferredChildDetailsPageModule = class ReferredChildDetailsPageModule {
};
ReferredChildDetailsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _referred_child_details_routing_module__WEBPACK_IMPORTED_MODULE_0__.ReferredChildDetailsPageRoutingModule
        ],
        declarations: [_referred_child_details_page__WEBPACK_IMPORTED_MODULE_1__.ReferredChildDetailsPage]
    })
], ReferredChildDetailsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ReferredChildDetailsPage": function() { return /* binding */ ReferredChildDetailsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_referred_child_details_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./referred-child-details.page.html */ 99231);
/* harmony import */ var _referred_child_details_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./referred-child-details.page.scss */ 16522);
...
let ReferredChildDetailsPage = class ReferredChildDetailsPage {
    constructor(alertController, usersessionService, pdfGenerator, router, userService, alert, alertService) {
    ...
    getReferredChildSchList() {
        this.userService.MhtReferredSchs(this.UserName).subscribe((res) => {
            if (res.dataStatus) {
    ...
    schBtn(item) {
        ...
        let alert;
        this.userService.MhtReferredStudentList(this.UserName, this.schId).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            if (res.dataStatus) {
                this.studList2 = res.result;
                this.studList = res.result;
                for (var i = 0; i < this.studList.length; i++) {
                    let actkn = this.Action_taken.find(j => j.value === this.studList[i].act_tkn);
                    if (this.studList[i].act_tkn = actkn.value) {
                        Object.assign(this.studList[i], { acktnlabel: actkn.label });
                    }
                }
            }
            else {
                ...
                buttons: [
                    {
                        ...
                        handler: (item) => {
                            ...
                            this.value = item;
                            let label = this.Action_taken.find(j => j.value === this.value);
                            this.labelSelct = label.label;
                            console.log('labelSelct', this.labelSelct);
                            var sortStudentList = this.studList2.filter(tt => tt.act_tkn == this.value);
    ...
    onSumbit() {
        ...
        if (this.remarks != null && this.remarks.trim() !== "" && this.disease !== null && this.disease.trim() !== "" && this.date !== null && this.date.trim() !== "") {
            ...
            this.userService.mhtfollowup(this.finaldata).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
    ...
    getfollowup() {
        this.getdatafollow = [];
        this.userService.getfollowupdatamht(this.studt_id).subscribe((res) => {
            if (res.dataStatus) {
...
ReferredChildDetailsPage.ctorParameters = () => [
...
ReferredChildDetailsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
//# sourceMappingURL=src_app_pages_mht_referred-child-details_referred-child-details_module_ts-es2015.js.map