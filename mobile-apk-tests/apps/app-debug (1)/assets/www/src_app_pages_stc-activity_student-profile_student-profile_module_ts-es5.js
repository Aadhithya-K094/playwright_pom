  ...
  (self["webpackChunkTNSED_Administrators"] = self["webpackChunkTNSED_Administrators"] || []).push([["src_app_pages_stc-activity_student-profile_student-profile_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "StudentProfilePageRoutingModule": function StudentProfilePageRoutingModule() {
          return (
            /* binding */
            _StudentProfilePageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _student_profile_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      var _StudentProfilePageRoutingModule = /*#__PURE__*/_createClass(function StudentProfilePageRoutingModule() {
        _classCallCheck(this, StudentProfilePageRoutingModule);
      });

      _StudentProfilePageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "StudentProfilePageModule": function StudentProfilePageModule() {
          return (
            /* binding */
            _StudentProfilePageModule
          );
        }
        /* harmony export */
      ...
      var _student_profile_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./student-profile-routing.module */
      21300);
      /* harmony import */


      var _student_profile_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./student-profile.page */
      88212);

      var _StudentProfilePageModule = /*#__PURE__*/_createClass(function StudentProfilePageModule() {
        _classCallCheck(this, StudentProfilePageModule);
      });

      _StudentProfilePageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _student_profile_routing_module__WEBPACK_IMPORTED_MODULE_0__.StudentProfilePageRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "StudentProfilePage": function StudentProfilePage() {
          return (
            /* binding */
            _StudentProfilePage
          );
      ...
      var _raw_loader_student_profile_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./student-profile.page.html */
      34130);
      /* harmony import */


      var _student_profile_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./student-profile.page.scss */
      83713);
      /* harmony import */
      ...
      var _StudentProfilePage = /*#__PURE__*/function () {
        function StudentProfilePage(router, fb, ionStorage, alertService, emisService, userSesstion, geolocation, alertController, jsonService, route) {
          _classCallCheck(this, StudentProfilePage);
        ...
        return _createClass(StudentProfilePage, [{
          key: "ngOnInit",
          ...
          value: function getSchoolProfileList() {
            ...
            this.ionStorage.getData('MigrateStudList').then(function (res) {
              if (res) {
                _this2.MigrateStudList = res;
              } else {
                _this2.emisService.MigrateStudList(_this2.userSesstion.emis_username()).subscribe(function (res) {
                  if (res.dataStatus) {
          ...
          value: function getCenterDetails() {
            ...
            this.ionStorage.getData('CenterDetailsList').then(function (res) {
              if (res) {
                ...
                for (var i = 0; i < _this3.CenterDetailsList.length; i++) {
                  var data = {
                    schoolId: _this3.CenterDetailsList[i].SchlId,
                    schoolName: _this3.CenterDetailsList[i].SchlName
                  };

                  _this3.schoolList.push(data);
                }
                ...
                _this3.emisService.EVDetailsStoreGet(_this3.userSesstion.emis_username(), 2).subscribe(function (res) {
                  if (res.dataStatus) {
                    ...
                    for (var _i = 0; _i < _this3.CenterDetailsList.lenght; _i++) {
                      var _data = {
                        schoolId: _this3.CenterDetailsList[_i].SchlId,
                        schoolName: _this3.CenterDetailsList[_i].SchlName
                      };

                      _this3.schoolList.push(_data);
                    }
            ...
            this.ionStorage.getData('BrteMappedStudList').then(function (res) {
              if (res) {
                ...
                if (schoolData.length > 0) {
                  _this4.studentList = schoolData[0].studentList;
                } else {
                  _this4.emisService.BrteMappedStudList(event).subscribe(function (res) {
                    if (res.dataStatus) {
                      _this4.studentList = res.result;
                      var school = {
                        schoolId: event,
                      ...
                      _this4.ionStorage.removeKey('BrteMappedStudList').then(function (res) {
                        _this4.ionStorage.insertData_Replace('BrteMappedStudList', responce);
                      });
                    } else {
                ...
                _this4.form.controls['EmisNumber'].setValue(null);

                _this4.form.controls['EmisNumber'].updateValueAndValidity();
              } else {
                _this4.emisService.BrteMappedStudList(event).subscribe(function (res) {
                  if (res.dataStatus) {
                    _this4.studentList = res.result;
                    ...
                    _this4.ionStorage.removeKey('BrteMappedStudList').then(function (res) {
                      _this4.ionStorage.insertData_Replace('BrteMappedStudList', school);
                    });
                  } else {
                    _this4.alertService.error(res.message);
                  }
          ...
          value: function onSave(id) {
            ...
            if (this.form.valid) {
              ...
              if (id == 1) {
                var studData = this.studentList.filter(function (dd) {
                  return dd.user_id == _this5.form.value.EmisNumber;
                });
              ...
              if (id == 2) {
                ...
                if (this.form.value.StudMigrateState == 1) {
                  ...
                  this.emisService.StudentMigrantUpdate(data).subscribe(function (res) {
                    if (res.dataStatus) {
                      _this5.initialValidator();

                      _this5.submitted = false;
                      _this5.emisNumberValid = false;
                      _this5.ValidStud = false;
              ...
              if (id == 3) {
                if (this.form.valid) {
                  ...
                  this.emisService.StudentMigrantSave(_data2).subscribe(function (res) {
                    if (res.dataStatus) {
                      _this5.StudMigrateState(res.message);
                    } else {
          ...
          key: "StudMigrateState",
          value: function StudMigrateState(message) {
            var _this6 = this;
            ...
            if (this.form.value.StudMigrateState == 1) {
              ...
              this.emisService.StudentMigrantUpdate(data).subscribe(function (res) {
                if (res.dataStatus) {
                  ...
                  _this6.initialValidator();

                  _this6.submitted = false;
                  _this6.emisNumberValid = false;
                  _this6.ValidStud = false;
                  _this6.addProfile = false;

                  _this6.emisService.MigrateStudList(_this6.userSesstion.emis_username()).subscribe(function (res) {
                    if (res.dataStatus) {
                      _this6.MigrateStudList = res.result;

                      _this6.ionStorage.removeKey('MigrateStudList').then(function (res) {
                        _this6.ionStorage.insertData_Replace('MigrateStudList', _this6.MigrateStudList);
                      });
                    }
                  });
                } else {
          ...
          value: function onEdit(data) {
            ...
            this.emisNumberValid = true; // this.ValidStud = true;
          ...
          value: function getDistrict() {
            ...
            this.ionStorage.getData('districtList').then(function (res) {
              _this8.districtList = res;
            });
          }
        }, {
          key: "getBlock",
          value: function getBlock(data) {
            var _this9 = this;

            this.form.controls['PermanentBlock'].setValue(null);
            this.form.controls['PermanentBlock'].updateValueAndValidity();
            this.ionStorage.getData('blockList').then(function (res) {
              _this9.blockList = res.filter(function (dd) {
                return dd.District_id == _this9.form.value.PermanentDistrict;
              });
            });
          }
        }, {
          key: "onRadioEvent",
          value: function onRadioEvent(id) {
            if (id == 1) {
              if (this.form.value.StudMigrateState == 1) {
                ...
                this.form.controls['StudState'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required); // this.ValidStud = true;
              } else {
          ...
          value: function getLatLong() {
            ...
            this.geolocation.getCurrentPosition({
              ...
              _this0.locationCordinates = resp.coords;
              _this0.locationCordinates.latitude;
              _this0.locationCordinates.longitude;
      ...
      _StudentProfilePage.ctorParameters = function () {
        return [{
      ...
      _StudentProfilePage = (0, tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_12__.Component)({
...
//# sourceMappingURL=src_app_pages_stc-activity_student-profile_student-profile_module_ts-es5.js.map