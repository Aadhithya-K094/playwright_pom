...
/* harmony export */   "PrimaryBuildingQuestionsPageRoutingModule": function() { return /* binding */ PrimaryBuildingQuestionsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _primary_building_questions_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primary-building-questions.page */ 23266);
...
let PrimaryBuildingQuestionsPageRoutingModule = class PrimaryBuildingQuestionsPageRoutingModule {
};
PrimaryBuildingQuestionsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], PrimaryBuildingQuestionsPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrimaryBuildingQuestionsPageModule": function() { return /* binding */ PrimaryBuildingQuestionsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _primary_building_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primary-building-questions-routing.module */ 73536);
/* harmony import */ var _primary_building_questions_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./primary-building-questions.page */ 23266);
...
let PrimaryBuildingQuestionsPageModule = class PrimaryBuildingQuestionsPageModule {
};
PrimaryBuildingQuestionsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _primary_building_questions_routing_module__WEBPACK_IMPORTED_MODULE_0__.PrimaryBuildingQuestionsPageRoutingModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule
        ],
        declarations: [_primary_building_questions_page__WEBPACK_IMPORTED_MODULE_1__.PrimaryBuildingQuestionsPage]
    })
], PrimaryBuildingQuestionsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrimaryBuildingQuestionsPage": function() { return /* binding */ PrimaryBuildingQuestionsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! tslib */ 65353);
/* harmony import */ var _raw_loader_primary_building_questions_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./primary-building-questions.page.html */ 41875);
/* harmony import */ var _primary_building_questions_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./primary-building-questions.page.scss */ 36298);
...
/* harmony import */ var src_app_services_emis_user_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/emis/user.service */ 92275);
...
/* harmony import */ var src_app_services_sqlite_sqlitedatabase_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/services/sqlite/sqlitedatabase.service */ 48167);
...
let PrimaryBuildingQuestionsPage = class PrimaryBuildingQuestionsPage {
    constructor(router, formBuilder, route, networkService, alertController, androidPermissions, file, camera, sqliteDB, geolocation, utilityService, ionicStorage, userSessionService, alertService, el) {
        this.router = router;
    ...
    onSave() {
        ...
        if (this.form.valid) {
            ...
            let query = 'DELETE FROM  sidsPrimaryBuildingQuestion' +
    ...
    insertLocalDB() {
        ...
        if (+this.form.value.BldgCondition == 2 || +this.form.value.BldgCondition == 3 || +this.form.value.BldgCondition == 5) {
            insertRows.push([
                "INSERT INTO sidsPrimaryBuildingQuestion VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                [null, this.schoolId, this.vistId, this.buildingId, this.form.value.IndexId,
                    this.form.value.BldgName, this.form.value.BldgAge, this.form.value.BldgFundSourceCons,
                    this.form.value.BldgType, this.form.value.BldgLength, this.form.value.BldgBre,
                    this.form.value.BldgCondition, '',
                    '', '', '', '', '', '', '', '', '', '', '', this.form.value.AuditoriumYn,
                    this.form.value.AuditoriumStageReqt, this.form.value.AuditoriumStageArea, this.form.value.AuditoriumStageHeight,
                    this.form.value.AuditoriumStageAreaLevel, this.form.value.AuditoriumLights, this.form.value.AuditoriumFans,
                    this.form.value.AuditoriumPrjtYn, this.form.value.AuditoriumPrjtFunc, '',
                    'false', 'false', 'false', 'false', 'false', '', '', this.form.value.BldgFrontPhoto, this.form.value.BldgFrontPhotoName,
                    this.form.value.BldgLatitude, this.form.value.BldgLongitude
                ]
            ]);
        }
        else {
            insertRows.push([
                ...
                [null, this.schoolId, this.vistId, this.buildingId, this.form.value.IndexId,
                    this.form.value.BldgName, this.form.value.BldgAge, this.form.value.BldgFundSourceCons,
                    this.form.value.BldgType, this.form.value.BldgLength, this.form.value.BldgBre,
                    this.form.value.BldgCondition, this.form.value.BldgRepair ? this.form.value.BldgRepair.toString() : this.form.value.BldgRepair,
                    ...
                    this.form.value.AuditoriumStageReqt, this.form.value.AuditoriumStageArea, this.form.value.AuditoriumStageHeight,
                    this.form.value.AuditoriumStageAreaLevel, this.form.value.AuditoriumLights, this.form.value.AuditoriumFans,
                    this.form.value.AuditoriumPrjtYn, this.form.value.AuditoriumPrjtFunc, this.form.value.RampAvailYn,
                    this.form.value.RampRepairYn, this.form.value.FireExtYn, this.form.value.FirstAidKit,
                    this.form.value.CCTVCameraYn, this.form.value.BuildTabsYn, this.form.value.BuildTabsNumber, this.form.value.BuildReapairComArea,
                    this.form.value.BldgFrontPhoto, this.form.value.BldgFrontPhotoName, this.form.value.BldgLatitude, this.form.value.BldgLongitude
                ]
            ]);
        }
        ...
        this.sqliteDB.bulkInsert(insertRows).then((result) => {
            ...
            let query = 'UPDATE sidsPrimaryBuildSavesDatas SET Status = 2 WHERE sidsPrimaryBuildSavesDatas.SclId = "' + this.schoolId + '" And sidsPrimaryBuildSavesDatas.BuildingId = "' + this.buildingId + '" And sidsPrimaryBuildSavesDatas.VistId = "' + this.vistId + '"';
            let query1 = 'UPDATE sidsPrimaryBuildSavesDatas SET BuildName="' + name + '" WHERE sidsPrimaryBuildSavesDatas.SclId = "' + this.schoolId + '" And sidsPrimaryBuildSavesDatas.BuildingId = "' + this.buildingId + '" And sidsPrimaryBuildSavesDatas.VistId = "' + this.vistId + '"';
            let query2 = 'UPDATE sidsPrimaryBuildSavesDatas SET BuildCondi="' + this.form.value.BldgCondition + '" WHERE sidsPrimaryBuildSavesDatas.SclId = "' + this.schoolId + '" And sidsPrimaryBuildSavesDatas.BuildingId = "' + this.buildingId + '" And sidsPrimaryBuildSavesDatas.VistId = "' + this.vistId + '"';
            if (((_a = this.dataList) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                if (((_b = this.dataList[0]) === null || _b === void 0 ? void 0 : _b.BldgCondition) == 2 || this.dataList[0].BldgCondition == 3 || this.dataList[0].BldgCondition == 5) {
                    let query3 = 'UPDATE sidsPrimaryBuildSavesDatas SET ClosingQuestions="' + 1 + '" WHERE sidsPrimaryBuildSavesDatas.SclId = "' + this.schoolId + '" And sidsPrimaryBuildSavesDatas.BuildingId = "' + this.buildingId + '" And sidsPrimaryBuildSavesDatas.VistId = "' + this.vistId + '"';
            ...
            return this.sqliteDB.update(query).then(data => {
                return this.sqliteDB.update(query1).then(data => {
                    return this.sqliteDB.update(query2).then(data => {
                        console.log("update");
                        this.router.navigate(['/tabs/primary-new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '2', expIdBuild: build, expBuildId: buildId, BldgCondition: +this.form.value.BldgCondition == 2 ? 2 : +this.form.value.BldgCondition == 1 ? 1 : null, 'visitstatus': this.visitstatus }, skipLocationChange: false });
                    });
                });
            });
        });
        ...
        return this.sqliteDB.getDataLocalDB(query).then(data => {
            if (data.rows.length > 0) {
                ...
                this.form.patchValue({
                    "IndexId": this.dataList[0].BuildingIndex,
                    "SchlId": this.schoolId,
                    "VistId": this.vistId,
                    "BldgId": this.buildingId,
                    ...
                    "BldgLatitude": this.dataList[0].BldgLatitude,
                    "BldgLongitude": this.dataList[0].BldgLongitude,
                });
    ...
    goToBack() {
        ...
        if (this.status == 3) {
            this.router.navigate(['/tabs/primary-new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '3', expIdBuild: build, expBuildId: buildId, 'visitstatus': this.visitstatus }, skipLocationChange: false });
        }
        if (this.status == 1) {
            this.router.navigate(['/tabs/primary-new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '1', expIdBuild: build, expBuildId: buildId, 'visitstatus': this.visitstatus }, skipLocationChange: false });
        }
        if (this.status == 2) {
            this.router.navigate(['/tabs/primary-new-dashboard'], { queryParams: { 'schoolId': this.schoolId, 'vistId': this.vistId, 'expanted': '2', expIdBuild: build, expBuildId: buildId, 'visitstatus': this.visitstatus }, skipLocationChange: false });
        }
    }
    deleteFloorandRoom() {
        let idbuild = parseInt(this.buildingId) - 100;
        let query1 = 'DELETE FROM sidsPrimaryFloorQuestion' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildingId = "' + this.buildingId + '"' +
            ' And VistId = "' + this.vistId + '"';
        let query2 = 'DELETE FROM sidsPrimaryFloorSaveDatas' +
            ' WHERE SclId = "' + this.schoolId + '"' +
        ...
        let query4 = 'DELETE FROM newPrimaryRoomscommons' +
            ...
            ' And VistId = "' + this.vistId + '"';
        let query5 = 'SELECT * FROM sidsPrimaryFloorQuestion' +
            ' WHERE SclId = "' + this.schoolId + '"' +
            ' And BuildingId = "' + this.buildingId + '"' +
            ' And VistId = "' + this.vistId + '"';
        return this.sqliteDB.getDataLocalDB(query5).then(floorData => {
            let sidsFloor = [];
                ...
                return this.sqliteDB.getDataLocalDB(query2).then(data => {
                    return this.sqliteDB.getDataLocalDB(query3).then(data => {
                        return this.sqliteDB.getDataLocalDB(query4).then(data => {
                            ...
                            if (this.dataList[0].BuildingIndex) {
                                let params = {
                                    "records": {
                                        "IndexId": '',
                                        ...
                                        "ToilBuildId": this.dataList[0].BuildingIndex,
                                        // "No Delete Building"
                                    }
                                };
                                let selectQuery = 'SELECT * FROM DeleteBuilding WHERE schoolId ="' + this.schoolId + '" And visitId ="' + this.vistId + '" And BuildId ="' + this.buildingId + '" And BuildIndxId ="' + this.dataList[0].BuildingIndex + '"';
                                return this.sqliteDB.getDataLocalDB(selectQuery).then(data => {
                                    if (data.rows.length == 0) {
                                        if (sidsFloor.length > 0 && sidsFloor[0].FloorIndx) {
                                            const datainsert = "INSERT INTO DeleteBuilding VALUES (?,?,?,?,?,?,?)";
                                            this.sqliteDB.insert(datainsert, [null, this.schoolId, this.vistId, this.buildingId, JSON.stringify(params), this.dataList[0].BuildingIndex, 2
                                            ]).then(insertres => { });
                                        }
                                    }
                                });
    ...
    getLatLong() {
        this.geolocation.getCurrentPosition({
            ...
            this.form.controls['BldgLatitude'].setValue(this.locationCordinates.latitude);
            this.form.controls['BldgLongitude'].setValue(this.locationCordinates.longitude);
            this.form.controls['BldgLatitude'].updateValueAndValidity();
            this.form.controls['BldgLongitude'].updateValueAndValidity();
        }).catch((error) => {
...
PrimaryBuildingQuestionsPage.ctorParameters = () => [
...
PrimaryBuildingQuestionsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_17__.__decorate)([
...
//# sourceMappingURL=src_app_pages_sids_primary-school_primary-building_primary-building-questions_primary-buildin-8948f0-es2015.js.map