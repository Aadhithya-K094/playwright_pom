...
test.describe("Inbox", () => {
    ...
    test("Verify Inbox menu visible", async ({ page }) => {
    ...
    test("Take Inbox screenshot", async ({ page }) => {
        await page.goto(BASE_URL + "/dashboard");
        await page.waitForLoadState("networkidle");
        await page.locator("text=Inbox").first().click();
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
        await page.screenshot({ path: "test-results/screenshots/BEO1_Inbox.png", fullPage: true });
    });
});
