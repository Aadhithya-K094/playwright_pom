...
const MODULE_URL = "/component/new_health_dashboard";
...
test.describe("Component > Health", () => {
    ...
    test("Verify Health page loads", async ({ page }) => {
    ...
    test("Verify Health page title", async ({ page }) => {
        await page.goto(BASE_URL + MODULE_URL);
        await page.waitForLoadState("networkidle");
    ...
    test("Verify Health navigation from Component menu", async ({ page }) => {
    ...
    test("Verify no console errors on Health", async ({ page }) => {
        const errors = [];
    ...
    test("Take Health screenshot", async ({ page }) => {
        await page.goto(BASE_URL + MODULE_URL);
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
        await page.screenshot({ path: "test-results/screenshots/BEO1_Component_Health.png", fullPage: true });
    });
});
