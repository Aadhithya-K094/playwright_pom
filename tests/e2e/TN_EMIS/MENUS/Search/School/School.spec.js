...
test.describe("Search > School", () => {
    ...
    test("Verify Search > School sub-menu appears", async ({ page }) => {
        await page.goto(BASE_URL + "/dashboard");
        await page.waitForLoadState("networkidle");
        ...
        // Verify School sub-menu
        const subMenu = page.locator("text=School").first();
        await expect(subMenu).toBeVisible();
    });

    test("Verify Search > School navigation", async ({ page }) => {
        await page.goto(BASE_URL + "/dashboard");
        await page.waitForLoadState("networkidle");
    ...
    test("Take Search School screenshot", async ({ page }) => {
        await page.goto(BASE_URL + "/dashboard");
        await page.waitForLoadState("networkidle");
        await page.getByRole("link", { name: "Search " }).click();
        await page.waitForTimeout(1000);
        ...
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
        await page.screenshot({ path: "test-results/screenshots/BEO1_Search_School.png", fullPage: true });
    });
});
