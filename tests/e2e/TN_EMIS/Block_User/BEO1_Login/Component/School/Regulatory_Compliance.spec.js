...
const MODULE_URL = "/component/rc_dashboard";

test.use({ storageState: { cookies: [], origins: [] } });

test.describe("Component > Regulatory Compliance", () => {
    ...
    test("Verify Regulatory Compliance page loads", async ({ page }) => {
    ...
    test("Verify Regulatory Compliance page title", async ({ page }) => {
        await page.goto(BASE_URL + MODULE_URL);
        await page.waitForLoadState("networkidle");
    ...
    test("Verify Regulatory Compliance navigation from Component menu", async ({ page }) => {
        ...
        // Click sub-menu item
        await page.getByRole("link", { name: "Regulatory Compliance" }).click();
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
    ...
    test("Verify no console errors on Regulatory Compliance", async ({ page }) => {
        const errors = [];
    ...
    test("Take Regulatory Compliance screenshot", async ({ page }) => {
        await page.goto(BASE_URL + MODULE_URL);
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
        await page.screenshot({ path: "test-results/screenshots/BEO1_Component_Regulatory_Compliance.png", fullPage: true });
    });
});
