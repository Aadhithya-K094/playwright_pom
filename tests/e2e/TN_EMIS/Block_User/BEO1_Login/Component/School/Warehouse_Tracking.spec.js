...
const MODULE_URL = "/component/barcode-scanner";

test.use({ storageState: { cookies: [], origins: [] } });

test.describe("Component > Warehouse Tracking", () => {
    ...
    test("Verify Warehouse Tracking page loads", async ({ page }) => {
    ...
    test("Verify Warehouse Tracking page title", async ({ page }) => {
        await page.goto(BASE_URL + MODULE_URL);
        await page.waitForLoadState("networkidle");
    ...
    test("Verify Warehouse Tracking navigation from Component menu", async ({ page }) => {
        ...
        // Click sub-menu item
        await page.getByRole("link", { name: "Warehouse Tracking" }).click();
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
    ...
    test("Verify no console errors on Warehouse Tracking", async ({ page }) => {
        const errors = [];
    ...
    test("Take Warehouse Tracking screenshot", async ({ page }) => {
        await page.goto(BASE_URL + MODULE_URL);
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
        await page.screenshot({ path: "test-results/screenshots/BEO1_Component_Warehouse_Tracking.png", fullPage: true });
    });
});
