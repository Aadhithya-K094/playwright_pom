...
const MODULE_URL = "/component/G2C";

test.use({ storageState: { cookies: [], origins: [] } });

test.describe("Component > G2C", () => {
    ...
    test("Verify G2C page loads", async ({ page }) => {
    ...
    test("Verify G2C page title", async ({ page }) => {
        await page.goto(BASE_URL + MODULE_URL);
        await page.waitForLoadState("networkidle");
    ...
    test("Verify G2C navigation from Component menu", async ({ page }) => {
        ...
        // Click sub-menu item
        await page.getByRole("link", { name: "G2C" }).click();
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
    ...
    test("Verify no console errors on G2C", async ({ page }) => {
        const errors = [];
    ...
    test("Take G2C screenshot", async ({ page }) => {
        await page.goto(BASE_URL + MODULE_URL);
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
        await page.screenshot({ path: "test-results/screenshots/BEO1_Component_G2C.png", fullPage: true });
    });
});
