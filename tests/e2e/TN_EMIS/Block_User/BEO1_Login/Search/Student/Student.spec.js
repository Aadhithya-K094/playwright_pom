...
test.describe("Search > Student", () => {
    ...
    test("Verify Search > Student sub-menu appears", async ({ page }) => {
        await page.goto(BASE_URL + "/dashboard");
        await page.waitForLoadState("networkidle");
        ...
        // Verify Student sub-menu
        const subMenu = page.locator("text=Student").first();
        await expect(subMenu).toBeVisible();
    });

    test("Verify Search > Student navigation", async ({ page }) => {
        await page.goto(BASE_URL + "/dashboard");
        await page.waitForLoadState("networkidle");
    ...
    test("Take Search Student screenshot", async ({ page }) => {
        await page.goto(BASE_URL + "/dashboard");
        await page.waitForLoadState("networkidle");
        await page.getByRole("link", { name: "Search " }).click();
        await page.waitForTimeout(1000);
        ...
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(3000);
        await page.screenshot({ path: "test-results/screenshots/BEO1_Search_Student.png", fullPage: true });
    });
});
