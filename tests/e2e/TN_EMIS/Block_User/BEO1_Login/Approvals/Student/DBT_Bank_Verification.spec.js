...
test(`BEO1 - Approvals > Student > DBT_Bank_Verification (User ${USER_NUMBER})`, async ({ beo1Page }) => {
    ...
    // TODO: Navigate to Approvals > Student > DBT_Bank_Verification module and test
